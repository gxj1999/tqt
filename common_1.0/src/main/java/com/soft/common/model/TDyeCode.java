...
@Table(name = "`t_dye_code`")
public class TDyeCode implements Serializable {
    /**
     * 主键
     */
    @Id
     ...
     */
    @Column(name = "`DYE_NM`")
    private String dyeNm;

    /**
     * 染料类型
     */
    @Column(name = "`DYE_TYPE`")
    private String dyeType;

    /**
     * 系统外区分
     */
    @Column(name = "`OUT_DYE_CLS`")
    private String outDyeCls;

    /**
     * 系统外染料编号
     */
    @Column(name = "`OUT_DYE_CD`")
    private String outDyeCd;

    /**
     * 系统外染料名称
     */
    @Column(name = "`OUT_DYE_NM`")
    private String outDyeNm;
     ...
     * @param dyeNm 染料名称
     */
    public void setDyeNm(String dyeNm) {
        this.dyeNm = dyeNm == null ? null : dyeNm.trim();
    }

    /**
     * 获取染料类型
     *
     * @return DYE_TYPE - 染料类型
     */
     ...
     * 获取系统外区分
     *
     * @return OUT_DYE_CLS - 系统外区分
     */
    public String getOutDyeCls() {
        return outDyeCls;
    }
     ...
     * 设置系统外区分
     *
     * @param outDyeCls 系统外区分
     */
    public void setOutDyeCls(String outDyeCls) {
        this.outDyeCls = outDyeCls == null ? null : outDyeCls.trim();
    }

    /**
     * 获取系统外染料编号
     *
     * @return OUT_DYE_CD - 系统外染料编号
     */
    public String getOutDyeCd() {
        return outDyeCd;
    }
     ...
     * 设置系统外染料编号
     *
     * @param outDyeCd 系统外染料编号
     */
    public void setOutDyeCd(String outDyeCd) {
        this.outDyeCd = outDyeCd == null ? null : outDyeCd.trim();
    }

    /**
     * 获取系统外染料名称
     *
     * @return OUT_DYE_NM - 系统外染料名称
     */
    public String getOutDyeNm() {
        return outDyeNm;
    }
     ...
     * 设置系统外染料名称
     *
     * @param outDyeNm 系统外染料名称
     */
    public void setOutDyeNm(String outDyeNm) {
        this.outDyeNm = outDyeNm == null ? null : outDyeNm.trim();
    }
    ...
    public boolean equals(Object that) {
        ...
        TDyeCode other = (TDyeCode) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            && (this.getProdId() == null ? other.getProdId() == null : this.getProdId().equals(other.getProdId()))
            && (this.getDyeNm() == null ? other.getDyeNm() == null : this.getDyeNm().equals(other.getDyeNm()))
            && (this.getDyeType() == null ? other.getDyeType() == null : this.getDyeType().equals(other.getDyeType()))
            && (this.getOutDyeCls() == null ? other.getOutDyeCls() == null : this.getOutDyeCls().equals(other.getOutDyeCls()))
            && (this.getOutDyeCd() == null ? other.getOutDyeCd() == null : this.getOutDyeCd().equals(other.getOutDyeCd()))
            && (this.getOutDyeNm() == null ? other.getOutDyeNm() == null : this.getOutDyeNm().equals(other.getOutDyeNm()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getDyeNm() == null) ? 0 : getDyeNm().hashCode());
        result = prime * result + ((getDyeType() == null) ? 0 : getDyeType().hashCode());
        result = prime * result + ((getOutDyeCls() == null) ? 0 : getOutDyeCls().hashCode());
        result = prime * result + ((getOutDyeCd() == null) ? 0 : getOutDyeCd().hashCode());
        result = prime * result + ((getOutDyeNm() == null) ? 0 : getOutDyeNm().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", dyeNm=").append(dyeNm);
        sb.append(", dyeType=").append(dyeType);
        sb.append(", outDyeCls=").append(outDyeCls);
        sb.append(", outDyeCd=").append(outDyeCd);
        sb.append(", outDyeNm=").append(outDyeNm);
