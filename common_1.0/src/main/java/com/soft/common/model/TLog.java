...
public class TLog implements Serializable {
     ...
     * 处理结束日时
     */
    @Column(name = "`OPT_END_DT`")
    private String optEndDt;

    /**
     * 対象開始日付
     */
    @Column(name = "`OBJ_START_DT`")
    private String objStartDt;

    /**
     * 対象終了日付
     */
    @Column(name = "`OBJ_END_DT`")
    private String objEndDt;
     ...
     * 设置处理结束日时
     *
     * @param optEndDt 处理结束日时
     */
    public void setOptEndDt(String optEndDt) {
        this.optEndDt = optEndDt == null ? null : optEndDt.trim();
    }

    /**
     * 获取対象開始日付
     *
     * @return OBJ_START_DT - 対象開始日付
     */
    public String getObjStartDt() {
        return objStartDt;
    }
     ...
     */
    public void setObjStartDt(String objStartDt) {
        this.objStartDt = objStartDt == null ? null : objStartDt.trim();
    }

    /**
     * 获取対象終了日付
     *
     * @return OBJ_END_DT - 対象終了日付
     */
    public String getObjEndDt() {
        return objEndDt;
    }
     ...
     */
    public void setObjEndDt(String objEndDt) {
        this.objEndDt = objEndDt == null ? null : objEndDt.trim();
    }
    ...
    public boolean equals(Object that) {
        ...
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getOptEndDt() == null ? other.getOptEndDt() == null : this.getOptEndDt().equals(other.getOptEndDt()))
            && (this.getObjStartDt() == null ? other.getObjStartDt() == null : this.getObjStartDt().equals(other.getObjStartDt()))
            && (this.getObjEndDt() == null ? other.getObjEndDt() == null : this.getObjEndDt().equals(other.getObjEndDt()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getOptEndDt() == null) ? 0 : getOptEndDt().hashCode());
        result = prime * result + ((getObjStartDt() == null) ? 0 : getObjStartDt().hashCode());
        result = prime * result + ((getObjEndDt() == null) ? 0 : getObjEndDt().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", optEndDt=").append(optEndDt);
        sb.append(", objStartDt=").append(objStartDt);
        sb.append(", objEndDt=").append(objEndDt);
