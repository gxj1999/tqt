...
@Table(name = "`t_receipt_order_line`")
public class TReceiptOrderLine implements Serializable {
    /**
     * 主键
     */
    @Id
     ...
     * 预定入库明细号
     */
    @Column(name = "`RCV_ORD_LIN_NUM`")
    private String rcvOrdLinNum;

    /**
     * 到货日期
     */
    @Column(name = "`ONS_DT`")
    private String onsDt;
     ...
     * 获取预定入库明细号
     *
     * @return RCV_ORD_LIN_NUM - 预定入库明细号
     */
    public String getRcvOrdLinNum() {
        return rcvOrdLinNum;
    }
     ...
     * 设置预定入库明细号
     *
     * @param rcvOrdLinNum 预定入库明细号
     */
    public void setRcvOrdLinNum(String rcvOrdLinNum) {
        this.rcvOrdLinNum = rcvOrdLinNum == null ? null : rcvOrdLinNum.trim();
    }
     ...
     * @param onsDt 到货日期
     */
    public void setOnsDt(String onsDt) {
        this.onsDt = onsDt == null ? null : onsDt.trim();
    }
    ...
    public boolean equals(Object that) {
        ...
        TReceiptOrderLine other = (TReceiptOrderLine) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            && (this.getRcvOrdId() == null ? other.getRcvOrdId() == null : this.getRcvOrdId().equals(other.getRcvOrdId()))
            && (this.getRcvOrdLinNum() == null ? other.getRcvOrdLinNum() == null : this.getRcvOrdLinNum().equals(other.getRcvOrdLinNum()))
            && (this.getOnsDt() == null ? other.getOnsDt() == null : this.getOnsDt().equals(other.getOnsDt()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getRcvOrdLinNum() == null) ? 0 : getRcvOrdLinNum().hashCode());
        result = prime * result + ((getOnsDt() == null) ? 0 : getOnsDt().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", rcvOrdLinNum=").append(rcvOrdLinNum);
        sb.append(", onsDt=").append(onsDt);
