...
@Table(name = "`t_traffic_line`")
public class TTrafficLine implements Serializable {
    /**
     * 主键
     */
    @Id
     ...
     * 物流配送明细号
     */
    @Column(name = "`TRAF_LINE_NUM`")
    private String trafLineNum;
     ...
     * 获取物流配送明细号
     *
     * @return TRAF_LINE_NUM - 物流配送明细号
     */
    public String getTrafLineNum() {
        return trafLineNum;
    }
     ...
     * 设置物流配送明细号
     *
     * @param trafLineNum 物流配送明细号
     */
    public void setTrafLineNum(String trafLineNum) {
        this.trafLineNum = trafLineNum == null ? null : trafLineNum.trim();
    }
    ...
    public boolean equals(Object that) {
        ...
        TTrafficLine other = (TTrafficLine) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            && (this.getTrafNum() == null ? other.getTrafNum() == null : this.getTrafNum().equals(other.getTrafNum()))
            && (this.getTrafLineNum() == null ? other.getTrafLineNum() == null : this.getTrafLineNum().equals(other.getTrafLineNum()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getTrafLineNum() == null) ? 0 : getTrafLineNum().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", trafLineNum=").append(trafLineNum);
