...
public class TPurchasePlan implements Serializable {
     ...
     * 采购状态
     */
    @Column(name = "`PURCHASE_CLS`")
    private String purchaseCls;
     ...
     * 获取采购状态
     *
     * @return PURCHASE_CLS - 采购状态
     */
    public String getPurchaseCls() {
        return purchaseCls;
    }
     ...
     * 设置采购状态
     *
     * @param purchaseCls 采购状态
     */
    public void setPurchaseCls(String purchaseCls) {
        this.purchaseCls = purchaseCls == null ? null : purchaseCls.trim();
    }
    ...
    public boolean equals(Object that) {
        ...
        TPurchasePlan other = (TPurchasePlan) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getPurchaseCls() == null ? other.getPurchaseCls() == null : this.getPurchaseCls().equals(other.getPurchaseCls()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getPurchaseCls() == null) ? 0 : getPurchaseCls().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", purchaseCls=").append(purchaseCls);
