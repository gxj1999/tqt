...
public class MLevel implements Serializable {
     ...
     * 积分要求上限
     */
    @Column(name = "`POINT_UPPER_LIMIT`")
    private Integer pointUpperLimit;

    /**
     * 积分要求下限
     */
    @Column(name = "`POINT_LOWER_LIMIT`")
    private Integer pointLowerLimit;
    ...
    public void setLevelNm(String levelNm) {
        this.levelNm = levelNm == null ? null : levelNm.trim();
    }

    /**
     * 获取评级类型
     *
     * @return LEVEL_TYPE - 评级类型
     */
     ...
     * 获取积分要求上限
     *
     * @return POINT_UPPER_LIMIT - 积分要求上限
     */
    public Integer getPointUpperLimit() {
     ...
     * 设置积分要求上限
     *
     * @param pointUpperLimit 积分要求上限
     */
    public void setPointUpperLimit(Integer pointUpperLimit) {
     ...
     * 获取积分要求下限
     *
     * @return POINT_LOWER_LIMIT - 积分要求下限
     */
    public Integer getPointLowerLimit() {
     ...
     * 设置积分要求下限
     *
     * @param pointLowerLimit 积分要求下限
     */
    public void setPointLowerLimit(Integer pointLowerLimit) {
    ...
    public boolean equals(Object that) {
        ...
        MLevel other = (MLevel) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            && (this.getCntrCd() == null ? other.getCntrCd() == null : this.getCntrCd().equals(other.getCntrCd()))
            && (this.getLevelNm() == null ? other.getLevelNm() == null : this.getLevelNm().equals(other.getLevelNm()))
            && (this.getLevelType() == null ? other.getLevelType() == null : this.getLevelType().equals(other.getLevelType()))
            && (this.getPointUpperLimit() == null ? other.getPointUpperLimit() == null : this.getPointUpperLimit().equals(other.getPointUpperLimit()))
            && (this.getPointLowerLimit() == null ? other.getPointLowerLimit() == null : this.getPointLowerLimit().equals(other.getPointLowerLimit()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getLevelNm() == null) ? 0 : getLevelNm().hashCode());
        result = prime * result + ((getLevelType() == null) ? 0 : getLevelType().hashCode());
        result = prime * result + ((getPointUpperLimit() == null) ? 0 : getPointUpperLimit().hashCode());
        result = prime * result + ((getPointLowerLimit() == null) ? 0 : getPointLowerLimit().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", levelNm=").append(levelNm);
        sb.append(", levelType=").append(levelType);
        sb.append(", pointUpperLimit=").append(pointUpperLimit);
        sb.append(", pointLowerLimit=").append(pointLowerLimit);
