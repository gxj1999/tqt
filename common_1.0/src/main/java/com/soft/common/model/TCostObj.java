...
@Table(name = "`t_cost_obj`")
public class TCostObj implements Serializable {
    /**
     * 主键
     */
    @Id
     ...
     * 成本核算对象名称
     */
    @Column(name = "`COST_OBJ_NM`")
    private String costObjNm;

    /**
     * 成本核算对象类型
     */
    @Column(name = "`COST_OBJ_TYPE`")
    private String costObjType;

    /**
     * 成本核算对象习性
     */
    @Column(name = "`COST_OBJ_HABIT`")
    private String costObjHabit;
     ...
     * 获取成本核算对象名称
     *
     * @return COST_OBJ_NM - 成本核算对象名称
     */
    public String getCostObjNm() {
        return costObjNm;
    }
     ...
     * 设置成本核算对象名称
     *
     * @param costObjNm 成本核算对象名称
     */
    public void setCostObjNm(String costObjNm) {
        this.costObjNm = costObjNm == null ? null : costObjNm.trim();
    }

    /**
     * 获取成本核算对象类型
     *
     * @return COST_OBJ_TYPE - 成本核算对象类型
     */
     ...
     * 设置成本核算对象类型
     *
     * @param costObjType 成本核算对象类型
     */
    public void setCostObjType(String costObjType) {
        this.costObjType = costObjType == null ? null : costObjType.trim();
    }

    /**
     * 获取成本核算对象习性
     *
     * @return COST_OBJ_HABIT - 成本核算对象习性
     */
    public String getCostObjHabit() {
        return costObjHabit;
    }
     ...
     * 设置成本核算对象习性
     *
     * @param costObjHabit 成本核算对象习性
     */
    public void setCostObjHabit(String costObjHabit) {
        this.costObjHabit = costObjHabit == null ? null : costObjHabit.trim();
    }

    /**
     * 获取关联编号
     *
     * @return RELATION_CD - 关联编号
     */
     ...
     * 设置关联编号
     *
     * @param relationCd 关联编号
     */
    public void setRelationCd(String relationCd) {
        this.relationCd = relationCd == null ? null : relationCd.trim();
    }
    ...
    public boolean equals(Object that) {
        ...
        TCostObj other = (TCostObj) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            && (this.getCntrCd() == null ? other.getCntrCd() == null : this.getCntrCd().equals(other.getCntrCd()))
            && (this.getCostObjNm() == null ? other.getCostObjNm() == null : this.getCostObjNm().equals(other.getCostObjNm()))
            && (this.getCostObjType() == null ? other.getCostObjType() == null : this.getCostObjType().equals(other.getCostObjType()))
            && (this.getCostObjHabit() == null ? other.getCostObjHabit() == null : this.getCostObjHabit().equals(other.getCostObjHabit()))
            && (this.getRelationCd() == null ? other.getRelationCd() == null : this.getRelationCd().equals(other.getRelationCd()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getCostObjNm() == null) ? 0 : getCostObjNm().hashCode());
        result = prime * result + ((getCostObjType() == null) ? 0 : getCostObjType().hashCode());
        result = prime * result + ((getCostObjHabit() == null) ? 0 : getCostObjHabit().hashCode());
        result = prime * result + ((getRelationCd() == null) ? 0 : getRelationCd().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", costObjNm=").append(costObjNm);
        sb.append(", costObjType=").append(costObjType);
        sb.append(", costObjHabit=").append(costObjHabit);
        sb.append(", relationCd=").append(relationCd);
