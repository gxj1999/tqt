...
@Table(name = "`t_traffic_plan_line`")
public class TTrafficPlanLine implements Serializable {
    /**
     * 主键
     */
    @Id
     ...
     * 物流计划编号
     */
    @Column(name = "`TRAF_PLAN_CD`")
    private String trafPlanCd;

    /**
     * 物流计划明细号
     */
    @Column(name = "`TRAF_PLAN_LINE_NUM`")
    private String trafPlanLineNum;
     ...
     * 获取物流计划编号
     *
     * @return TRAF_PLAN_CD - 物流计划编号
     */
    public String getTrafPlanCd() {
        return trafPlanCd;
    }
     ...
     * 设置物流计划编号
     *
     * @param trafPlanCd 物流计划编号
     */
    public void setTrafPlanCd(String trafPlanCd) {
        this.trafPlanCd = trafPlanCd == null ? null : trafPlanCd.trim();
    }

    /**
     * 获取物流计划明细号
     *
     * @return TRAF_PLAN_LINE_NUM - 物流计划明细号
     */
    public String getTrafPlanLineNum() {
        return trafPlanLineNum;
    }

    /**
     * 设置物流计划明细号
     *
     * @param trafPlanLineNum 物流计划明细号
     */
    public void setTrafPlanLineNum(String trafPlanLineNum) {
        this.trafPlanLineNum = trafPlanLineNum == null ? null : trafPlanLineNum.trim();
    }
    ...
    public boolean equals(Object that) {
        ...
        TTrafficPlanLine other = (TTrafficPlanLine) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            && (this.getTrafPlanCd() == null ? other.getTrafPlanCd() == null : this.getTrafPlanCd().equals(other.getTrafPlanCd()))
            && (this.getTrafPlanLineNum() == null ? other.getTrafPlanLineNum() == null : this.getTrafPlanLineNum().equals(other.getTrafPlanLineNum()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getTrafPlanCd() == null) ? 0 : getTrafPlanCd().hashCode());
        result = prime * result + ((getTrafPlanLineNum() == null) ? 0 : getTrafPlanLineNum().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", trafPlanCd=").append(trafPlanCd);
        sb.append(", trafPlanLineNum=").append(trafPlanLineNum);
