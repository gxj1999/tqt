...
@Table(name = "`t_log_line`")
public class TLogLine implements Serializable {
    /**
     * 主键
     */
    @Id
     ...
     * 日志明细编号
     */
    @Column(name = "`LOG_LINE_NO`")
    private String logLineNo;

    /**
     * 处理开始日时
     */
    @Column(name = "`OPT_START_DT`")
    private String optStartDt;

    /**
     * 管理名称
     */
    @Column(name = "`MANAG_NM`")
    private String managNm;

    /**
     * 明细处理开始日时
     */
    @Column(name = "`SUB_OPT_START_DT`")
    private String subOptStartDt;

    /**
     * 明细处理终了日时
     */
    @Column(name = "`SUB_OPT_END_DT`")
    private String subOptEndDt;
     ...
     * 获取处理区分
     *
     * @return SYRI_KBN - 处理区分
     */
    public String getSyriKbn() {
        return syriKbn;
    }
     ...
     * @param syriKbn 处理区分
     */
    public void setSyriKbn(String syriKbn) {
        this.syriKbn = syriKbn == null ? null : syriKbn.trim();
    }
    ...
    public void setPgmId(String pgmId) {
        this.pgmId = pgmId == null ? null : pgmId.trim();
    }
     ...
     * 获取日志明细编号
     *
     * @return LOG_LINE_NO - 日志明细编号
     */
    public String getLogLineNo() {
        return logLineNo;
    }
     ...
     * 设置日志明细编号
     *
     * @param logLineNo 日志明细编号
     */
    public void setLogLineNo(String logLineNo) {
        this.logLineNo = logLineNo == null ? null : logLineNo.trim();
    }

    /**
     * 获取处理开始日时
     *
     * @return OPT_START_DT - 处理开始日时
     */
    public String getOptStartDt() {
        return optStartDt;
    }
     ...
     * 设置处理开始日时
     *
     * @param optStartDt 处理开始日时
     */
    public void setOptStartDt(String optStartDt) {
        this.optStartDt = optStartDt == null ? null : optStartDt.trim();
    }

    /**
     * 获取管理名称
     *
     * @return MANAG_NM - 管理名称
     */
    public String getManagNm() {
        return managNm;
    }
     ...
     * @param managNm 管理名称
     */
    public void setManagNm(String managNm) {
        this.managNm = managNm == null ? null : managNm.trim();
    }

    /**
     * 获取明细处理开始日时
     *
     * @return SUB_OPT_START_DT - 明细处理开始日时
     */
    public String getSubOptStartDt() {
        return subOptStartDt;
    }

    /**
     * 设置明细处理开始日时
     *
     * @param subOptStartDt 明细处理开始日时
     */
    public void setSubOptStartDt(String subOptStartDt) {
        this.subOptStartDt = subOptStartDt == null ? null : subOptStartDt.trim();
    }

    /**
     * 获取明细处理终了日时
     *
     * @return SUB_OPT_END_DT - 明细处理终了日时
     */
    public String getSubOptEndDt() {
        return subOptEndDt;
    }
     ...
     * 设置明细处理终了日时
     *
     * @param subOptEndDt 明细处理终了日时
     */
    public void setSubOptEndDt(String subOptEndDt) {
        this.subOptEndDt = subOptEndDt == null ? null : subOptEndDt.trim();
    }

    /**
     * 获取数据个数
     *
     * @return DATA_NUM - 数据个数
     */
    ...
    public boolean equals(Object that) {
        ...
        TLogLine other = (TLogLine) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            && (this.getCntrCd() == null ? other.getCntrCd() == null : this.getCntrCd().equals(other.getCntrCd()))
            && (this.getSyriKbn() == null ? other.getSyriKbn() == null : this.getSyriKbn().equals(other.getSyriKbn()))
            && (this.getPgmId() == null ? other.getPgmId() == null : this.getPgmId().equals(other.getPgmId()))
            && (this.getLogId() == null ? other.getLogId() == null : this.getLogId().equals(other.getLogId()))
            && (this.getLogLineNo() == null ? other.getLogLineNo() == null : this.getLogLineNo().equals(other.getLogLineNo()))
            && (this.getOptStartDt() == null ? other.getOptStartDt() == null : this.getOptStartDt().equals(other.getOptStartDt()))
            && (this.getManagNm() == null ? other.getManagNm() == null : this.getManagNm().equals(other.getManagNm()))
            && (this.getSubOptStartDt() == null ? other.getSubOptStartDt() == null : this.getSubOptStartDt().equals(other.getSubOptStartDt()))
            && (this.getSubOptEndDt() == null ? other.getSubOptEndDt() == null : this.getSubOptEndDt().equals(other.getSubOptEndDt()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getSyriKbn() == null) ? 0 : getSyriKbn().hashCode());
        result = prime * result + ((getPgmId() == null) ? 0 : getPgmId().hashCode());
        result = prime * result + ((getLogId() == null) ? 0 : getLogId().hashCode());
        result = prime * result + ((getLogLineNo() == null) ? 0 : getLogLineNo().hashCode());
        result = prime * result + ((getOptStartDt() == null) ? 0 : getOptStartDt().hashCode());
        result = prime * result + ((getManagNm() == null) ? 0 : getManagNm().hashCode());
        result = prime * result + ((getSubOptStartDt() == null) ? 0 : getSubOptStartDt().hashCode());
        result = prime * result + ((getSubOptEndDt() == null) ? 0 : getSubOptEndDt().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", syriKbn=").append(syriKbn);
        sb.append(", pgmId=").append(pgmId);
        sb.append(", logId=").append(logId);
        sb.append(", logLineNo=").append(logLineNo);
        sb.append(", optStartDt=").append(optStartDt);
        sb.append(", managNm=").append(managNm);
        sb.append(", subOptStartDt=").append(subOptStartDt);
        sb.append(", subOptEndDt=").append(subOptEndDt);
