...
@Table(name = "`t_ship_line`")
public class TShipLine implements Serializable {
    /**
     * 主键
     */
    @Id
     ...
     * 出库明细号
     */
    @Column(name = "`SHP_LIN_NUM`")
    private String shpLinNum;
     ...
     * 获取出库明细号
     *
     * @return SHP_LIN_NUM - 出库明细号
     */
    public String getShpLinNum() {
        return shpLinNum;
    }
     ...
     * 设置出库明细号
     *
     * @param shpLinNum 出库明细号
     */
    public void setShpLinNum(String shpLinNum) {
        this.shpLinNum = shpLinNum == null ? null : shpLinNum.trim();
    }
    ...
    public boolean equals(Object that) {
        ...
        TShipLine other = (TShipLine) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            && (this.getShpId() == null ? other.getShpId() == null : this.getShpId().equals(other.getShpId()))
            && (this.getShpLinNum() == null ? other.getShpLinNum() == null : this.getShpLinNum().equals(other.getShpLinNum()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getShpLinNum() == null) ? 0 : getShpLinNum().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", shpLinNum=").append(shpLinNum);
