...
@Table(name = "`t_craft_knit_method`")
public class TCraftKnitMethod implements Serializable {
    /**
     * 主键
     */
    @Id
     ...
     * 编织名称
     */
    @Column(name = "`CRAFT_KNIT_NM`")
    private String craftKnitNm;

    /**
     * 织物类型
     */
    @Column(name = "`CRAFT_KNIT_TYPE`")
    private String craftKnitType;
     ...
     * 获取编织名称
     *
     * @return CRAFT_KNIT_NM - 编织名称
     */
    public String getCraftKnitNm() {
        return craftKnitNm;
    }
     ...
     * 设置编织名称
     *
     * @param craftKnitNm 编织名称
     */
    public void setCraftKnitNm(String craftKnitNm) {
        this.craftKnitNm = craftKnitNm == null ? null : craftKnitNm.trim();
    }

    /**
     * 获取织物类型
     *
     * @return CRAFT_KNIT_TYPE - 织物类型
     */
    public String getCraftKnitType() {
        return craftKnitType;
    }

    /**
     * 设置织物类型
     *
     * @param craftKnitType 织物类型
     */
    public void setCraftKnitType(String craftKnitType) {
        this.craftKnitType = craftKnitType == null ? null : craftKnitType.trim();
    }
    ...
    public boolean equals(Object that) {
        ...
        TCraftKnitMethod other = (TCraftKnitMethod) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            && (this.getCraftKnitNm() == null ? other.getCraftKnitNm() == null : this.getCraftKnitNm().equals(other.getCraftKnitNm()))
            && (this.getCraftKnitType() == null ? other.getCraftKnitType() == null : this.getCraftKnitType().equals(other.getCraftKnitType()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getCraftKnitNm() == null) ? 0 : getCraftKnitNm().hashCode());
        result = prime * result + ((getCraftKnitType() == null) ? 0 : getCraftKnitType().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", craftKnitNm=").append(craftKnitNm);
        sb.append(", craftKnitType=").append(craftKnitType);
