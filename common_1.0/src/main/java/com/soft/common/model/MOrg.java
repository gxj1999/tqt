...
public class MOrg implements Serializable {
     ...
     * 表示用组织部门编号
     */
    @Column(name = "`ORG_CD_DIS`")
    private String orgCdDis;

    /**
     * 上位组织编号
     */
    @Column(name = "`HIGHER_ORG_CD`")
    private String higherOrgCd;
     ...
     * 省市区编号
     */
    @Column(name = "`PROVINCIAL_CD`")
    private String provincialCd;
     ...
     * 设置表示用组织部门编号
     *
     * @param orgCdDis 表示用组织部门编号
     */
    public void setOrgCdDis(String orgCdDis) {
        this.orgCdDis = orgCdDis == null ? null : orgCdDis.trim();
    }

    /**
     * 获取上位组织编号
     *
     * @return HIGHER_ORG_CD - 上位组织编号
     */
    public String getHigherOrgCd() {
        return higherOrgCd;
    }
     ...
     * 设置上位组织编号
     *
     * @param higherOrgCd 上位组织编号
     */
    public void setHigherOrgCd(String higherOrgCd) {
        this.higherOrgCd = higherOrgCd == null ? null : higherOrgCd.trim();
    }

    /**
     * 获取组织部门名称
     *
     * @return ORG_NM - 组织部门名称
     */
     ...
     * 设置组织部门英文名称
     *
     * @param orgEngNm 组织部门英文名称
     */
    public void setOrgEngNm(String orgEngNm) {
        this.orgEngNm = orgEngNm == null ? null : orgEngNm.trim();
    }
     ...
     * 设置是否管理部门
     *
     * @param isFinancial 是否管理部门
     */
    public void setIsFinancial(String isFinancial) {
        this.isFinancial = isFinancial == null ? null : isFinancial.trim();
    }

    /**
     * 获取省市区编号
     *
     * @return PROVINCIAL_CD - 省市区编号
     */
    public String getProvincialCd() {
        return provincialCd;
    }
     ...
     * 设置省市区编号
     *
     * @param provincialCd 省市区编号
     */
    public void setProvincialCd(String provincialCd) {
        this.provincialCd = provincialCd == null ? null : provincialCd.trim();
    }

    /**
     * 获取联系人
     *
     * @return CONTACT_NM - 联系人
     */
    ...
    public void setAdrs(String adrs) {
        this.adrs = adrs == null ? null : adrs.trim();
    }
    ...
    public boolean equals(Object that) {
        ...
        MOrg other = (MOrg) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            && (this.getCntrCd() == null ? other.getCntrCd() == null : this.getCntrCd().equals(other.getCntrCd()))
            && (this.getOrgCdDis() == null ? other.getOrgCdDis() == null : this.getOrgCdDis().equals(other.getOrgCdDis()))
            && (this.getHigherOrgCd() == null ? other.getHigherOrgCd() == null : this.getHigherOrgCd().equals(other.getHigherOrgCd()))
            && (this.getOrgNm() == null ? other.getOrgNm() == null : this.getOrgNm().equals(other.getOrgNm()))
            && (this.getOrgAbbr() == null ? other.getOrgAbbr() == null : this.getOrgAbbr().equals(other.getOrgAbbr()))
            && (this.getOrgEngNm() == null ? other.getOrgEngNm() == null : this.getOrgEngNm().equals(other.getOrgEngNm()))
            && (this.getOrgType() == null ? other.getOrgType() == null : this.getOrgType().equals(other.getOrgType()))
            && (this.getIsFinancial() == null ? other.getIsFinancial() == null : this.getIsFinancial().equals(other.getIsFinancial()))
            && (this.getProvincialCd() == null ? other.getProvincialCd() == null : this.getProvincialCd().equals(other.getProvincialCd()))
            && (this.getContactNm() == null ? other.getContactNm() == null : this.getContactNm().equals(other.getContactNm()))
            && (this.getTel() == null ? other.getTel() == null : this.getTel().equals(other.getTel()))
            && (this.getFax() == null ? other.getFax() == null : this.getFax().equals(other.getFax()))
            && (this.getAdrs() == null ? other.getAdrs() == null : this.getAdrs().equals(other.getAdrs()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getOrgCdDis() == null) ? 0 : getOrgCdDis().hashCode());
        result = prime * result + ((getHigherOrgCd() == null) ? 0 : getHigherOrgCd().hashCode());
        result = prime * result + ((getOrgNm() == null) ? 0 : getOrgNm().hashCode());
        result = prime * result + ((getOrgAbbr() == null) ? 0 : getOrgAbbr().hashCode());
        result = prime * result + ((getOrgEngNm() == null) ? 0 : getOrgEngNm().hashCode());
        result = prime * result + ((getOrgType() == null) ? 0 : getOrgType().hashCode());
        result = prime * result + ((getIsFinancial() == null) ? 0 : getIsFinancial().hashCode());
        result = prime * result + ((getProvincialCd() == null) ? 0 : getProvincialCd().hashCode());
        result = prime * result + ((getContactNm() == null) ? 0 : getContactNm().hashCode());
        result = prime * result + ((getTel() == null) ? 0 : getTel().hashCode());
        result = prime * result + ((getFax() == null) ? 0 : getFax().hashCode());
        result = prime * result + ((getAdrs() == null) ? 0 : getAdrs().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", orgCdDis=").append(orgCdDis);
        sb.append(", higherOrgCd=").append(higherOrgCd);
        sb.append(", orgNm=").append(orgNm);
        sb.append(", orgAbbr=").append(orgAbbr);
        sb.append(", orgEngNm=").append(orgEngNm);
        sb.append(", orgType=").append(orgType);
        sb.append(", isFinancial=").append(isFinancial);
        sb.append(", provincialCd=").append(provincialCd);
        sb.append(", contactNm=").append(contactNm);
        sb.append(", tel=").append(tel);
        sb.append(", fax=").append(fax);
        sb.append(", adrs=").append(adrs);
