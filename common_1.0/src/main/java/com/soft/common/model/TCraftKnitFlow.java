...
@Table(name = "`t_craft_knit_flow`")
public class TCraftKnitFlow implements Serializable {
    /**
     * 主键
     */
    @Id
     ...
     * 工艺流程类型
     */
    @Column(name = "`CRAFT_FLOW_TYPE`")
    private String craftFlowType;

    /**
     * 流程顺序
     */
    @Column(name = "`CRAFT_SORT`")
    private Integer craftSort;

    /**
     * 工艺流程
     */
    @Column(name = "`CRAFT_FLOW`")
     ...
     * 获取工艺流程类型
     *
     * @return CRAFT_FLOW_TYPE - 工艺流程类型
     */
    public String getCraftFlowType() {
        return craftFlowType;
    }

    /**
     * 设置工艺流程类型
     *
     * @param craftFlowType 工艺流程类型
     */
    public void setCraftFlowType(String craftFlowType) {
        this.craftFlowType = craftFlowType == null ? null : craftFlowType.trim();
    }

    /**
     * 获取流程顺序
     *
     * @return CRAFT_SORT - 流程顺序
     */
    public Integer getCraftSort() {
        return craftSort;
    }
     ...
     * 设置流程顺序
     *
     * @param craftSort 流程顺序
     */
    public void setCraftSort(Integer craftSort) {
        this.craftSort = craftSort;
    }

    /**
     * 获取工艺流程
     *
     * @return CRAFT_FLOW - 工艺流程
     */
    public String getCraftFlow() {
        return craftFlow;
    }
     ...
     * 设置工艺流程
     *
     * @param craftFlow 工艺流程
     */
    public void setCraftFlow(String craftFlow) {
        this.craftFlow = craftFlow == null ? null : craftFlow.trim();
    }
    ...
    public boolean equals(Object that) {
        ...
        TCraftKnitFlow other = (TCraftKnitFlow) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            && (this.getCraftSn() == null ? other.getCraftSn() == null : this.getCraftSn().equals(other.getCraftSn()))
            && (this.getCraftFlowType() == null ? other.getCraftFlowType() == null : this.getCraftFlowType().equals(other.getCraftFlowType()))
            && (this.getCraftSort() == null ? other.getCraftSort() == null : this.getCraftSort().equals(other.getCraftSort()))
            && (this.getCraftFlow() == null ? other.getCraftFlow() == null : this.getCraftFlow().equals(other.getCraftFlow()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getCraftFlowType() == null) ? 0 : getCraftFlowType().hashCode());
        result = prime * result + ((getCraftSort() == null) ? 0 : getCraftSort().hashCode());
        result = prime * result + ((getCraftFlow() == null) ? 0 : getCraftFlow().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", craftFlowType=").append(craftFlowType);
        sb.append(", craftSort=").append(craftSort);
        sb.append(", craftFlow=").append(craftFlow);
