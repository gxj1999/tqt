...
@Table(name = "`t_out_factory_plan`")
public class TOutFactoryPlan implements Serializable {
    /**
     * 主键
     */
    @Id
     ...
     * 外发计划编号
     */
    @Column(name = "`OF_PLAN_CD`")
    private String ofPlanCd;
     ...
     * 送回标识
     */
    @Column(name = "`SEND_BACK_FLG`")
    private String sendBackFlg;
     ...
     * 获取外发计划编号
     *
     * @return OF_PLAN_CD - 外发计划编号
     */
    public String getOfPlanCd() {
        return ofPlanCd;
    }
     ...
     * 设置外发计划编号
     *
     * @param ofPlanCd 外发计划编号
     */
    public void setOfPlanCd(String ofPlanCd) {
        this.ofPlanCd = ofPlanCd == null ? null : ofPlanCd.trim();
    }
     ...
     */
    public void setManufSort(Integer manufSort) {
        this.manufSort = manufSort;
    }

    /**
     * 获取生产流程编号
     *
     * @return MANUF_PROCESS_CLS - 生产流程编号
     */
     ...
     * @param ofCls 外发状态
     */
    public void setOfCls(String ofCls) {
        this.ofCls = ofCls == null ? null : ofCls.trim();
    }
     ...
     * 获取送回标识
     *
     * @return SEND_BACK_FLG - 送回标识
     */
    public String getSendBackFlg() {
        return sendBackFlg;
    }
     ...
     * 设置送回标识
     *
     * @param sendBackFlg 送回标识
     */
    public void setSendBackFlg(String sendBackFlg) {
        this.sendBackFlg = sendBackFlg == null ? null : sendBackFlg.trim();
    }

    /**
     * 获取记录人
     *
     * @return INPUT_USER_CD - 记录人
     */
    ...
    public boolean equals(Object that) {
        ...
        TOutFactoryPlan other = (TOutFactoryPlan) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            && (this.getOfPlanCd() == null ? other.getOfPlanCd() == null : this.getOfPlanCd().equals(other.getOfPlanCd()))
            ...
            && (this.getOfCls() == null ? other.getOfCls() == null : this.getOfCls().equals(other.getOfCls()))
            ...
            && (this.getSendBackFlg() == null ? other.getSendBackFlg() == null : this.getSendBackFlg().equals(other.getSendBackFlg()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getOfPlanCd() == null) ? 0 : getOfPlanCd().hashCode());
        ...
        result = prime * result + ((getOfCls() == null) ? 0 : getOfCls().hashCode());
        ...
        result = prime * result + ((getSendBackFlg() == null) ? 0 : getSendBackFlg().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", ofPlanCd=").append(ofPlanCd);
        ...
        sb.append(", sendBackFlg=").append(sendBackFlg);
