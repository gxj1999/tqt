...
@ApiModel(description="标准生产流程明细")
@Table(name = "m_standard_mp_line")
public class MStandardMpLine implements Serializable {
    /**
     * 主键
     */
    @Id
     ...
     * 生产流程ID
     */
    @Column(name = "MANUF_PROCESS_ID")
    @ApiModelProperty(value="生产流程ID")
    private String manufProcessId;

    /**
     * 流程顺序
     */
    @Column(name = "PROCESS_SORT")
     ...
     * @param id 主键
     */
    public MStandardMpLine setId(String id) {
     ...
     * @param cntrCd 中心编号
     */
    public MStandardMpLine setCntrCd(String cntrCd) {
     ...
     * 获取标准生产流程编号
     *
     * @return STANDARD_MP_ID - 标准生产流程编号
     */
     ...
     * 设置标准生产流程编号
     *
     * @param standardMpId 标准生产流程编号
     */
    public MStandardMpLine setStandardMpId(String standardMpId) {
        this.standardMpId = standardMpId == null ? null : standardMpId.trim();
        return this;
    }
     ...
     * 获取生产流程ID
     *
     * @return MANUF_PROCESS_ID - 生产流程ID
     */
     ...
     * 设置生产流程ID
     *
     * @param manufProcessId 生产流程ID
     */
    public MStandardMpLine setManufProcessId(String manufProcessId) {
     ...
     * 设置流程顺序
     *
     * @param processSort 流程顺序
     */
    public MStandardMpLine setProcessSort(Integer processSort) {
     ...
     * @param remark 备注
     */
    public MStandardMpLine setRemark(String remark) {
     ...
     * @param char1 文本1
     */
    public MStandardMpLine setChar1(String char1) {
     ...
     * @param char2 文本2
     */
    public MStandardMpLine setChar2(String char2) {
     ...
     * @param char3 文本3
     */
    public MStandardMpLine setChar3(String char3) {
     ...
     * @param char4 文本4
     */
    public MStandardMpLine setChar4(String char4) {
     ...
     * @param char5 文本5
     */
    public MStandardMpLine setChar5(String char5) {
     ...
     * @param char6 文本6
     */
    public MStandardMpLine setChar6(String char6) {
     ...
     * @param char7 文本7
     */
    public MStandardMpLine setChar7(String char7) {
     ...
     * @param char8 文本8
     */
    public MStandardMpLine setChar8(String char8) {
     ...
     * @param char9 文本9
     */
    public MStandardMpLine setChar9(String char9) {
     ...
     * @param char10 文本10
     */
    public MStandardMpLine setChar10(String char10) {
     ...
     * @param num1 数值1
     */
    public MStandardMpLine setNum1(BigDecimal num1) {
        this.num1 = num1;
        return this;
    }
     ...
     * @param num2 数值2
     */
    public MStandardMpLine setNum2(BigDecimal num2) {
        this.num2 = num2;
        return this;
    }
     ...
     * @param num3 数值3
     */
    public MStandardMpLine setNum3(BigDecimal num3) {
        this.num3 = num3;
        return this;
    }
     ...
     * @param num4 数值4
     */
    public MStandardMpLine setNum4(BigDecimal num4) {
        this.num4 = num4;
        return this;
    }
     ...
     * @param num5 数值5
     */
    public MStandardMpLine setNum5(BigDecimal num5) {
        this.num5 = num5;
        return this;
    }
     ...
     * @param num6 数值6
     */
    public MStandardMpLine setNum6(BigDecimal num6) {
        this.num6 = num6;
        return this;
    }
     ...
     * @param num7 数值7
     */
    public MStandardMpLine setNum7(BigDecimal num7) {
        this.num7 = num7;
        return this;
    }
     ...
     * @param num8 数值8
     */
    public MStandardMpLine setNum8(BigDecimal num8) {
        this.num8 = num8;
        return this;
    }
     ...
     * @param num9 数值9
     */
    public MStandardMpLine setNum9(BigDecimal num9) {
        this.num9 = num9;
        return this;
    }
     ...
     * @param num10 数值10
     */
    public MStandardMpLine setNum10(BigDecimal num10) {
        this.num10 = num10;
        return this;
    }
     ...
     * @param updCnt 更新次数
     */
    public MStandardMpLine setUpdCnt(Integer updCnt) {
        this.updCnt = updCnt;
        return this;
    }
     ...
     * @param delFlg 删除区分
     */
    public MStandardMpLine setDelFlg(String delFlg) {
     ...
     */
    public MStandardMpLine setAddEntKbn(String addEntKbn) {
     ...
     */
    public MStandardMpLine setAddPgmId(String addPgmId) {
     ...
     */
    public MStandardMpLine setAddUserId(String addUserId) {
     ...
     */
    public MStandardMpLine setAddUserNm(String addUserNm) {
     ...
     */
    public MStandardMpLine setAddTnmtId(String addTnmtId) {
     ...
     * @param addDt 登录日期
     */
    public MStandardMpLine setAddDt(Date addDt) {
        this.addDt = addDt;
        return this;
    }
     ...
     */
    public MStandardMpLine setUpdEntKbn(String updEntKbn) {
     ...
     */
    public MStandardMpLine setUpdPgmId(String updPgmId) {
     ...
     */
    public MStandardMpLine setUpdUserId(String updUserId) {
     ...
     */
    public MStandardMpLine setUpdUserNm(String updUserNm) {
     ...
     */
    public MStandardMpLine setUpdTnmtId(String updTnmtId) {
     ...
     * @param updDt 更新日期
     */
    public MStandardMpLine setUpdDt(Date updDt) {
        this.updDt = updDt;
        return this;
    }
    ...
    public boolean equals(Object that) {
        ...
        MStandardMpLine other = (MStandardMpLine) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            && (this.getCntrCd() == null ? other.getCntrCd() == null : this.getCntrCd().equals(other.getCntrCd()))
            && (this.getStandardMpId() == null ? other.getStandardMpId() == null : this.getStandardMpId().equals(other.getStandardMpId()))
            && (this.getManufProcessId() == null ? other.getManufProcessId() == null : this.getManufProcessId().equals(other.getManufProcessId()))
            && (this.getProcessSort() == null ? other.getProcessSort() == null : this.getProcessSort().equals(other.getProcessSort()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getStandardMpId() == null) ? 0 : getStandardMpId().hashCode());
        result = prime * result + ((getManufProcessId() == null) ? 0 : getManufProcessId().hashCode());
        result = prime * result + ((getProcessSort() == null) ? 0 : getProcessSort().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", standardMpId=").append(standardMpId);
        sb.append(", manufProcessId=").append(manufProcessId);
        sb.append(", processSort=").append(processSort);
