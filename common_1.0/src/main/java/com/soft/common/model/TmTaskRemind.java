...
@Table(name = "`tm_task_remind`")
public class TmTaskRemind implements Serializable {
    /**
     * 主键
     */
    @Id
     ...
     * 设置处理标志
     *
     * @param processFlg 处理标志
     */
    public void setProcessFlg(String processFlg) {
        this.processFlg = processFlg == null ? null : processFlg.trim();
    }

    /**
     * 获取处理者
     *
     * @return PROCESS_USER_ID - 处理者
     */
    ...
    public boolean equals(Object that) {
        ...
        TmTaskRemind other = (TmTaskRemind) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getProcessFlg() == null ? other.getProcessFlg() == null : this.getProcessFlg().equals(other.getProcessFlg()))
            && (this.getProcessUserId() == null ? other.getProcessUserId() == null : this.getProcessUserId().equals(other.getProcessUserId()))
            && (this.getProcessDt() == null ? other.getProcessDt() == null : this.getProcessDt().equals(other.getProcessDt()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getProcessFlg() == null) ? 0 : getProcessFlg().hashCode());
        result = prime * result + ((getProcessUserId() == null) ? 0 : getProcessUserId().hashCode());
        result = prime * result + ((getProcessDt() == null) ? 0 : getProcessDt().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", processFlg=").append(processFlg);
        sb.append(", processUserId=").append(processUserId);
        sb.append(", processDt=").append(processDt);
