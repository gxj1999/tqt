...
public class MBox implements Serializable {
     ...
     * 箱表示用编号
     */
    @Column(name = "`BOX_CD_DIS`")
    private String boxCdDis;
    ...
    private BigDecimal maxCapa;

    /**
     * 允许容积
     */
    @Column(name = "`GRANT_CAPA`")
    private BigDecimal grantCapa;

    /**
     * 允许重量
     */
    @Column(name = "`GRANT_WEIGHT`")
    private BigDecimal grantWeight;
     ...
     * 获取箱表示用编号
     *
     * @return BOX_CD_DIS - 箱表示用编号
     */
    public String getBoxCdDis() {
        return boxCdDis;
    }
     ...
     * 设置箱表示用编号
     *
     * @param boxCdDis 箱表示用编号
     */
    public void setBoxCdDis(String boxCdDis) {
        this.boxCdDis = boxCdDis == null ? null : boxCdDis.trim();
    }
    ...
    public void setBoxNm(String boxNm) {
        this.boxNm = boxNm == null ? null : boxNm.trim();
    }

    /**
     * 获取箱高
     *
     * @return BOX_HEIGHT - 箱高
     */
     ...
     * @param boxDepth 箱长
     */
    public void setBoxDepth(BigDecimal boxDepth) {
     ...
     * 获取最大容积
     *
     * @return MAX_CAPA - 最大容积
     */
    public BigDecimal getMaxCapa() {
        return maxCapa;
    }
     ...
     * @param maxCapa 最大容积
     */
    public void setMaxCapa(BigDecimal maxCapa) {
     ...
     * 获取允许容积
     *
     * @return GRANT_CAPA - 允许容积
     */
    public BigDecimal getGrantCapa() {
        return grantCapa;
    }
     ...
     * 设置允许容积
     *
     * @param grantCapa 允许容积
     */
    public void setGrantCapa(BigDecimal grantCapa) {
        this.grantCapa = grantCapa;
    }

    /**
     * 获取允许重量
     *
     * @return GRANT_WEIGHT - 允许重量
     */
    public BigDecimal getGrantWeight() {
        return grantWeight;
    }
     ...
     * 设置允许重量
     *
     * @param grantWeight 允许重量
     */
    public void setGrantWeight(BigDecimal grantWeight) {
        this.grantWeight = grantWeight;
    }

    /**
     * 获取装箱个数
     *
     * @return CASE_UNIT_NUM - 装箱个数
     */
     ...
     * 设置装箱个数
     *
     * @param caseUnitNum 装箱个数
     */
    public void setCaseUnitNum(BigDecimal caseUnitNum) {
    ...
    public boolean equals(Object that) {
        ...
        MBox other = (MBox) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            && (this.getCntrCd() == null ? other.getCntrCd() == null : this.getCntrCd().equals(other.getCntrCd()))
            && (this.getBoxCdDis() == null ? other.getBoxCdDis() == null : this.getBoxCdDis().equals(other.getBoxCdDis()))
            && (this.getBoxNm() == null ? other.getBoxNm() == null : this.getBoxNm().equals(other.getBoxNm()))
            && (this.getBoxHeight() == null ? other.getBoxHeight() == null : this.getBoxHeight().equals(other.getBoxHeight()))
            && (this.getBoxWidth() == null ? other.getBoxWidth() == null : this.getBoxWidth().equals(other.getBoxWidth()))
            && (this.getBoxDepth() == null ? other.getBoxDepth() == null : this.getBoxDepth().equals(other.getBoxDepth()))
            && (this.getMaxCapa() == null ? other.getMaxCapa() == null : this.getMaxCapa().equals(other.getMaxCapa()))
            && (this.getGrantCapa() == null ? other.getGrantCapa() == null : this.getGrantCapa().equals(other.getGrantCapa()))
            && (this.getGrantWeight() == null ? other.getGrantWeight() == null : this.getGrantWeight().equals(other.getGrantWeight()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getBoxCdDis() == null) ? 0 : getBoxCdDis().hashCode());
        result = prime * result + ((getBoxNm() == null) ? 0 : getBoxNm().hashCode());
        result = prime * result + ((getBoxHeight() == null) ? 0 : getBoxHeight().hashCode());
        result = prime * result + ((getBoxWidth() == null) ? 0 : getBoxWidth().hashCode());
        result = prime * result + ((getBoxDepth() == null) ? 0 : getBoxDepth().hashCode());
        result = prime * result + ((getMaxCapa() == null) ? 0 : getMaxCapa().hashCode());
        result = prime * result + ((getGrantCapa() == null) ? 0 : getGrantCapa().hashCode());
        result = prime * result + ((getGrantWeight() == null) ? 0 : getGrantWeight().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", boxCdDis=").append(boxCdDis);
        sb.append(", boxNm=").append(boxNm);
        sb.append(", boxHeight=").append(boxHeight);
        sb.append(", boxWidth=").append(boxWidth);
        sb.append(", boxDepth=").append(boxDepth);
        sb.append(", maxCapa=").append(maxCapa);
        sb.append(", grantCapa=").append(grantCapa);
        sb.append(", grantWeight=").append(grantWeight);
