...
@Table(name = "`t_borrow_take_register`")
public class TBorrowTakeRegister implements Serializable {
    /**
     * 主键
     */
    @Id
    ...
    public boolean equals(Object that) {
        ...
        TBorrowTakeRegister other = (TBorrowTakeRegister) that;
