...
@Table(name = "`t_purchase_ord`")
public class TPurchaseOrd implements Serializable {
    /**
     * 主键
     */
    @Id
     ...
     * 采购订单号
     */
    @Column(name = "`PURCHASE_ORD_CD`")
    private String purchaseOrdCd;

    /**
     * 采购计划明细编号
     */
    @Column(name = "`MR_PLAN_LINE_NUM`")
    private String mrPlanLineNum;
     ...
     * 采购合同编号
     */
    @Column(name = "`PURCHASE_CONTRACT_CD`")
    private String purchaseContractCd;
     ...
     * 获取采购订单号
     *
     * @return PURCHASE_ORD_CD - 采购订单号
     */
    public String getPurchaseOrdCd() {
        return purchaseOrdCd;
    }

    /**
     * 设置采购订单号
     *
     * @param purchaseOrdCd 采购订单号
     */
    public void setPurchaseOrdCd(String purchaseOrdCd) {
        this.purchaseOrdCd = purchaseOrdCd == null ? null : purchaseOrdCd.trim();
    }

    /**
     * 获取采购计划明细编号
     *
     * @return MR_PLAN_LINE_NUM - 采购计划明细编号
     */
    public String getMrPlanLineNum() {
        return mrPlanLineNum;
    }

    /**
     * 设置采购计划明细编号
     *
     * @param mrPlanLineNum 采购计划明细编号
     */
    public void setMrPlanLineNum(String mrPlanLineNum) {
        this.mrPlanLineNum = mrPlanLineNum == null ? null : mrPlanLineNum.trim();
    }
     ...
     * 获取采购合同编号
     *
     * @return PURCHASE_CONTRACT_CD - 采购合同编号
     */
    public String getPurchaseContractCd() {
        return purchaseContractCd;
    }

    /**
     * 设置采购合同编号
     *
     * @param purchaseContractCd 采购合同编号
     */
    public void setPurchaseContractCd(String purchaseContractCd) {
        this.purchaseContractCd = purchaseContractCd == null ? null : purchaseContractCd.trim();
    }
    ...
    public boolean equals(Object that) {
        ...
        TPurchaseOrd other = (TPurchaseOrd) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            && (this.getCntrCd() == null ? other.getCntrCd() == null : this.getCntrCd().equals(other.getCntrCd()))
            && (this.getPurchaseOrdCd() == null ? other.getPurchaseOrdCd() == null : this.getPurchaseOrdCd().equals(other.getPurchaseOrdCd()))
            && (this.getMrPlanLineNum() == null ? other.getMrPlanLineNum() == null : this.getMrPlanLineNum().equals(other.getMrPlanLineNum()))
            ...
            && (this.getPurchaseContractCd() == null ? other.getPurchaseContractCd() == null : this.getPurchaseContractCd().equals(other.getPurchaseContractCd()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getPurchaseOrdCd() == null) ? 0 : getPurchaseOrdCd().hashCode());
        result = prime * result + ((getMrPlanLineNum() == null) ? 0 : getMrPlanLineNum().hashCode());
        ...
        result = prime * result + ((getPurchaseContractCd() == null) ? 0 : getPurchaseContractCd().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", purchaseOrdCd=").append(purchaseOrdCd);
        sb.append(", mrPlanLineNum=").append(mrPlanLineNum);
        ...
        sb.append(", purchaseContractCd=").append(purchaseContractCd);
