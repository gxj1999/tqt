...
@Table(name = "`t_ship_order_line`")
public class TShipOrderLine implements Serializable {
    /**
     * 主键
     */
    @Id
     ...
     * 获取预定出库明细号
     *
     * @return SHP_ORD_LIN_NUM - 预定出库明细号
     */
     ...
     * 设置预定出库明细号
     *
     * @param shpOrdLinNum 预定出库明细号
     */
    public void setShpOrdLinNum(String shpOrdLinNum) {
        this.shpOrdLinNum = shpOrdLinNum == null ? null : shpOrdLinNum.trim();
    }
    ...
    public boolean equals(Object that) {
        ...
        TShipOrderLine other = (TShipOrderLine) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            && (this.getShpOrdId() == null ? other.getShpOrdId() == null : this.getShpOrdId().equals(other.getShpOrdId()))
            && (this.getShpOrdLinNum() == null ? other.getShpOrdLinNum() == null : this.getShpOrdLinNum().equals(other.getShpOrdLinNum()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getShpOrdLinNum() == null) ? 0 : getShpOrdLinNum().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", shpOrdLinNum=").append(shpOrdLinNum);
