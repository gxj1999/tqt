...
public class MUser implements Serializable {
     ...
     * 现行系统用户ID
     */
    @Column(name = "`CURRENT_SYS_USER_ID`")
     ...
     * 用户审批状态
     */
    @Column(name = "`APPROVAL_CLS_M`")
    private String approvalClsM;
    ...
    public void setUserNmEn(String userNmEn) {
        this.userNmEn = userNmEn == null ? null : userNmEn.trim();
    }
    ...
    public void setSexCd(String sexCd) {
        this.sexCd = sexCd == null ? null : sexCd.trim();
    }
     ...
     * 设置用户状态
     *
     * @param disableFlg 用户状态
     */
    public void setDisableFlg(String disableFlg) {
        this.disableFlg = disableFlg == null ? null : disableFlg.trim();
    }

    /**
     * 获取现行系统用户ID
     *
     * @return CURRENT_SYS_USER_ID - 现行系统用户ID
     */
     ...
     * 设置现行系统用户ID
     *
     * @param currentSysUserId 现行系统用户ID
     */
    public void setCurrentSysUserId(String currentSysUserId) {
        this.currentSysUserId = currentSysUserId == null ? null : currentSysUserId.trim();
    }
     ...
     * 获取用户审批状态
     *
     * @return APPROVAL_CLS_M - 用户审批状态
     */
    public String getApprovalClsM() {
        return approvalClsM;
    }
     ...
     * 设置用户审批状态
     *
     * @param approvalClsM 用户审批状态
     */
    public void setApprovalClsM(String approvalClsM) {
        this.approvalClsM = approvalClsM == null ? null : approvalClsM.trim();
    }
    ...
    public boolean equals(Object that) {
        ...
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getUserNmEn() == null ? other.getUserNmEn() == null : this.getUserNmEn().equals(other.getUserNmEn()))
            && (this.getSexCd() == null ? other.getSexCd() == null : this.getSexCd().equals(other.getSexCd()))
            && (this.getWorkId() == null ? other.getWorkId() == null : this.getWorkId().equals(other.getWorkId()))
            && (this.getUserKbn() == null ? other.getUserKbn() == null : this.getUserKbn().equals(other.getUserKbn()))
            ...
            && (this.getDisableFlg() == null ? other.getDisableFlg() == null : this.getDisableFlg().equals(other.getDisableFlg()))
            && (this.getCurrentSysUserId() == null ? other.getCurrentSysUserId() == null : this.getCurrentSysUserId().equals(other.getCurrentSysUserId()))
            && (this.getPicId() == null ? other.getPicId() == null : this.getPicId().equals(other.getPicId()))
            && (this.getPid() == null ? other.getPid() == null : this.getPid().equals(other.getPid()))
            && (this.getApprovalClsM() == null ? other.getApprovalClsM() == null : this.getApprovalClsM().equals(other.getApprovalClsM()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getUserNmEn() == null) ? 0 : getUserNmEn().hashCode());
        result = prime * result + ((getSexCd() == null) ? 0 : getSexCd().hashCode());
        result = prime * result + ((getWorkId() == null) ? 0 : getWorkId().hashCode());
        result = prime * result + ((getUserKbn() == null) ? 0 : getUserKbn().hashCode());
        ...
        result = prime * result + ((getDisableFlg() == null) ? 0 : getDisableFlg().hashCode());
        result = prime * result + ((getCurrentSysUserId() == null) ? 0 : getCurrentSysUserId().hashCode());
        result = prime * result + ((getPicId() == null) ? 0 : getPicId().hashCode());
        result = prime * result + ((getPid() == null) ? 0 : getPid().hashCode());
        result = prime * result + ((getApprovalClsM() == null) ? 0 : getApprovalClsM().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", userNmEn=").append(userNmEn);
        sb.append(", sexCd=").append(sexCd);
        sb.append(", workId=").append(workId);
        sb.append(", userKbn=").append(userKbn);
        ...
        sb.append(", currentSysUserId=").append(currentSysUserId);
        sb.append(", picId=").append(picId);
        sb.append(", pid=").append(pid);
        sb.append(", approvalClsM=").append(approvalClsM);
