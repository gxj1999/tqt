...
@ApiModel(description="标准生产流程")
@Table(name = "m_standard_mp")
public class MStandardMp implements Serializable {
    /**
     * 主键
     */
    @Id
     ...
     * 标准生产流程名
     */
    @Column(name = "STANDARD_MP_NM")
    @ApiModelProperty(value="标准生产流程名")
    private String standardMpNm;
     ...
     * @param id 主键
     */
    public MStandardMp setId(String id) {
     ...
     * @param cntrCd 中心编号
     */
    public MStandardMp setCntrCd(String cntrCd) {
     ...
     * 获取标准生产流程名
     *
     * @return STANDARD_MP_NM - 标准生产流程名
     */
    public String getStandardMpNm() {
        return standardMpNm;
    }
     ...
     * 设置标准生产流程名
     *
     * @param standardMpNm 标准生产流程名
     */
    public MStandardMp setStandardMpNm(String standardMpNm) {
        this.standardMpNm = standardMpNm == null ? null : standardMpNm.trim();
        return this;
    }
     ...
     * @param remark 备注
     */
    public MStandardMp setRemark(String remark) {
     ...
     * @param char1 文本1
     */
    public MStandardMp setChar1(String char1) {
     ...
     * @param char2 文本2
     */
    public MStandardMp setChar2(String char2) {
     ...
     * @param char3 文本3
     */
    public MStandardMp setChar3(String char3) {
     ...
     * @param char4 文本4
     */
    public MStandardMp setChar4(String char4) {
     ...
     * @param char5 文本5
     */
    public MStandardMp setChar5(String char5) {
     ...
     * @param char6 文本6
     */
    public MStandardMp setChar6(String char6) {
     ...
     * @param char7 文本7
     */
    public MStandardMp setChar7(String char7) {
     ...
     * @param char8 文本8
     */
    public MStandardMp setChar8(String char8) {
     ...
     * @param char9 文本9
     */
    public MStandardMp setChar9(String char9) {
     ...
     * @param char10 文本10
     */
    public MStandardMp setChar10(String char10) {
     ...
     * @param num1 数值1
     */
    public MStandardMp setNum1(BigDecimal num1) {
        this.num1 = num1;
        return this;
    }
     ...
     * @param num2 数值2
     */
    public MStandardMp setNum2(BigDecimal num2) {
        this.num2 = num2;
        return this;
    }
     ...
     * @param num3 数值3
     */
    public MStandardMp setNum3(BigDecimal num3) {
        this.num3 = num3;
        return this;
    }
     ...
     * @param num4 数值4
     */
    public MStandardMp setNum4(BigDecimal num4) {
        this.num4 = num4;
        return this;
    }
     ...
     * @param num5 数值5
     */
    public MStandardMp setNum5(BigDecimal num5) {
        this.num5 = num5;
        return this;
    }
     ...
     * @param num6 数值6
     */
    public MStandardMp setNum6(BigDecimal num6) {
        this.num6 = num6;
        return this;
    }
     ...
     * @param num7 数值7
     */
    public MStandardMp setNum7(BigDecimal num7) {
        this.num7 = num7;
        return this;
    }
     ...
     * @param num8 数值8
     */
    public MStandardMp setNum8(BigDecimal num8) {
        this.num8 = num8;
        return this;
    }
     ...
     * @param num9 数值9
     */
    public MStandardMp setNum9(BigDecimal num9) {
        this.num9 = num9;
        return this;
    }
     ...
     * @param num10 数值10
     */
    public MStandardMp setNum10(BigDecimal num10) {
        this.num10 = num10;
        return this;
    }
     ...
     * @param updCnt 更新次数
     */
    public MStandardMp setUpdCnt(Integer updCnt) {
        this.updCnt = updCnt;
        return this;
    }
     ...
     * @param delFlg 删除区分
     */
    public MStandardMp setDelFlg(String delFlg) {
     ...
     */
    public MStandardMp setAddEntKbn(String addEntKbn) {
     ...
     */
    public MStandardMp setAddPgmId(String addPgmId) {
     ...
     */
    public MStandardMp setAddUserId(String addUserId) {
     ...
     */
    public MStandardMp setAddUserNm(String addUserNm) {
     ...
     */
    public MStandardMp setAddTnmtId(String addTnmtId) {
     ...
     * @param addDt 登录日期
     */
    public MStandardMp setAddDt(Date addDt) {
        this.addDt = addDt;
        return this;
    }
     ...
     */
    public MStandardMp setUpdEntKbn(String updEntKbn) {
     ...
     */
    public MStandardMp setUpdPgmId(String updPgmId) {
     ...
     */
    public MStandardMp setUpdUserId(String updUserId) {
     ...
     */
    public MStandardMp setUpdUserNm(String updUserNm) {
     ...
     */
    public MStandardMp setUpdTnmtId(String updTnmtId) {
     ...
     * @param updDt 更新日期
     */
    public MStandardMp setUpdDt(Date updDt) {
        this.updDt = updDt;
        return this;
    }
    ...
    public boolean equals(Object that) {
        ...
        MStandardMp other = (MStandardMp) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            && (this.getCntrCd() == null ? other.getCntrCd() == null : this.getCntrCd().equals(other.getCntrCd()))
            && (this.getStandardMpNm() == null ? other.getStandardMpNm() == null : this.getStandardMpNm().equals(other.getStandardMpNm()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getStandardMpNm() == null) ? 0 : getStandardMpNm().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", standardMpNm=").append(standardMpNm);
