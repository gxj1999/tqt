...
@Table(name = "`t_manuf_process`")
public class TManufProcess implements Serializable {
    /**
     * 主键
     */
    @Id
    ...
    private BigDecimal tubeLength;

    /**
     * 筒角重量
     */
    @Column(name = "`TOTAL_TUBE_WEIGHT`")
    private BigDecimal totalTubeWeight;

    /**
     * 投入总重量
     */
    @Column(name = "`TOTAL_WEIGHT_IN`")
    private BigDecimal totalWeightIn;

    /**
     * 投入总数量
     */
    @Column(name = "`TOTAL_QTY_IN`")
    private BigDecimal totalQtyIn;

    /**
     * 其他投入总重量
     */
    @Column(name = "`TOTAL_OTHER_WEIGHT_IN`")
    private BigDecimal totalOtherWeightIn;

    /**
     * 其他投入总数量
     */
    @Column(name = "`TOTAL_OTHER_QTY_IN`")
    private BigDecimal totalOtherQtyIn;

    /**
     * 产出总毛重
     */
    @Column(name = "`TOTAL_GWEIGHT_OUT`")
    private BigDecimal totalGweightOut;

    /**
     * 产出总净重
     */
    @Column(name = "`TOTAL_NWEIGHT_OUT`")
    private BigDecimal totalNweightOut;

    /**
     * 产出总数量
     */
    @Column(name = "`TOTAL_QTY_OUT`")
     ...
     * 设置生产流程
     *
     * @param manufProcessCls 生产流程
     */
    public void setManufProcessCls(String manufProcessCls) {
     ...
     */
    public void setManufProcessDt(String manufProcessDt) {
     ...
     * @param lotCnt 总批次数
     */
    public void setLotCnt(BigDecimal lotCnt) {
        this.lotCnt = lotCnt;
    }
     ...
     * 获取筒角厚度
     *
     * @return TUBE_LENGTH - 筒角厚度
     */
    public BigDecimal getTubeLength() {
        return tubeLength;
    }
     ...
     * 设置筒角厚度
     *
     * @param tubeLength 筒角厚度
     */
    public void setTubeLength(BigDecimal tubeLength) {
     ...
     * 获取筒角重量
     *
     * @return TOTAL_TUBE_WEIGHT - 筒角重量
     */
    public BigDecimal getTotalTubeWeight() {
     ...
     * 设置筒角重量
     *
     * @param totalTubeWeight 筒角重量
     */
    public void setTotalTubeWeight(BigDecimal totalTubeWeight) {
        this.totalTubeWeight = totalTubeWeight;
    }
     ...
     */
    public void setTotalWeightIn(BigDecimal totalWeightIn) {
     ...
     * 获取其他投入总重量
     *
     * @return TOTAL_OTHER_WEIGHT_IN - 其他投入总重量
     */
    public BigDecimal getTotalOtherWeightIn() {
        return totalOtherWeightIn;
    }

    /**
     * 设置其他投入总重量
     *
     * @param totalOtherWeightIn 其他投入总重量
     */
    public void setTotalOtherWeightIn(BigDecimal totalOtherWeightIn) {
        this.totalOtherWeightIn = totalOtherWeightIn;
    }

    /**
     * 获取其他投入总数量
     *
     * @return TOTAL_OTHER_QTY_IN - 其他投入总数量
     */
    public BigDecimal getTotalOtherQtyIn() {
        return totalOtherQtyIn;
    }

    /**
     * 设置其他投入总数量
     *
     * @param totalOtherQtyIn 其他投入总数量
     */
    public void setTotalOtherQtyIn(BigDecimal totalOtherQtyIn) {
        this.totalOtherQtyIn = totalOtherQtyIn;
    }

    /**
     * 获取产出总毛重
     *
     * @return TOTAL_GWEIGHT_OUT - 产出总毛重
     */
    public BigDecimal getTotalGweightOut() {
        return totalGweightOut;
    }

    /**
     * 设置产出总毛重
     *
     * @param totalGweightOut 产出总毛重
     */
    public void setTotalGweightOut(BigDecimal totalGweightOut) {
        this.totalGweightOut = totalGweightOut;
    }

    /**
     * 获取产出总净重
     *
     * @return TOTAL_NWEIGHT_OUT - 产出总净重
     */
    public BigDecimal getTotalNweightOut() {
        return totalNweightOut;
    }

    /**
     * 设置产出总净重
     *
     * @param totalNweightOut 产出总净重
     */
    public void setTotalNweightOut(BigDecimal totalNweightOut) {
        this.totalNweightOut = totalNweightOut;
    }

    /**
     * 获取产出总数量
     *
     * @return TOTAL_QTY_OUT - 产出总数量
     */
     ...
     * @param outFlg 外发标志
     */
    public void setOutFlg(BigDecimal outFlg) {
        this.outFlg = outFlg;
    }
    ...
    public boolean equals(Object that) {
        ...
        TManufProcess other = (TManufProcess) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getLotCnt() == null ? other.getLotCnt() == null : this.getLotCnt().equals(other.getLotCnt()))
            && (this.getUnit() == null ? other.getUnit() == null : this.getUnit().equals(other.getUnit()))
            && (this.getTubeLength() == null ? other.getTubeLength() == null : this.getTubeLength().equals(other.getTubeLength()))
            && (this.getTotalTubeWeight() == null ? other.getTotalTubeWeight() == null : this.getTotalTubeWeight().equals(other.getTotalTubeWeight()))
            ...
            && (this.getTotalOtherWeightIn() == null ? other.getTotalOtherWeightIn() == null : this.getTotalOtherWeightIn().equals(other.getTotalOtherWeightIn()))
            && (this.getTotalOtherQtyIn() == null ? other.getTotalOtherQtyIn() == null : this.getTotalOtherQtyIn().equals(other.getTotalOtherQtyIn()))
            && (this.getTotalGweightOut() == null ? other.getTotalGweightOut() == null : this.getTotalGweightOut().equals(other.getTotalGweightOut()))
            && (this.getTotalNweightOut() == null ? other.getTotalNweightOut() == null : this.getTotalNweightOut().equals(other.getTotalNweightOut()))
            && (this.getTotalQtyOut() == null ? other.getTotalQtyOut() == null : this.getTotalQtyOut().equals(other.getTotalQtyOut()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getLotCnt() == null) ? 0 : getLotCnt().hashCode());
        result = prime * result + ((getUnit() == null) ? 0 : getUnit().hashCode());
        result = prime * result + ((getTubeLength() == null) ? 0 : getTubeLength().hashCode());
        result = prime * result + ((getTotalTubeWeight() == null) ? 0 : getTotalTubeWeight().hashCode());
        ...
        result = prime * result + ((getTotalOtherWeightIn() == null) ? 0 : getTotalOtherWeightIn().hashCode());
        result = prime * result + ((getTotalOtherQtyIn() == null) ? 0 : getTotalOtherQtyIn().hashCode());
        result = prime * result + ((getTotalGweightOut() == null) ? 0 : getTotalGweightOut().hashCode());
        result = prime * result + ((getTotalNweightOut() == null) ? 0 : getTotalNweightOut().hashCode());
        result = prime * result + ((getTotalQtyOut() == null) ? 0 : getTotalQtyOut().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", lotCnt=").append(lotCnt);
        sb.append(", unit=").append(unit);
        sb.append(", tubeLength=").append(tubeLength);
        sb.append(", totalTubeWeight=").append(totalTubeWeight);
        sb.append(", totalWeightIn=").append(totalWeightIn);
        sb.append(", totalQtyIn=").append(totalQtyIn);
        sb.append(", totalOtherWeightIn=").append(totalOtherWeightIn);
        sb.append(", totalOtherQtyIn=").append(totalOtherQtyIn);
        sb.append(", totalGweightOut=").append(totalGweightOut);
        sb.append(", totalNweightOut=").append(totalNweightOut);
        sb.append(", totalQtyOut=").append(totalQtyOut);
