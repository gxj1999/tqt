...
@ApiModel(description="班组")
@Table(name = "m_workgroup")
public class MWorkgroup implements Serializable {
    /**
     * 主键
     */
    @Id
     ...
     * 表示用班组编号
     */
    @Column(name = "WORKGROUP_CD")
    @ApiModelProperty(value="表示用班组编号")
     ...
     * 班组简称
     */
    @Column(name = "WORKGROUP_ABBR")
    @ApiModelProperty(value="班组简称")
    private String workgroupAbbr;

    /**
     * 班组英文名称
     */
    @Column(name = "WORKGROUP_ENG_NM")
    @ApiModelProperty(value="班组英文名称")
    private String workgroupEngNm;
     ...
     */
    @Column(name = "ORG_ID")
    @ApiModelProperty(value="所属组织部门编号")
     ...
     * @param id 主键
     */
    public MWorkgroup setId(String id) {
     ...
     * @param cntrCd 中心编号
     */
    public MWorkgroup setCntrCd(String cntrCd) {
     ...
     * 设置表示用班组编号
     *
     * @param workgroupCd 表示用班组编号
     */
    public MWorkgroup setWorkgroupCd(String workgroupCd) {
        this.workgroupCd = workgroupCd == null ? null : workgroupCd.trim();
        return this;
    }
     ...
     * 设置班组名称
     *
     * @param workgroupNm 班组名称
     */
    public MWorkgroup setWorkgroupNm(String workgroupNm) {
        this.workgroupNm = workgroupNm == null ? null : workgroupNm.trim();
        return this;
    }
     ...
     * 获取班组简称
     *
     * @return WORKGROUP_ABBR - 班组简称
     */
    public String getWorkgroupAbbr() {
        return workgroupAbbr;
    }

    /**
     * 设置班组简称
     *
     * @param workgroupAbbr 班组简称
     */
    public MWorkgroup setWorkgroupAbbr(String workgroupAbbr) {
        this.workgroupAbbr = workgroupAbbr == null ? null : workgroupAbbr.trim();
        return this;
    }
     ...
     * 获取班组英文名称
     *
     * @return WORKGROUP_ENG_NM - 班组英文名称
     */
    public String getWorkgroupEngNm() {
        return workgroupEngNm;
    }

    /**
     * 设置班组英文名称
     *
     * @param workgroupEngNm 班组英文名称
     */
    public MWorkgroup setWorkgroupEngNm(String workgroupEngNm) {
        this.workgroupEngNm = workgroupEngNm == null ? null : workgroupEngNm.trim();
        return this;
    }
     ...
     * 设置班组类型
     *
     * @param workgroupType 班组类型
     */
    public MWorkgroup setWorkgroupType(String workgroupType) {
     ...
     * 设置所属组织部门编号
     *
     * @param orgId 所属组织部门编号
     */
    public MWorkgroup setOrgId(String orgId) {
     ...
     * 设置负责人ID
     *
     * @param chargeUserId 负责人ID
     */
    public MWorkgroup setChargeUserId(String chargeUserId) {
     ...
     * @param remarks 备注
     */
    public MWorkgroup setRemarks(String remarks) {
     ...
     * @param char1 文本1
     */
    public MWorkgroup setChar1(String char1) {
     ...
     * @param char2 文本2
     */
    public MWorkgroup setChar2(String char2) {
     ...
     * @param char3 文本3
     */
    public MWorkgroup setChar3(String char3) {
     ...
     * @param char4 文本4
     */
    public MWorkgroup setChar4(String char4) {
     ...
     * @param char5 文本5
     */
    public MWorkgroup setChar5(String char5) {
     ...
     * @param char6 文本6
     */
    public MWorkgroup setChar6(String char6) {
     ...
     * @param char7 文本7
     */
    public MWorkgroup setChar7(String char7) {
     ...
     * @param char8 文本8
     */
    public MWorkgroup setChar8(String char8) {
     ...
     * @param char9 文本9
     */
    public MWorkgroup setChar9(String char9) {
     ...
     * @param char10 文本10
     */
    public MWorkgroup setChar10(String char10) {
     ...
     * @param num1 数值1
     */
    public MWorkgroup setNum1(BigDecimal num1) {
        this.num1 = num1;
        return this;
    }
     ...
     * @param num2 数值2
     */
    public MWorkgroup setNum2(BigDecimal num2) {
        this.num2 = num2;
        return this;
    }
     ...
     * @param num3 数值3
     */
    public MWorkgroup setNum3(BigDecimal num3) {
        this.num3 = num3;
        return this;
    }
     ...
     * @param num4 数值4
     */
    public MWorkgroup setNum4(BigDecimal num4) {
        this.num4 = num4;
        return this;
    }
     ...
     * @param num5 数值5
     */
    public MWorkgroup setNum5(BigDecimal num5) {
        this.num5 = num5;
        return this;
    }
     ...
     * @param num6 数值6
     */
    public MWorkgroup setNum6(BigDecimal num6) {
        this.num6 = num6;
        return this;
    }
     ...
     * @param num7 数值7
     */
    public MWorkgroup setNum7(BigDecimal num7) {
        this.num7 = num7;
        return this;
    }
     ...
     * @param num8 数值8
     */
    public MWorkgroup setNum8(BigDecimal num8) {
        this.num8 = num8;
        return this;
    }
     ...
     * @param num9 数值9
     */
    public MWorkgroup setNum9(BigDecimal num9) {
        this.num9 = num9;
        return this;
    }
     ...
     * @param num10 数值10
     */
    public MWorkgroup setNum10(BigDecimal num10) {
        this.num10 = num10;
        return this;
    }
     ...
     * @param updCnt 更新次数
     */
    public MWorkgroup setUpdCnt(Integer updCnt) {
        this.updCnt = updCnt;
        return this;
    }
     ...
     * @param delFlg 删除区分
     */
    public MWorkgroup setDelFlg(String delFlg) {
     ...
     */
    public MWorkgroup setAddEntKbn(String addEntKbn) {
     ...
     */
    public MWorkgroup setAddPgmId(String addPgmId) {
     ...
     */
    public MWorkgroup setAddUserId(String addUserId) {
     ...
     */
    public MWorkgroup setAddUserNm(String addUserNm) {
     ...
     */
    public MWorkgroup setAddTnmtId(String addTnmtId) {
     ...
     * @param addDt 登录日期
     */
    public MWorkgroup setAddDt(Date addDt) {
        this.addDt = addDt;
        return this;
    }
     ...
     */
    public MWorkgroup setUpdEntKbn(String updEntKbn) {
     ...
     */
    public MWorkgroup setUpdPgmId(String updPgmId) {
     ...
     */
    public MWorkgroup setUpdUserId(String updUserId) {
     ...
     */
    public MWorkgroup setUpdUserNm(String updUserNm) {
     ...
     */
    public MWorkgroup setUpdTnmtId(String updTnmtId) {
     ...
     * @param updDt 更新日期
     */
    public MWorkgroup setUpdDt(Date updDt) {
        this.updDt = updDt;
        return this;
    }
    ...
    public boolean equals(Object that) {
        ...
        MWorkgroup other = (MWorkgroup) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            && (this.getCntrCd() == null ? other.getCntrCd() == null : this.getCntrCd().equals(other.getCntrCd()))
            && (this.getWorkgroupCd() == null ? other.getWorkgroupCd() == null : this.getWorkgroupCd().equals(other.getWorkgroupCd()))
            && (this.getWorkgroupNm() == null ? other.getWorkgroupNm() == null : this.getWorkgroupNm().equals(other.getWorkgroupNm()))
            && (this.getWorkgroupAbbr() == null ? other.getWorkgroupAbbr() == null : this.getWorkgroupAbbr().equals(other.getWorkgroupAbbr()))
            && (this.getWorkgroupEngNm() == null ? other.getWorkgroupEngNm() == null : this.getWorkgroupEngNm().equals(other.getWorkgroupEngNm()))
            && (this.getWorkgroupType() == null ? other.getWorkgroupType() == null : this.getWorkgroupType().equals(other.getWorkgroupType()))
            && (this.getOrgId() == null ? other.getOrgId() == null : this.getOrgId().equals(other.getOrgId()))
            && (this.getChargeUserId() == null ? other.getChargeUserId() == null : this.getChargeUserId().equals(other.getChargeUserId()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getWorkgroupCd() == null) ? 0 : getWorkgroupCd().hashCode());
        result = prime * result + ((getWorkgroupNm() == null) ? 0 : getWorkgroupNm().hashCode());
        result = prime * result + ((getWorkgroupAbbr() == null) ? 0 : getWorkgroupAbbr().hashCode());
        result = prime * result + ((getWorkgroupEngNm() == null) ? 0 : getWorkgroupEngNm().hashCode());
        result = prime * result + ((getWorkgroupType() == null) ? 0 : getWorkgroupType().hashCode());
        result = prime * result + ((getOrgId() == null) ? 0 : getOrgId().hashCode());
        result = prime * result + ((getChargeUserId() == null) ? 0 : getChargeUserId().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", workgroupCd=").append(workgroupCd);
        sb.append(", workgroupNm=").append(workgroupNm);
        sb.append(", workgroupAbbr=").append(workgroupAbbr);
        sb.append(", workgroupEngNm=").append(workgroupEngNm);
        sb.append(", workgroupType=").append(workgroupType);
        sb.append(", orgId=").append(orgId);
        sb.append(", chargeUserId=").append(chargeUserId);
