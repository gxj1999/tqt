...
public class TPurchaseContract implements Serializable {
    /**
     * 主键
     */
    @Id
    ...
    public boolean equals(Object that) {
        ...
        TPurchaseContract other = (TPurchaseContract) that;
