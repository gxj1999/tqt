...
@Table(name = "`t_stock_trns_book`")
public class TStockTrnsBook implements Serializable {
    /**
     * 主键
     */
    @Id
     ...
     * 账面库存收付编号
     */
    @Column(name = "`TRN_BOOK_NUM`")
    private String trnBookNum;

    /**
     * 账面库存收付明细号
     */
    @Column(name = "`TRN_BOOK_LINE_NUM`")
    private String trnBookLineNum;
     ...
     * 获取账面库存收付编号
     *
     * @return TRN_BOOK_NUM - 账面库存收付编号
     */
    public String getTrnBookNum() {
        return trnBookNum;
    }
     ...
     * 设置账面库存收付编号
     *
     * @param trnBookNum 账面库存收付编号
     */
    public void setTrnBookNum(String trnBookNum) {
        this.trnBookNum = trnBookNum == null ? null : trnBookNum.trim();
    }

    /**
     * 获取账面库存收付明细号
     *
     * @return TRN_BOOK_LINE_NUM - 账面库存收付明细号
     */
    public String getTrnBookLineNum() {
        return trnBookLineNum;
    }

    /**
     * 设置账面库存收付明细号
     *
     * @param trnBookLineNum 账面库存收付明细号
     */
    public void setTrnBookLineNum(String trnBookLineNum) {
        this.trnBookLineNum = trnBookLineNum == null ? null : trnBookLineNum.trim();
    }
    ...
    public boolean equals(Object that) {
        ...
        TStockTrnsBook other = (TStockTrnsBook) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            && (this.getTrnBookNum() == null ? other.getTrnBookNum() == null : this.getTrnBookNum().equals(other.getTrnBookNum()))
            && (this.getTrnBookLineNum() == null ? other.getTrnBookLineNum() == null : this.getTrnBookLineNum().equals(other.getTrnBookLineNum()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getTrnBookNum() == null) ? 0 : getTrnBookNum().hashCode());
        result = prime * result + ((getTrnBookLineNum() == null) ? 0 : getTrnBookLineNum().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", trnBookNum=").append(trnBookNum);
        sb.append(", trnBookLineNum=").append(trnBookLineNum);
