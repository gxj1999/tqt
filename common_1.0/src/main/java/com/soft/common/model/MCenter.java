...
public class MCenter implements Serializable {
     ...
     * 中心表示用编号
     */
    @Column(name = "`CNTR_CD_DIS`")
    private String cntrCdDis;
     ...
     * 获取中心表示用编号
     *
     * @return CNTR_CD_DIS - 中心表示用编号
     */
    public String getCntrCdDis() {
        return cntrCdDis;
    }
     ...
     * 设置中心表示用编号
     *
     * @param cntrCdDis 中心表示用编号
     */
    public void setCntrCdDis(String cntrCdDis) {
        this.cntrCdDis = cntrCdDis == null ? null : cntrCdDis.trim();
    }
    ...
    public void setCntrNm(String cntrNm) {
        this.cntrNm = cntrNm == null ? null : cntrNm.trim();
    }

    /**
     * 获取中心表示用名称
     *
     * @return CNTR_NM_DIS - 中心表示用名称
     */
     ...
     * 设置中心表示用名称
     *
     * @param cntrNmDis 中心表示用名称
     */
    public void setCntrNmDis(String cntrNmDis) {
        this.cntrNmDis = cntrNmDis == null ? null : cntrNmDis.trim();
    }

    /**
     * 获取中心类型
     *
     * @return CNTR_TYPE - 中心类型
     */
    ...
    public boolean equals(Object that) {
        ...
        MCenter other = (MCenter) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            && (this.getCntrCdDis() == null ? other.getCntrCdDis() == null : this.getCntrCdDis().equals(other.getCntrCdDis()))
            && (this.getCntrNm() == null ? other.getCntrNm() == null : this.getCntrNm().equals(other.getCntrNm()))
            && (this.getCntrNmDis() == null ? other.getCntrNmDis() == null : this.getCntrNmDis().equals(other.getCntrNmDis()))
            && (this.getCntrType() == null ? other.getCntrType() == null : this.getCntrType().equals(other.getCntrType()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getCntrCdDis() == null) ? 0 : getCntrCdDis().hashCode());
        result = prime * result + ((getCntrNm() == null) ? 0 : getCntrNm().hashCode());
        result = prime * result + ((getCntrNmDis() == null) ? 0 : getCntrNmDis().hashCode());
        result = prime * result + ((getCntrType() == null) ? 0 : getCntrType().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", cntrCdDis=").append(cntrCdDis);
        sb.append(", cntrNm=").append(cntrNm);
        sb.append(", cntrNmDis=").append(cntrNmDis);
