...
public class MProductClass implements Serializable {
    /**
     * 主键
     */
    @Id
     ...
     * 商品分类表示用编号
     */
    @Column(name = "PROD_CLASS_CD_DIS")
    @ApiModelProperty(value="商品分类表示用编号")
    private String prodClassCdDis;

    /**
     * 商品分类名称
     */
    @Column(name = "PROD_CLASS_NM")
     ...
     * 商品分类简称
     */
    @Column(name = "PROD_CLASS_JC")
    @ApiModelProperty(value="商品分类简称")
    private String prodClassJc;

    /**
     * 商品分类英文名称
     */
    @Column(name = "PROD_CLASS_NM_EN")
    @ApiModelProperty(value="商品分类英文名称")
    private String prodClassNmEn;
     ...
     * @param id 主键
     */
    public MProductClass setId(String id) {
     ...
     * @param cntrCd 中心编号
     */
    public MProductClass setCntrCd(String cntrCd) {
     ...
     * 获取商品分类表示用编号
     *
     * @return PROD_CLASS_CD_DIS - 商品分类表示用编号
     */
    public String getProdClassCdDis() {
        return prodClassCdDis;
    }
     ...
     */
    public MProductClass setProdClassCdDis(String prodClassCdDis) {
        this.prodClassCdDis = prodClassCdDis == null ? null : prodClassCdDis.trim();
        return this;
    }
     ...
     */
    public MProductClass setProdClassNm(String prodClassNm) {
        this.prodClassNm = prodClassNm == null ? null : prodClassNm.trim();
        return this;
    }
     ...
     * 获取商品分类简称
     *
     * @return PROD_CLASS_JC - 商品分类简称
     */
    public String getProdClassJc() {
        return prodClassJc;
    }
     ...
     */
    public MProductClass setProdClassJc(String prodClassJc) {
        this.prodClassJc = prodClassJc == null ? null : prodClassJc.trim();
        return this;
    }
     ...
     * 获取商品分类英文名称
     *
     * @return PROD_CLASS_NM_EN - 商品分类英文名称
     */
    public String getProdClassNmEn() {
        return prodClassNmEn;
    }
     ...
     */
    public MProductClass setProdClassNmEn(String prodClassNmEn) {
        this.prodClassNmEn = prodClassNmEn == null ? null : prodClassNmEn.trim();
        return this;
    }
     ...
     * @param prodType 商品种类
     */
    public MProductClass setProdType(String prodType) {
     ...
     */
    public MProductClass setClassLevel(String classLevel) {
     ...
     * 设置父类主键
     *
     * @param parentClass 父类主键
     */
    public MProductClass setParentClass(String parentClass) {
     ...
     * @param path 分类路径
     */
    public MProductClass setPath(String path) {
     ...
     * @param remarks 备注
     */
    public MProductClass setRemarks(String remarks) {
     ...
     * @param char1 文本1
     */
    public MProductClass setChar1(String char1) {
     ...
     * @param char2 文本2
     */
    public MProductClass setChar2(String char2) {
     ...
     * @param char3 文本3
     */
    public MProductClass setChar3(String char3) {
     ...
     * @param char4 文本4
     */
    public MProductClass setChar4(String char4) {
     ...
     * @param char5 文本5
     */
    public MProductClass setChar5(String char5) {
     ...
     * @param char6 文本6
     */
    public MProductClass setChar6(String char6) {
     ...
     * @param char7 文本7
     */
    public MProductClass setChar7(String char7) {
     ...
     * @param char8 文本8
     */
    public MProductClass setChar8(String char8) {
     ...
     * @param char9 文本9
     */
    public MProductClass setChar9(String char9) {
     ...
     * @param char10 文本10
     */
    public MProductClass setChar10(String char10) {
     ...
     * @param num1 数值1
     */
    public MProductClass setNum1(BigDecimal num1) {
        this.num1 = num1;
        return this;
    }
     ...
     * @param num2 数值2
     */
    public MProductClass setNum2(BigDecimal num2) {
        this.num2 = num2;
        return this;
    }
     ...
     * @param num3 数值3
     */
    public MProductClass setNum3(BigDecimal num3) {
        this.num3 = num3;
        return this;
    }
     ...
     * @param num4 数值4
     */
    public MProductClass setNum4(BigDecimal num4) {
        this.num4 = num4;
        return this;
    }
     ...
     * @param num5 数值5
     */
    public MProductClass setNum5(BigDecimal num5) {
        this.num5 = num5;
        return this;
    }
     ...
     * @param num6 数值6
     */
    public MProductClass setNum6(BigDecimal num6) {
        this.num6 = num6;
        return this;
    }
     ...
     * @param num7 数值7
     */
    public MProductClass setNum7(BigDecimal num7) {
        this.num7 = num7;
        return this;
    }
     ...
     * @param num8 数值8
     */
    public MProductClass setNum8(BigDecimal num8) {
        this.num8 = num8;
        return this;
    }
     ...
     * @param num9 数值9
     */
    public MProductClass setNum9(BigDecimal num9) {
        this.num9 = num9;
        return this;
    }
     ...
     * @param num10 数值10
     */
    public MProductClass setNum10(BigDecimal num10) {
        this.num10 = num10;
        return this;
    }
     ...
     * @param updCnt 更新次数
     */
    public MProductClass setUpdCnt(Integer updCnt) {
        this.updCnt = updCnt;
        return this;
    }
     ...
     * @param delFlg 删除区分
     */
    public MProductClass setDelFlg(String delFlg) {
     ...
     */
    public MProductClass setAddEntKbn(String addEntKbn) {
     ...
     */
    public MProductClass setAddPgmId(String addPgmId) {
     ...
     */
    public MProductClass setAddUserId(String addUserId) {
     ...
     */
    public MProductClass setAddUserNm(String addUserNm) {
     ...
     */
    public MProductClass setAddTnmtId(String addTnmtId) {
     ...
     * @param addDt 登录日期
     */
    public MProductClass setAddDt(Date addDt) {
        this.addDt = addDt;
        return this;
    }
     ...
     */
    public MProductClass setUpdEntKbn(String updEntKbn) {
     ...
     */
    public MProductClass setUpdPgmId(String updPgmId) {
     ...
     */
    public MProductClass setUpdUserId(String updUserId) {
     ...
     */
    public MProductClass setUpdUserNm(String updUserNm) {
     ...
     */
    public MProductClass setUpdTnmtId(String updTnmtId) {
     ...
     * @param updDt 更新日期
     */
    public MProductClass setUpdDt(Date updDt) {
        this.updDt = updDt;
        return this;
    }
    ...
    public boolean equals(Object that) {
        ...
        MProductClass other = (MProductClass) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            && (this.getCntrCd() == null ? other.getCntrCd() == null : this.getCntrCd().equals(other.getCntrCd()))
            && (this.getProdClassCdDis() == null ? other.getProdClassCdDis() == null : this.getProdClassCdDis().equals(other.getProdClassCdDis()))
            && (this.getProdClassNm() == null ? other.getProdClassNm() == null : this.getProdClassNm().equals(other.getProdClassNm()))
            && (this.getProdClassJc() == null ? other.getProdClassJc() == null : this.getProdClassJc().equals(other.getProdClassJc()))
            && (this.getProdClassNmEn() == null ? other.getProdClassNmEn() == null : this.getProdClassNmEn().equals(other.getProdClassNmEn()))
            && (this.getProdType() == null ? other.getProdType() == null : this.getProdType().equals(other.getProdType()))
            && (this.getClassLevel() == null ? other.getClassLevel() == null : this.getClassLevel().equals(other.getClassLevel()))
            && (this.getParentClass() == null ? other.getParentClass() == null : this.getParentClass().equals(other.getParentClass()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getProdClassCdDis() == null) ? 0 : getProdClassCdDis().hashCode());
        result = prime * result + ((getProdClassNm() == null) ? 0 : getProdClassNm().hashCode());
        result = prime * result + ((getProdClassJc() == null) ? 0 : getProdClassJc().hashCode());
        result = prime * result + ((getProdClassNmEn() == null) ? 0 : getProdClassNmEn().hashCode());
        result = prime * result + ((getProdType() == null) ? 0 : getProdType().hashCode());
        result = prime * result + ((getClassLevel() == null) ? 0 : getClassLevel().hashCode());
        result = prime * result + ((getParentClass() == null) ? 0 : getParentClass().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", prodClassCdDis=").append(prodClassCdDis);
        sb.append(", prodClassNm=").append(prodClassNm);
        sb.append(", prodClassJc=").append(prodClassJc);
        sb.append(", prodClassNmEn=").append(prodClassNmEn);
        sb.append(", prodType=").append(prodType);
        sb.append(", classLevel=").append(classLevel);
        sb.append(", parentClass=").append(parentClass);
