...
@Table(name = "`t_sample_plan`")
public class TSamplePlan implements Serializable {
    /**
     * 主键
     */
    @Id
     ...
     * 复样状态
     */
    @Column(name = "`SAMPLE_CLS`")
    private String sampleCls;

    /**
     * 复样完成时间
     */
    @Column(name = "`SAMPLE_DT`")
    private String sampleDt;
     ...
     * 获取复样状态
     *
     * @return SAMPLE_CLS - 复样状态
     */
    public String getSampleCls() {
        return sampleCls;
    }
     ...
     * 设置复样状态
     *
     * @param sampleCls 复样状态
     */
    public void setSampleCls(String sampleCls) {
        this.sampleCls = sampleCls == null ? null : sampleCls.trim();
    }

    /**
     * 获取复样完成时间
     *
     * @return SAMPLE_DT - 复样完成时间
     */
     ...
     * 设置复样完成时间
     *
     * @param sampleDt 复样完成时间
     */
    public void setSampleDt(String sampleDt) {
        this.sampleDt = sampleDt == null ? null : sampleDt.trim();
    }

    /**
     * 获取执行车间编号
     *
     * @return ORG_ID - 执行车间编号
     */
    ...
    public boolean equals(Object that) {
        ...
        TSamplePlan other = (TSamplePlan) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getSampleCls() == null ? other.getSampleCls() == null : this.getSampleCls().equals(other.getSampleCls()))
            && (this.getSampleDt() == null ? other.getSampleDt() == null : this.getSampleDt().equals(other.getSampleDt()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getSampleCls() == null) ? 0 : getSampleCls().hashCode());
        result = prime * result + ((getSampleDt() == null) ? 0 : getSampleDt().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", sampleCls=").append(sampleCls);
        sb.append(", sampleDt=").append(sampleDt);
