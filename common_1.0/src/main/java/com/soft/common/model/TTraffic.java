...
public class TTraffic implements Serializable {
     ...
     * 物流配送编号
     */
    @Column(name = "`TRAF_NUM`")
    private String trafNum;
     ...
     * 配送状态
     */
    @Column(name = "`TRAF_CLS`")
    private String trafCls;
     ...
     * 预定送达时间
     */
    @Column(name = "`TRAF_ORD_DT`")
    private String trafOrdDt;
     ...
     * 送货地点
     */
    @Column(name = "`TRAF_ADDRESS`")
    private String trafAddress;

    /**
     * 配送标志
     */
    @Column(name = "`TRAF_FLG`")
    private String trafFlg;
     ...
     * 装车总毛重
     */
    @Column(name = "`TOTAL_GWEIGHT`")
    private BigDecimal totalGweight;

    /**
     * 装车总净重
     */
    @Column(name = "`TOTAL_NWEIGHT`")
     ...
     * 获取物流配送编号
     *
     * @return TRAF_NUM - 物流配送编号
     */
    public String getTrafNum() {
        return trafNum;
    }
     ...
     * 设置物流配送编号
     *
     * @param trafNum 物流配送编号
     */
    public void setTrafNum(String trafNum) {
        this.trafNum = trafNum == null ? null : trafNum.trim();
    }
     ...
     * 获取配送状态
     *
     * @return TRAF_CLS - 配送状态
     */
    public String getTrafCls() {
        return trafCls;
    }
     ...
     * @param trafCls 配送状态
     */
    public void setTrafCls(String trafCls) {
        this.trafCls = trafCls == null ? null : trafCls.trim();
    }
    ...
    public void setShpDt(String shpDt) {
        this.shpDt = shpDt == null ? null : shpDt.trim();
    }

    /**
     * 获取预定送达时间
     *
     * @return TRAF_ORD_DT - 预定送达时间
     */
    public String getTrafOrdDt() {
        return trafOrdDt;
    }
     ...
     * 设置预定送达时间
     *
     * @param trafOrdDt 预定送达时间
     */
    public void setTrafOrdDt(String trafOrdDt) {
        this.trafOrdDt = trafOrdDt == null ? null : trafOrdDt.trim();
    }
     ...
     * @param trafDt 送达时间
     */
    public void setTrafDt(Date trafDt) {
        this.trafDt = trafDt;
    }
     ...
     * 获取送货地点
     *
     * @return TRAF_ADDRESS - 送货地点
     */
    public String getTrafAddress() {
        return trafAddress;
    }
     ...
     * 设置送货地点
     *
     * @param trafAddress 送货地点
     */
    public void setTrafAddress(String trafAddress) {
        this.trafAddress = trafAddress == null ? null : trafAddress.trim();
    }

    /**
     * 获取配送标志
     *
     * @return TRAF_FLG - 配送标志
     */
    public String getTrafFlg() {
        return trafFlg;
    }
     ...
     * @param trafFlg 配送标志
     */
    public void setTrafFlg(String trafFlg) {
        this.trafFlg = trafFlg == null ? null : trafFlg.trim();
    }
     ...
     * 设置物流单据号
     *
     * @param carrierNum 物流单据号
     */
    public void setCarrierNum(String carrierNum) {
        this.carrierNum = carrierNum == null ? null : carrierNum.trim();
    }
    ...
    public boolean equals(Object that) {
        ...
        TTraffic other = (TTraffic) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            && (this.getTrafNum() == null ? other.getTrafNum() == null : this.getTrafNum().equals(other.getTrafNum()))
            && (this.getShpNum() == null ? other.getShpNum() == null : this.getShpNum().equals(other.getShpNum()))
            && (this.getTrafCls() == null ? other.getTrafCls() == null : this.getTrafCls().equals(other.getTrafCls()))
            && (this.getShpDt() == null ? other.getShpDt() == null : this.getShpDt().equals(other.getShpDt()))
            && (this.getTrafOrdDt() == null ? other.getTrafOrdDt() == null : this.getTrafOrdDt().equals(other.getTrafOrdDt()))
            && (this.getTrafDt() == null ? other.getTrafDt() == null : this.getTrafDt().equals(other.getTrafDt()))
            && (this.getTrafAddress() == null ? other.getTrafAddress() == null : this.getTrafAddress().equals(other.getTrafAddress()))
            && (this.getTrafFlg() == null ? other.getTrafFlg() == null : this.getTrafFlg().equals(other.getTrafFlg()))
            && (this.getCarrierId() == null ? other.getCarrierId() == null : this.getCarrierId().equals(other.getCarrierId()))
            && (this.getCarrierNum() == null ? other.getCarrierNum() == null : this.getCarrierNum().equals(other.getCarrierNum()))
            ...
            && (this.getTotalGweight() == null ? other.getTotalGweight() == null : this.getTotalGweight().equals(other.getTotalGweight()))
            && (this.getTotalNweight() == null ? other.getTotalNweight() == null : this.getTotalNweight().equals(other.getTotalNweight()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getTrafNum() == null) ? 0 : getTrafNum().hashCode());
        result = prime * result + ((getShpNum() == null) ? 0 : getShpNum().hashCode());
        result = prime * result + ((getTrafCls() == null) ? 0 : getTrafCls().hashCode());
        result = prime * result + ((getShpDt() == null) ? 0 : getShpDt().hashCode());
        result = prime * result + ((getTrafOrdDt() == null) ? 0 : getTrafOrdDt().hashCode());
        result = prime * result + ((getTrafDt() == null) ? 0 : getTrafDt().hashCode());
        result = prime * result + ((getTrafAddress() == null) ? 0 : getTrafAddress().hashCode());
        result = prime * result + ((getTrafFlg() == null) ? 0 : getTrafFlg().hashCode());
        result = prime * result + ((getCarrierId() == null) ? 0 : getCarrierId().hashCode());
        result = prime * result + ((getCarrierNum() == null) ? 0 : getCarrierNum().hashCode());
        ...
        result = prime * result + ((getTotalGweight() == null) ? 0 : getTotalGweight().hashCode());
        result = prime * result + ((getTotalNweight() == null) ? 0 : getTotalNweight().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", trafNum=").append(trafNum);
        sb.append(", shpNum=").append(shpNum);
        sb.append(", trafCls=").append(trafCls);
        sb.append(", shpDt=").append(shpDt);
        sb.append(", trafOrdDt=").append(trafOrdDt);
        sb.append(", trafDt=").append(trafDt);
        sb.append(", trafAddress=").append(trafAddress);
        sb.append(", trafFlg=").append(trafFlg);
        sb.append(", carrierId=").append(carrierId);
        sb.append(", carrierNum=").append(carrierNum);
        ...
        sb.append(", totalGweight=").append(totalGweight);
        sb.append(", totalNweight=").append(totalNweight);
