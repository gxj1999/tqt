...
public class MSupplier implements Serializable {
     ...
     * 供应商表示用编号
     */
    @Column(name = "`SUPPLIER_CD_DIS`")
    private String supplierCdDis;
     ...
     * 供应商英文名称
     */
    @Column(name = "`SUPPLIER_NM_EN`")
    private String supplierNmEn;
     ...
     * 供应商资质认证
     */
    @Column(name = "`SUPPLIER_QC`")
    private String supplierQc;
     ...
     * 获取供应商表示用编号
     *
     * @return SUPPLIER_CD_DIS - 供应商表示用编号
     */
    public String getSupplierCdDis() {
        return supplierCdDis;
    }
     ...
     */
    public void setSupplierCdDis(String supplierCdDis) {
        this.supplierCdDis = supplierCdDis == null ? null : supplierCdDis.trim();
    }

    /**
     * 获取供应商名称
     *
     * @return SUPPLIER_NM - 供应商名称
     */
     ...
     * 获取供应商英文名称
     *
     * @return SUPPLIER_NM_EN - 供应商英文名称
     */
    public String getSupplierNmEn() {
        return supplierNmEn;
    }
     ...
     */
    public void setSupplierNmEn(String supplierNmEn) {
        this.supplierNmEn = supplierNmEn == null ? null : supplierNmEn.trim();
    }

    /**
     * 获取供应商简称
     *
     * @return SUPPLIER_JC - 供应商简称
     */
    ...
    public void setSupplierJc(String supplierJc) {
        this.supplierJc = supplierJc == null ? null : supplierJc.trim();
    }

    /**
     * 获取供应商种类
     *
     * @return SUPPLIER_TYPE - 供应商种类
     */
     ...
     * 获取供应商资质认证
     *
     * @return SUPPLIER_QC - 供应商资质认证
     */
    public String getSupplierQc() {
        return supplierQc;
    }
     ...
     * 设置供应商资质认证
     *
     * @param supplierQc 供应商资质认证
     */
    public void setSupplierQc(String supplierQc) {
        this.supplierQc = supplierQc == null ? null : supplierQc.trim();
    }
    ...
    public boolean equals(Object that) {
        ...
        MSupplier other = (MSupplier) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            && (this.getCntrCd() == null ? other.getCntrCd() == null : this.getCntrCd().equals(other.getCntrCd()))
            && (this.getSupplierCdDis() == null ? other.getSupplierCdDis() == null : this.getSupplierCdDis().equals(other.getSupplierCdDis()))
            && (this.getSupplierNm() == null ? other.getSupplierNm() == null : this.getSupplierNm().equals(other.getSupplierNm()))
            && (this.getSupplierNmEn() == null ? other.getSupplierNmEn() == null : this.getSupplierNmEn().equals(other.getSupplierNmEn()))
            && (this.getSupplierJc() == null ? other.getSupplierJc() == null : this.getSupplierJc().equals(other.getSupplierJc()))
            ...
            && (this.getSupplierQc() == null ? other.getSupplierQc() == null : this.getSupplierQc().equals(other.getSupplierQc()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getSupplierCdDis() == null) ? 0 : getSupplierCdDis().hashCode());
        result = prime * result + ((getSupplierNm() == null) ? 0 : getSupplierNm().hashCode());
        result = prime * result + ((getSupplierNmEn() == null) ? 0 : getSupplierNmEn().hashCode());
        result = prime * result + ((getSupplierJc() == null) ? 0 : getSupplierJc().hashCode());
        ...
        result = prime * result + ((getSupplierQc() == null) ? 0 : getSupplierQc().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", supplierCdDis=").append(supplierCdDis);
        sb.append(", supplierNm=").append(supplierNm);
        sb.append(", supplierNmEn=").append(supplierNmEn);
        sb.append(", supplierJc=").append(supplierJc);
        sb.append(", supplierType=").append(supplierType);
        sb.append(", integral=").append(integral);
        sb.append(", levelId=").append(levelId);
        sb.append(", supplierQc=").append(supplierQc);
