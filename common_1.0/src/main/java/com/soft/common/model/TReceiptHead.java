...
public class TReceiptHead implements Serializable {
     ...
     * 预定入库单号
     */
    @Column(name = "`RCV_ORD_ID`")
    private String rcvOrdId;

    /**
     * 预定入库明细号
     */
    @Column(name = "`RCV_ORD_LIN_ID`")
    private String rcvOrdLinId;

    /**
     * 入库单状态
     */
    @Column(name = "`RCV_CLS`")
    private String rcvCls;
     ...
     * 预定入库数量
     */
    @Column(name = "`QTY_RCV_ORD`")
    private BigDecimal qtyRcvOrd;

    /**
     * 到货毛重
     */
    @Column(name = "`GWEIGHT_ARR`")
    private BigDecimal gweightArr;

    /**
     * 到货净重
     */
    @Column(name = "`NWEIGHT_ARR`")
    private BigDecimal nweightArr;

    /**
     * 到货数量
     */
    @Column(name = "`QTY_ARR`")
    private BigDecimal qtyArr;

    /**
     * 到货验收毛重
     */
    @Column(name = "`GWEIGHT_ONS`")
    private BigDecimal gweightOns;

    /**
     * 到货验收净重
     */
    @Column(name = "`NWEIGHT_ONS`")
    private BigDecimal nweightOns;

    /**
     * 到货验收数量
     */
    @Column(name = "`QTY_ONS`")
    private BigDecimal qtyOns;

    /**
     * 入库验收毛重
     */
    @Column(name = "`GWEIGHT_RCV`")
    private BigDecimal gweightRcv;

    /**
     * 入库验收净重
     */
    @Column(name = "`NWEIGHT_RCV`")
    private BigDecimal nweightRcv;

    /**
     * 入库验收数量
     */
    @Column(name = "`QTY_RCV`")
    private BigDecimal qtyRcv;

    /**
     * 质检状态
     */
    @Column(name = "`QUALITY_CLS`")
    private String qualityCls;
     ...
     * 到货验收负责人
     */
    @Column(name = "`ONS_USER_ID`")
    private String onsUserId;

    /**
     * 到货验收时间
     */
    @Column(name = "`ONS_USER_DT`")
    private Date onsUserDt;
     ...
     * 入库验收时间
     */
    @Column(name = "`RCV_USER_DT`")
    private Date rcvUserDt;
    ...
    public void setRcvNum(String rcvNum) {
        this.rcvNum = rcvNum == null ? null : rcvNum.trim();
    }

    /**
     * 获取预定入库单号
     *
     * @return RCV_ORD_ID - 预定入库单号
     */
    public String getRcvOrdId() {
        return rcvOrdId;
    }
     ...
     * 设置预定入库单号
     *
     * @param rcvOrdId 预定入库单号
     */
    public void setRcvOrdId(String rcvOrdId) {
        this.rcvOrdId = rcvOrdId == null ? null : rcvOrdId.trim();
    }

    /**
     * 获取预定入库明细号
     *
     * @return RCV_ORD_LIN_ID - 预定入库明细号
     */
    public String getRcvOrdLinId() {
        return rcvOrdLinId;
    }
     ...
     * 设置预定入库明细号
     *
     * @param rcvOrdLinId 预定入库明细号
     */
    public void setRcvOrdLinId(String rcvOrdLinId) {
        this.rcvOrdLinId = rcvOrdLinId == null ? null : rcvOrdLinId.trim();
    }

    /**
     * 获取入库单状态
     *
     * @return RCV_CLS - 入库单状态
     */
    public String getRcvCls() {
        return rcvCls;
    }
     ...
     * @param rcvCls 入库单状态
     */
    public void setRcvCls(String rcvCls) {
        this.rcvCls = rcvCls == null ? null : rcvCls.trim();
    }

    /**
     * 获取入库类型
     *
     * @return RCV_TYPE - 入库类型
     */
     ...
     * 获取预定入库数量
     *
     * @return QTY_RCV_ORD - 预定入库数量
     */
    public BigDecimal getQtyRcvOrd() {
        return qtyRcvOrd;
    }
     ...
     * 设置预定入库数量
     *
     * @param qtyRcvOrd 预定入库数量
     */
    public void setQtyRcvOrd(BigDecimal qtyRcvOrd) {
        this.qtyRcvOrd = qtyRcvOrd;
    }

    /**
     * 获取到货毛重
     *
     * @return GWEIGHT_ARR - 到货毛重
     */
    public BigDecimal getGweightArr() {
        return gweightArr;
    }
     ...
     * 设置到货毛重
     *
     * @param gweightArr 到货毛重
     */
    public void setGweightArr(BigDecimal gweightArr) {
        this.gweightArr = gweightArr;
    }

    /**
     * 获取到货净重
     *
     * @return NWEIGHT_ARR - 到货净重
     */
    public BigDecimal getNweightArr() {
        return nweightArr;
    }
     ...
     * 设置到货净重
     *
     * @param nweightArr 到货净重
     */
    public void setNweightArr(BigDecimal nweightArr) {
        this.nweightArr = nweightArr;
    }
     ...
     * @param qtyArr 到货数量
     */
    public void setQtyArr(BigDecimal qtyArr) {
        this.qtyArr = qtyArr;
    }
     ...
     * 获取到货验收毛重
     *
     * @return GWEIGHT_ONS - 到货验收毛重
     */
    public BigDecimal getGweightOns() {
        return gweightOns;
    }
     ...
     * 设置到货验收毛重
     *
     * @param gweightOns 到货验收毛重
     */
    public void setGweightOns(BigDecimal gweightOns) {
        this.gweightOns = gweightOns;
    }

    /**
     * 获取到货验收净重
     *
     * @return NWEIGHT_ONS - 到货验收净重
     */
    public BigDecimal getNweightOns() {
        return nweightOns;
    }
     ...
     * 设置到货验收净重
     *
     * @param nweightOns 到货验收净重
     */
    public void setNweightOns(BigDecimal nweightOns) {
        this.nweightOns = nweightOns;
    }

    /**
     * 获取到货验收数量
     *
     * @return QTY_ONS - 到货验收数量
     */
    public BigDecimal getQtyOns() {
        return qtyOns;
    }
     ...
     * @param qtyOns 到货验收数量
     */
    public void setQtyOns(BigDecimal qtyOns) {
        this.qtyOns = qtyOns;
    }
     ...
     * 获取入库验收毛重
     *
     * @return GWEIGHT_RCV - 入库验收毛重
     */
    public BigDecimal getGweightRcv() {
        return gweightRcv;
    }
     ...
     * 设置入库验收毛重
     *
     * @param gweightRcv 入库验收毛重
     */
    public void setGweightRcv(BigDecimal gweightRcv) {
        this.gweightRcv = gweightRcv;
    }

    /**
     * 获取入库验收净重
     *
     * @return NWEIGHT_RCV - 入库验收净重
     */
    public BigDecimal getNweightRcv() {
        return nweightRcv;
    }
     ...
     * 设置入库验收净重
     *
     * @param nweightRcv 入库验收净重
     */
    public void setNweightRcv(BigDecimal nweightRcv) {
        this.nweightRcv = nweightRcv;
    }

    /**
     * 获取入库验收数量
     *
     * @return QTY_RCV - 入库验收数量
     */
    public BigDecimal getQtyRcv() {
        return qtyRcv;
    }
     ...
     * @param qtyRcv 入库验收数量
     */
    public void setQtyRcv(BigDecimal qtyRcv) {
        this.qtyRcv = qtyRcv;
    }
     ...
     * 获取质检状态
     *
     * @return QUALITY_CLS - 质检状态
     */
    public String getQualityCls() {
        return qualityCls;
    }
     ...
     * 设置质检状态
     *
     * @param qualityCls 质检状态
     */
    public void setQualityCls(String qualityCls) {
        this.qualityCls = qualityCls == null ? null : qualityCls.trim();
    }

    /**
     * 获取记录编号
     *
     * @return INPUT_USER_ID - 记录编号
     */
     ...
     * 获取到货验收负责人
     *
     * @return ONS_USER_ID - 到货验收负责人
     */
    public String getOnsUserId() {
        return onsUserId;
    }
     ...
     * 设置到货验收负责人
     *
     * @param onsUserId 到货验收负责人
     */
    public void setOnsUserId(String onsUserId) {
        this.onsUserId = onsUserId == null ? null : onsUserId.trim();
    }

    /**
     * 获取到货验收时间
     *
     * @return ONS_USER_DT - 到货验收时间
     */
    public Date getOnsUserDt() {
        return onsUserDt;
    }
     ...
     * 设置到货验收时间
     *
     * @param onsUserDt 到货验收时间
     */
    public void setOnsUserDt(Date onsUserDt) {
        this.onsUserDt = onsUserDt;
    }

    /**
     * 获取入库验收负责人
     *
     * @return RCV_USER_ID - 入库验收负责人
     */
     ...
     * 设置入库验收负责人
     *
     * @param rcvUserId 入库验收负责人
     */
    public void setRcvUserId(String rcvUserId) {
        this.rcvUserId = rcvUserId == null ? null : rcvUserId.trim();
    }

    /**
     * 获取入库验收时间
     *
     * @return RCV_USER_DT - 入库验收时间
     */
    public Date getRcvUserDt() {
        return rcvUserDt;
    }
     ...
     * 设置入库验收时间
     *
     * @param rcvUserDt 入库验收时间
     */
    public void setRcvUserDt(Date rcvUserDt) {
        this.rcvUserDt = rcvUserDt;
    }
    ...
    public boolean equals(Object that) {
        ...
        TReceiptHead other = (TReceiptHead) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            && (this.getRcvNum() == null ? other.getRcvNum() == null : this.getRcvNum().equals(other.getRcvNum()))
            && (this.getRcvOrdId() == null ? other.getRcvOrdId() == null : this.getRcvOrdId().equals(other.getRcvOrdId()))
            && (this.getRcvOrdLinId() == null ? other.getRcvOrdLinId() == null : this.getRcvOrdLinId().equals(other.getRcvOrdLinId()))
            && (this.getRcvCls() == null ? other.getRcvCls() == null : this.getRcvCls().equals(other.getRcvCls()))
            && (this.getRcvType() == null ? other.getRcvType() == null : this.getRcvType().equals(other.getRcvType()))
            ...
            && (this.getQtyRcvOrd() == null ? other.getQtyRcvOrd() == null : this.getQtyRcvOrd().equals(other.getQtyRcvOrd()))
            && (this.getGweightArr() == null ? other.getGweightArr() == null : this.getGweightArr().equals(other.getGweightArr()))
            && (this.getNweightArr() == null ? other.getNweightArr() == null : this.getNweightArr().equals(other.getNweightArr()))
            && (this.getQtyArr() == null ? other.getQtyArr() == null : this.getQtyArr().equals(other.getQtyArr()))
            && (this.getGweightOns() == null ? other.getGweightOns() == null : this.getGweightOns().equals(other.getGweightOns()))
            && (this.getNweightOns() == null ? other.getNweightOns() == null : this.getNweightOns().equals(other.getNweightOns()))
            && (this.getQtyOns() == null ? other.getQtyOns() == null : this.getQtyOns().equals(other.getQtyOns()))
            && (this.getGweightRcv() == null ? other.getGweightRcv() == null : this.getGweightRcv().equals(other.getGweightRcv()))
            && (this.getNweightRcv() == null ? other.getNweightRcv() == null : this.getNweightRcv().equals(other.getNweightRcv()))
            && (this.getQtyRcv() == null ? other.getQtyRcv() == null : this.getQtyRcv().equals(other.getQtyRcv()))
            && (this.getQualityCls() == null ? other.getQualityCls() == null : this.getQualityCls().equals(other.getQualityCls()))
            ...
            && (this.getOnsUserId() == null ? other.getOnsUserId() == null : this.getOnsUserId().equals(other.getOnsUserId()))
            && (this.getOnsUserDt() == null ? other.getOnsUserDt() == null : this.getOnsUserDt().equals(other.getOnsUserDt()))
            && (this.getRcvUserId() == null ? other.getRcvUserId() == null : this.getRcvUserId().equals(other.getRcvUserId()))
            && (this.getRcvUserDt() == null ? other.getRcvUserDt() == null : this.getRcvUserDt().equals(other.getRcvUserDt()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getRcvNum() == null) ? 0 : getRcvNum().hashCode());
        result = prime * result + ((getRcvOrdId() == null) ? 0 : getRcvOrdId().hashCode());
        result = prime * result + ((getRcvOrdLinId() == null) ? 0 : getRcvOrdLinId().hashCode());
        result = prime * result + ((getRcvCls() == null) ? 0 : getRcvCls().hashCode());
        result = prime * result + ((getRcvType() == null) ? 0 : getRcvType().hashCode());
        ...
        result = prime * result + ((getQtyRcvOrd() == null) ? 0 : getQtyRcvOrd().hashCode());
        result = prime * result + ((getGweightArr() == null) ? 0 : getGweightArr().hashCode());
        result = prime * result + ((getNweightArr() == null) ? 0 : getNweightArr().hashCode());
        result = prime * result + ((getQtyArr() == null) ? 0 : getQtyArr().hashCode());
        result = prime * result + ((getGweightOns() == null) ? 0 : getGweightOns().hashCode());
        result = prime * result + ((getNweightOns() == null) ? 0 : getNweightOns().hashCode());
        result = prime * result + ((getQtyOns() == null) ? 0 : getQtyOns().hashCode());
        result = prime * result + ((getGweightRcv() == null) ? 0 : getGweightRcv().hashCode());
        result = prime * result + ((getNweightRcv() == null) ? 0 : getNweightRcv().hashCode());
        result = prime * result + ((getQtyRcv() == null) ? 0 : getQtyRcv().hashCode());
        result = prime * result + ((getQualityCls() == null) ? 0 : getQualityCls().hashCode());
        ...
        result = prime * result + ((getOnsUserId() == null) ? 0 : getOnsUserId().hashCode());
        result = prime * result + ((getOnsUserDt() == null) ? 0 : getOnsUserDt().hashCode());
        result = prime * result + ((getRcvUserId() == null) ? 0 : getRcvUserId().hashCode());
        result = prime * result + ((getRcvUserDt() == null) ? 0 : getRcvUserDt().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", rcvNum=").append(rcvNum);
        sb.append(", rcvOrdId=").append(rcvOrdId);
        sb.append(", rcvOrdLinId=").append(rcvOrdLinId);
        sb.append(", rcvCls=").append(rcvCls);
        sb.append(", rcvType=").append(rcvType);
        ...
        sb.append(", qtyRcvOrd=").append(qtyRcvOrd);
        sb.append(", gweightArr=").append(gweightArr);
        sb.append(", nweightArr=").append(nweightArr);
        sb.append(", qtyArr=").append(qtyArr);
        sb.append(", gweightOns=").append(gweightOns);
        sb.append(", nweightOns=").append(nweightOns);
        sb.append(", qtyOns=").append(qtyOns);
        sb.append(", gweightRcv=").append(gweightRcv);
        sb.append(", nweightRcv=").append(nweightRcv);
        sb.append(", qtyRcv=").append(qtyRcv);
        sb.append(", qualityCls=").append(qualityCls);
        sb.append(", inputUserId=").append(inputUserId);
        sb.append(", inputDt=").append(inputDt);
        sb.append(", onsUserId=").append(onsUserId);
        sb.append(", onsUserDt=").append(onsUserDt);
        sb.append(", rcvUserId=").append(rcvUserId);
        sb.append(", rcvUserDt=").append(rcvUserDt);
