...
@Table(name = "`t_base_process`")
public class TBaseProcess implements Serializable {
    /**
     * 主键
     */
    @Id
     ...
     * 流程名称
     */
    @Column(name = "`BASE_PROCESS_NM`")
    private String baseProcessNm;

    /**
     * 流程类型
     */
    @Column(name = "`BASE_PROCESS_TYPE`")
    private String baseProcessType;

    /**
     * 流程值
     */
    @Column(name = "`BASE_PROCESS_VALUE`")
    private String baseProcessValue;
     ...
     * 获取流程名称
     *
     * @return BASE_PROCESS_NM - 流程名称
     */
    public String getBaseProcessNm() {
        return baseProcessNm;
    }

    /**
     * 设置流程名称
     *
     * @param baseProcessNm 流程名称
     */
    public void setBaseProcessNm(String baseProcessNm) {
        this.baseProcessNm = baseProcessNm == null ? null : baseProcessNm.trim();
    }

    /**
     * 获取流程类型
     *
     * @return BASE_PROCESS_TYPE - 流程类型
     */
     ...
     * 设置流程类型
     *
     * @param baseProcessType 流程类型
     */
    public void setBaseProcessType(String baseProcessType) {
        this.baseProcessType = baseProcessType == null ? null : baseProcessType.trim();
    }

    /**
     * 获取流程值
     *
     * @return BASE_PROCESS_VALUE - 流程值
     */
    public String getBaseProcessValue() {
        return baseProcessValue;
    }

    /**
     * 设置流程值
     *
     * @param baseProcessValue 流程值
     */
    public void setBaseProcessValue(String baseProcessValue) {
        this.baseProcessValue = baseProcessValue == null ? null : baseProcessValue.trim();
    }
    ...
    public boolean equals(Object that) {
        ...
        TBaseProcess other = (TBaseProcess) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            && (this.getBaseProcessNm() == null ? other.getBaseProcessNm() == null : this.getBaseProcessNm().equals(other.getBaseProcessNm()))
            && (this.getBaseProcessType() == null ? other.getBaseProcessType() == null : this.getBaseProcessType().equals(other.getBaseProcessType()))
            && (this.getBaseProcessValue() == null ? other.getBaseProcessValue() == null : this.getBaseProcessValue().equals(other.getBaseProcessValue()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getBaseProcessNm() == null) ? 0 : getBaseProcessNm().hashCode());
        result = prime * result + ((getBaseProcessType() == null) ? 0 : getBaseProcessType().hashCode());
        result = prime * result + ((getBaseProcessValue() == null) ? 0 : getBaseProcessValue().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", baseProcessNm=").append(baseProcessNm);
        sb.append(", baseProcessType=").append(baseProcessType);
        sb.append(", baseProcessValue=").append(baseProcessValue);
