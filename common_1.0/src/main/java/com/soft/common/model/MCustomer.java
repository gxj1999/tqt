...
public class MCustomer implements Serializable {
     ...
     * 客户表示用编号
     */
    @Column(name = "`CUSTOMER_CD_DIS`")
    private String customerCdDis;
     ...
     * 客户英文名称
     */
    @Column(name = "`CUSTOMER_NM_EN`")
    private String customerNmEn;

    /**
     * 客户简称
     */
    @Column(name = "`CUSTOMER_JC`")
     ...
     * 获取客户表示用编号
     *
     * @return CUSTOMER_CD_DIS - 客户表示用编号
     */
    public String getCustomerCdDis() {
        return customerCdDis;
    }
     ...
     */
    public void setCustomerCdDis(String customerCdDis) {
        this.customerCdDis = customerCdDis == null ? null : customerCdDis.trim();
    }

    /**
     * 获取客户名称
     *
     * @return CUSTOMER_NM - 客户名称
     */
     ...
     * 获取客户英文名称
     *
     * @return CUSTOMER_NM_EN - 客户英文名称
     */
    public String getCustomerNmEn() {
        return customerNmEn;
    }
     ...
     */
    public void setCustomerNmEn(String customerNmEn) {
        this.customerNmEn = customerNmEn == null ? null : customerNmEn.trim();
    }

    /**
     * 获取客户简称
     *
     * @return CUSTOMER_JC - 客户简称
     */
    ...
    public boolean equals(Object that) {
        ...
        MCustomer other = (MCustomer) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            && (this.getCntrCd() == null ? other.getCntrCd() == null : this.getCntrCd().equals(other.getCntrCd()))
            && (this.getCustomerCdDis() == null ? other.getCustomerCdDis() == null : this.getCustomerCdDis().equals(other.getCustomerCdDis()))
            && (this.getCustomerNm() == null ? other.getCustomerNm() == null : this.getCustomerNm().equals(other.getCustomerNm()))
            && (this.getCustomerNmEn() == null ? other.getCustomerNmEn() == null : this.getCustomerNmEn().equals(other.getCustomerNmEn()))
            && (this.getCustomerJc() == null ? other.getCustomerJc() == null : this.getCustomerJc().equals(other.getCustomerJc()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getCustomerCdDis() == null) ? 0 : getCustomerCdDis().hashCode());
        result = prime * result + ((getCustomerNm() == null) ? 0 : getCustomerNm().hashCode());
        result = prime * result + ((getCustomerNmEn() == null) ? 0 : getCustomerNmEn().hashCode());
        result = prime * result + ((getCustomerJc() == null) ? 0 : getCustomerJc().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", customerCdDis=").append(customerCdDis);
        sb.append(", customerNm=").append(customerNm);
        sb.append(", customerNmEn=").append(customerNmEn);
        sb.append(", customerJc=").append(customerJc);
