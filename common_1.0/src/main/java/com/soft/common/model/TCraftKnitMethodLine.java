...
@Table(name = "`t_craft_knit_method_line`")
public class TCraftKnitMethodLine implements Serializable {
    /**
     * 主键
     */
    @Id
     ...
     * 编织工艺明细号
     */
    @Column(name = "`CRAFT_KNIT_LINE_NUM`")
    private String craftKnitLineNum;
     ...
     * 编织结构
     */
    @Column(name = "`KNIT_STRUCTURE`")
    private String knitStructure;

    /**
     * 上盘排针
     */
    @Column(name = "`UP_NEEDLE`")
    private String upNeedle;

    /**
     * 上盘排针种类
     */
    @Column(name = "`UP_NEEDLE_TYPE`")
    private String upNeedleType;

    /**
     * 上盘排针数
     */
    @Column(name = "`UP_NEEDLE_CNT`")
    private BigDecimal upNeedleCnt;

    /**
     * 上盘菱角
     */
    @Column(name = "`UP_NEEDLE_VALUE`")
    private String upNeedleValue;

    /**
     * 上盘菱角排版
     */
    @Column(name = "`UP_NEEDLE_ITEM`")
    private String upNeedleItem;

    /**
     * 下盘排针
     */
    @Column(name = "`DOWN_NEEDLE`")
    private String downNeedle;

    /**
     * 下盘排针种类
     */
    @Column(name = "`DOWN_NEEDLE_TYPE`")
    private String downNeedleType;

    /**
     * 下盘排针数
     */
    @Column(name = "`DOWN_NEEDLE_CNT`")
    private BigDecimal downNeedleCnt;

    /**
     * 下盘菱角
     */
    @Column(name = "`DOWN_NEEDLE_VALUE`")
    private String downNeedleValue;

    /**
     * 下盘菱角排版
     */
    @Column(name = "`DOWN_NEEDLE_ITEM`")
    private String downNeedleItem;
     ...
     * 获取编织工艺明细号
     *
     * @return CRAFT_KNIT_LINE_NUM - 编织工艺明细号
     */
    public String getCraftKnitLineNum() {
        return craftKnitLineNum;
    }

    /**
     * 设置编织工艺明细号
     *
     * @param craftKnitLineNum 编织工艺明细号
     */
    public void setCraftKnitLineNum(String craftKnitLineNum) {
        this.craftKnitLineNum = craftKnitLineNum == null ? null : craftKnitLineNum.trim();
    }
     ...
     * 获取编织结构
     *
     * @return KNIT_STRUCTURE - 编织结构
     */
    public String getKnitStructure() {
        return knitStructure;
    }

    /**
     * 设置编织结构
     *
     * @param knitStructure 编织结构
     */
    public void setKnitStructure(String knitStructure) {
        this.knitStructure = knitStructure == null ? null : knitStructure.trim();
    }

    /**
     * 获取上盘排针
     *
     * @return UP_NEEDLE - 上盘排针
     */
    public String getUpNeedle() {
        return upNeedle;
    }
     ...
     * @param upNeedle 上盘排针
     */
    public void setUpNeedle(String upNeedle) {
        this.upNeedle = upNeedle == null ? null : upNeedle.trim();
    }

    /**
     * 获取上盘排针种类
     *
     * @return UP_NEEDLE_TYPE - 上盘排针种类
     */
    public String getUpNeedleType() {
        return upNeedleType;
    }
     ...
     * 设置上盘排针种类
     *
     * @param upNeedleType 上盘排针种类
     */
    public void setUpNeedleType(String upNeedleType) {
        this.upNeedleType = upNeedleType == null ? null : upNeedleType.trim();
    }

    /**
     * 获取上盘排针数
     *
     * @return UP_NEEDLE_CNT - 上盘排针数
     */
    public BigDecimal getUpNeedleCnt() {
        return upNeedleCnt;
    }
     ...
     * 设置上盘排针数
     *
     * @param upNeedleCnt 上盘排针数
     */
    public void setUpNeedleCnt(BigDecimal upNeedleCnt) {
        this.upNeedleCnt = upNeedleCnt;
    }

    /**
     * 获取上盘菱角
     *
     * @return UP_NEEDLE_VALUE - 上盘菱角
     */
    public String getUpNeedleValue() {
        return upNeedleValue;
    }

    /**
     * 设置上盘菱角
     *
     * @param upNeedleValue 上盘菱角
     */
    public void setUpNeedleValue(String upNeedleValue) {
        this.upNeedleValue = upNeedleValue == null ? null : upNeedleValue.trim();
    }

    /**
     * 获取上盘菱角排版
     *
     * @return UP_NEEDLE_ITEM - 上盘菱角排版
     */
    public String getUpNeedleItem() {
        return upNeedleItem;
    }
     ...
     * 设置上盘菱角排版
     *
     * @param upNeedleItem 上盘菱角排版
     */
    public void setUpNeedleItem(String upNeedleItem) {
        this.upNeedleItem = upNeedleItem == null ? null : upNeedleItem.trim();
    }

    /**
     * 获取下盘排针
     *
     * @return DOWN_NEEDLE - 下盘排针
     */
    public String getDownNeedle() {
        return downNeedle;
    }
     ...
     * 设置下盘排针
     *
     * @param downNeedle 下盘排针
     */
    public void setDownNeedle(String downNeedle) {
        this.downNeedle = downNeedle == null ? null : downNeedle.trim();
    }

    /**
     * 获取下盘排针种类
     *
     * @return DOWN_NEEDLE_TYPE - 下盘排针种类
     */
    public String getDownNeedleType() {
        return downNeedleType;
    }

    /**
     * 设置下盘排针种类
     *
     * @param downNeedleType 下盘排针种类
     */
    public void setDownNeedleType(String downNeedleType) {
        this.downNeedleType = downNeedleType == null ? null : downNeedleType.trim();
    }

    /**
     * 获取下盘排针数
     *
     * @return DOWN_NEEDLE_CNT - 下盘排针数
     */
    public BigDecimal getDownNeedleCnt() {
        return downNeedleCnt;
    }

    /**
     * 设置下盘排针数
     *
     * @param downNeedleCnt 下盘排针数
     */
    public void setDownNeedleCnt(BigDecimal downNeedleCnt) {
        this.downNeedleCnt = downNeedleCnt;
    }

    /**
     * 获取下盘菱角
     *
     * @return DOWN_NEEDLE_VALUE - 下盘菱角
     */
    public String getDownNeedleValue() {
        return downNeedleValue;
    }

    /**
     * 设置下盘菱角
     *
     * @param downNeedleValue 下盘菱角
     */
    public void setDownNeedleValue(String downNeedleValue) {
        this.downNeedleValue = downNeedleValue == null ? null : downNeedleValue.trim();
    }

    /**
     * 获取下盘菱角排版
     *
     * @return DOWN_NEEDLE_ITEM - 下盘菱角排版
     */
    public String getDownNeedleItem() {
        return downNeedleItem;
    }

    /**
     * 设置下盘菱角排版
     *
     * @param downNeedleItem 下盘菱角排版
     */
    public void setDownNeedleItem(String downNeedleItem) {
        this.downNeedleItem = downNeedleItem == null ? null : downNeedleItem.trim();
    }
    ...
    public boolean equals(Object that) {
        ...
        TCraftKnitMethodLine other = (TCraftKnitMethodLine) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            && (this.getCraftKnitId() == null ? other.getCraftKnitId() == null : this.getCraftKnitId().equals(other.getCraftKnitId()))
            && (this.getCraftKnitLineNum() == null ? other.getCraftKnitLineNum() == null : this.getCraftKnitLineNum().equals(other.getCraftKnitLineNum()))
            && (this.getSeat() == null ? other.getSeat() == null : this.getSeat().equals(other.getSeat()))
            && (this.getSort() == null ? other.getSort() == null : this.getSort().equals(other.getSort()))
            && (this.getKnitStructure() == null ? other.getKnitStructure() == null : this.getKnitStructure().equals(other.getKnitStructure()))
            && (this.getUpNeedle() == null ? other.getUpNeedle() == null : this.getUpNeedle().equals(other.getUpNeedle()))
            && (this.getUpNeedleType() == null ? other.getUpNeedleType() == null : this.getUpNeedleType().equals(other.getUpNeedleType()))
            && (this.getUpNeedleCnt() == null ? other.getUpNeedleCnt() == null : this.getUpNeedleCnt().equals(other.getUpNeedleCnt()))
            && (this.getUpNeedleValue() == null ? other.getUpNeedleValue() == null : this.getUpNeedleValue().equals(other.getUpNeedleValue()))
            && (this.getUpNeedleItem() == null ? other.getUpNeedleItem() == null : this.getUpNeedleItem().equals(other.getUpNeedleItem()))
            && (this.getDownNeedle() == null ? other.getDownNeedle() == null : this.getDownNeedle().equals(other.getDownNeedle()))
            && (this.getDownNeedleType() == null ? other.getDownNeedleType() == null : this.getDownNeedleType().equals(other.getDownNeedleType()))
            && (this.getDownNeedleCnt() == null ? other.getDownNeedleCnt() == null : this.getDownNeedleCnt().equals(other.getDownNeedleCnt()))
            && (this.getDownNeedleValue() == null ? other.getDownNeedleValue() == null : this.getDownNeedleValue().equals(other.getDownNeedleValue()))
            && (this.getDownNeedleItem() == null ? other.getDownNeedleItem() == null : this.getDownNeedleItem().equals(other.getDownNeedleItem()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getCraftKnitLineNum() == null) ? 0 : getCraftKnitLineNum().hashCode());
        result = prime * result + ((getSeat() == null) ? 0 : getSeat().hashCode());
        result = prime * result + ((getSort() == null) ? 0 : getSort().hashCode());
        result = prime * result + ((getKnitStructure() == null) ? 0 : getKnitStructure().hashCode());
        result = prime * result + ((getUpNeedle() == null) ? 0 : getUpNeedle().hashCode());
        result = prime * result + ((getUpNeedleType() == null) ? 0 : getUpNeedleType().hashCode());
        result = prime * result + ((getUpNeedleCnt() == null) ? 0 : getUpNeedleCnt().hashCode());
        result = prime * result + ((getUpNeedleValue() == null) ? 0 : getUpNeedleValue().hashCode());
        result = prime * result + ((getUpNeedleItem() == null) ? 0 : getUpNeedleItem().hashCode());
        result = prime * result + ((getDownNeedle() == null) ? 0 : getDownNeedle().hashCode());
        result = prime * result + ((getDownNeedleType() == null) ? 0 : getDownNeedleType().hashCode());
        result = prime * result + ((getDownNeedleCnt() == null) ? 0 : getDownNeedleCnt().hashCode());
        result = prime * result + ((getDownNeedleValue() == null) ? 0 : getDownNeedleValue().hashCode());
        result = prime * result + ((getDownNeedleItem() == null) ? 0 : getDownNeedleItem().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", craftKnitLineNum=").append(craftKnitLineNum);
        sb.append(", seat=").append(seat);
        sb.append(", sort=").append(sort);
        sb.append(", knitStructure=").append(knitStructure);
        sb.append(", upNeedle=").append(upNeedle);
        sb.append(", upNeedleType=").append(upNeedleType);
        sb.append(", upNeedleCnt=").append(upNeedleCnt);
        sb.append(", upNeedleValue=").append(upNeedleValue);
        sb.append(", upNeedleItem=").append(upNeedleItem);
        sb.append(", downNeedle=").append(downNeedle);
        sb.append(", downNeedleType=").append(downNeedleType);
        sb.append(", downNeedleCnt=").append(downNeedleCnt);
        sb.append(", downNeedleValue=").append(downNeedleValue);
        sb.append(", downNeedleItem=").append(downNeedleItem);
