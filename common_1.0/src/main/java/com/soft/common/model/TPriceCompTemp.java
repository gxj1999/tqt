...
@Table(name = "`t_price_comp_temp`")
public class TPriceCompTemp implements Serializable {
    /**
     * 主键
     */
    @Id
     ...
     * 要素名称
     */
    @Column(name = "`PRICE_COMP_NM`")
    private String priceCompNm;
     ...
     * 获取要素名称
     *
     * @return PRICE_COMP_NM - 要素名称
     */
    public String getPriceCompNm() {
        return priceCompNm;
    }
     ...
     * 设置要素名称
     *
     * @param priceCompNm 要素名称
     */
    public void setPriceCompNm(String priceCompNm) {
        this.priceCompNm = priceCompNm == null ? null : priceCompNm.trim();
    }
    ...
    public boolean equals(Object that) {
        ...
        TPriceCompTemp other = (TPriceCompTemp) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            && (this.getCntrCd() == null ? other.getCntrCd() == null : this.getCntrCd().equals(other.getCntrCd()))
            && (this.getCompCd() == null ? other.getCompCd() == null : this.getCompCd().equals(other.getCompCd()))
            ...
            && (this.getPriceCompNm() == null ? other.getPriceCompNm() == null : this.getPriceCompNm().equals(other.getPriceCompNm()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getCompCd() == null) ? 0 : getCompCd().hashCode());
        ...
        result = prime * result + ((getPriceCompNm() == null) ? 0 : getPriceCompNm().hashCode());
