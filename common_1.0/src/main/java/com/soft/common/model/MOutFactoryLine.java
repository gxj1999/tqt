...
@Table(name = "`m_out_factory_line`")
public class MOutFactoryLine implements Serializable {
    /**
     * 主键
     */
    @Id
     ...
     * 外发工厂明细行号
     */
    @Column(name = "`OUT_FACTORY_LINE_NUM`")
    private String outFactoryLineNum;
     ...
     * 获取外发工厂明细行号
     *
     * @return OUT_FACTORY_LINE_NUM - 外发工厂明细行号
     */
    public String getOutFactoryLineNum() {
        return outFactoryLineNum;
    }

    /**
     * 设置外发工厂明细行号
     *
     * @param outFactoryLineNum 外发工厂明细行号
     */
    public void setOutFactoryLineNum(String outFactoryLineNum) {
        this.outFactoryLineNum = outFactoryLineNum == null ? null : outFactoryLineNum.trim();
    }
    ...
    public void setProdQc(String prodQc) {
        this.prodQc = prodQc == null ? null : prodQc.trim();
    }
    ...
    public boolean equals(Object that) {
        ...
        MOutFactoryLine other = (MOutFactoryLine) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getOutFactoryLineNum() == null ? other.getOutFactoryLineNum() == null : this.getOutFactoryLineNum().equals(other.getOutFactoryLineNum()))
            ...
            && (this.getProdQc() == null ? other.getProdQc() == null : this.getProdQc().equals(other.getProdQc()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getOutFactoryLineNum() == null) ? 0 : getOutFactoryLineNum().hashCode());
        result = prime * result + ((getProdId() == null) ? 0 : getProdId().hashCode());
        result = prime * result + ((getColorCd() == null) ? 0 : getColorCd().hashCode());
        result = prime * result + ((getProdQc() == null) ? 0 : getProdQc().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", outFactoryLineNum=").append(outFactoryLineNum);
        sb.append(", prodId=").append(prodId);
        sb.append(", colorCd=").append(colorCd);
        sb.append(", prodQc=").append(prodQc);
