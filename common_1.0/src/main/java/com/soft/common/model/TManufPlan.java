...
@Table(name = "`t_manuf_plan`")
public class TManufPlan implements Serializable {
    /**
     * 主键
     */
    @Id
     ...
     * 生产计划编号
     */
    @Column(name = "`PRODUCE_PLAN_CD`")
    private String producePlanCd;

    /**
     * 生产计划明细号
     */
    @Column(name = "`PRODUCE_PLAN_LINE_NUM`")
    private String producePlanLineNum;

    /**
     * 生产订单编号
     */
    @Column(name = "`PRODUCE_ORD_CD`")
    private String produceOrdCd;

    /**
     * 生产订单明细号
     */
    @Column(name = "`PRODUCE_ORD_LINE_NUM`")
    private String produceOrdLineNum;

    /**
     * 生产状态
     */
    @Column(name = "`PRODUCE_CLS`")
    private String produceCls;
     ...
     * 绑定工艺号1
     */
    @Column(name = "`PROCESS_NO1`")
    private String processNo1;

    /**
     * 绑定工艺号2
     */
    @Column(name = "`PROCESS_NO2`")
    private String processNo2;

    /**
     * 绑定工艺号3
     */
    @Column(name = "`PROCESS_NO3`")
     ...
     * 获取生产计划编号
     *
     * @return PRODUCE_PLAN_CD - 生产计划编号
     */
    public String getProducePlanCd() {
        return producePlanCd;
    }

    /**
     * 设置生产计划编号
     *
     * @param producePlanCd 生产计划编号
     */
    public void setProducePlanCd(String producePlanCd) {
        this.producePlanCd = producePlanCd == null ? null : producePlanCd.trim();
    }

    /**
     * 获取生产计划明细号
     *
     * @return PRODUCE_PLAN_LINE_NUM - 生产计划明细号
     */
    public String getProducePlanLineNum() {
        return producePlanLineNum;
    }

    /**
     * 设置生产计划明细号
     *
     * @param producePlanLineNum 生产计划明细号
     */
    public void setProducePlanLineNum(String producePlanLineNum) {
        this.producePlanLineNum = producePlanLineNum == null ? null : producePlanLineNum.trim();
    }

    /**
     * 获取生产订单编号
     *
     * @return PRODUCE_ORD_CD - 生产订单编号
     */
    public String getProduceOrdCd() {
        return produceOrdCd;
    }
     ...
     * 设置生产订单编号
     *
     * @param produceOrdCd 生产订单编号
     */
    public void setProduceOrdCd(String produceOrdCd) {
        this.produceOrdCd = produceOrdCd == null ? null : produceOrdCd.trim();
    }

    /**
     * 获取生产订单明细号
     *
     * @return PRODUCE_ORD_LINE_NUM - 生产订单明细号
     */
    public String getProduceOrdLineNum() {
        return produceOrdLineNum;
    }

    /**
     * 设置生产订单明细号
     *
     * @param produceOrdLineNum 生产订单明细号
     */
    public void setProduceOrdLineNum(String produceOrdLineNum) {
        this.produceOrdLineNum = produceOrdLineNum == null ? null : produceOrdLineNum.trim();
    }

    /**
     * 获取生产状态
     *
     * @return PRODUCE_CLS - 生产状态
     */
    public String getProduceCls() {
        return produceCls;
    }
     ...
     * 设置生产状态
     *
     * @param produceCls 生产状态
     */
    public void setProduceCls(String produceCls) {
        this.produceCls = produceCls == null ? null : produceCls.trim();
    }

    /**
     * 获取生产类型
     *
     * @return PRODUCE_TYPE - 生产类型
     */
     ...
     * 设置计划开始时间
     *
     * @param planStartDt 计划开始时间
     */
    public void setPlanStartDt(String planStartDt) {
        this.planStartDt = planStartDt == null ? null : planStartDt.trim();
    }

    /**
     * 获取计划结束时间
     *
     * @return PLAN_END_DT - 计划结束时间
     */
     ...
     * 设置计划结束时间
     *
     * @param planEndDt 计划结束时间
     */
    public void setPlanEndDt(String planEndDt) {
        this.planEndDt = planEndDt == null ? null : planEndDt.trim();
    }
    ...
    public void setLot3(String lot3) {
        this.lot3 = lot3 == null ? null : lot3.trim();
    }
     ...
     * 设置绑定工艺号1
     *
     * @param processNo1 绑定工艺号1
     */
    public void setProcessNo1(String processNo1) {
        this.processNo1 = processNo1 == null ? null : processNo1.trim();
    }

    /**
     * 获取绑定工艺号2
     *
     * @return PROCESS_NO2 - 绑定工艺号2
     */
    public String getProcessNo2() {
        return processNo2;
    }
     ...
     * 设置绑定工艺号2
     *
     * @param processNo2 绑定工艺号2
     */
    public void setProcessNo2(String processNo2) {
        this.processNo2 = processNo2 == null ? null : processNo2.trim();
    }

    /**
     * 获取绑定工艺号3
     *
     * @return PROCESS_NO3 - 绑定工艺号3
     */
    public String getProcessNo3() {
        return processNo3;
    }
     ...
     * 设置绑定工艺号3
     *
     * @param processNo3 绑定工艺号3
     */
    public void setProcessNo3(String processNo3) {
        this.processNo3 = processNo3 == null ? null : processNo3.trim();
    }
    ...
    public boolean equals(Object that) {
        ...
        TManufPlan other = (TManufPlan) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            && (this.getProducePlanCd() == null ? other.getProducePlanCd() == null : this.getProducePlanCd().equals(other.getProducePlanCd()))
            && (this.getProducePlanLineNum() == null ? other.getProducePlanLineNum() == null : this.getProducePlanLineNum().equals(other.getProducePlanLineNum()))
            && (this.getProduceOrdCd() == null ? other.getProduceOrdCd() == null : this.getProduceOrdCd().equals(other.getProduceOrdCd()))
            && (this.getProduceOrdLineNum() == null ? other.getProduceOrdLineNum() == null : this.getProduceOrdLineNum().equals(other.getProduceOrdLineNum()))
            && (this.getProduceCls() == null ? other.getProduceCls() == null : this.getProduceCls().equals(other.getProduceCls()))
            ...
            && (this.getOrgCd() == null ? other.getOrgCd() == null : this.getOrgCd().equals(other.getOrgCd()))
            ...
            && (this.getLot3() == null ? other.getLot3() == null : this.getLot3().equals(other.getLot3()))
            ...
            && (this.getProcessNo1() == null ? other.getProcessNo1() == null : this.getProcessNo1().equals(other.getProcessNo1()))
            && (this.getProcessNo2() == null ? other.getProcessNo2() == null : this.getProcessNo2().equals(other.getProcessNo2()))
            && (this.getProcessNo3() == null ? other.getProcessNo3() == null : this.getProcessNo3().equals(other.getProcessNo3()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getProducePlanCd() == null) ? 0 : getProducePlanCd().hashCode());
        result = prime * result + ((getProducePlanLineNum() == null) ? 0 : getProducePlanLineNum().hashCode());
        result = prime * result + ((getProduceOrdCd() == null) ? 0 : getProduceOrdCd().hashCode());
        result = prime * result + ((getProduceOrdLineNum() == null) ? 0 : getProduceOrdLineNum().hashCode());
        result = prime * result + ((getProduceCls() == null) ? 0 : getProduceCls().hashCode());
        ...
        result = prime * result + ((getOrgCd() == null) ? 0 : getOrgCd().hashCode());
        ...
        result = prime * result + ((getLot3() == null) ? 0 : getLot3().hashCode());
        ...
        result = prime * result + ((getProcessNo1() == null) ? 0 : getProcessNo1().hashCode());
        result = prime * result + ((getProcessNo2() == null) ? 0 : getProcessNo2().hashCode());
        result = prime * result + ((getProcessNo3() == null) ? 0 : getProcessNo3().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", producePlanCd=").append(producePlanCd);
        sb.append(", producePlanLineNum=").append(producePlanLineNum);
        sb.append(", produceOrdCd=").append(produceOrdCd);
        sb.append(", produceOrdLineNum=").append(produceOrdLineNum);
        sb.append(", produceCls=").append(produceCls);
        sb.append(", produceType=").append(produceType);
        sb.append(", planStartDt=").append(planStartDt);
        sb.append(", planEndDt=").append(planEndDt);
        ...
        sb.append(", processNo1=").append(processNo1);
        sb.append(", processNo2=").append(processNo2);
        sb.append(", processNo3=").append(processNo3);
