...
public class MLogin implements Serializable {
    ...
    private Date lsLoginDt;

    /**
     * 前回登出时间
     */
    @Column(name = "`LS_LOGOUT_DT`")
    private Date lsLogoutDt;

    /**
     * 前前回密码
     */
    @Column(name = "`LS_LS_PSWD`")
     ...
     * 前回密码修改时间
     */
    @Column(name = "`LS_PSWD_DT`")
    private Date lsPswdDt;
     ...
     * 密码输入错误次数
     */
    @Column(name = "`PSWD_ERR_NUM`")
    private Integer pswdErrNum;
     ...
     * 获取前回登录时间
     *
     * @return LS_LOGIN_DT - 前回登录时间
     */
    public Date getLsLoginDt() {
        return lsLoginDt;
    }
     ...
     * 设置前回登录时间
     *
     * @param lsLoginDt 前回登录时间
     */
    public void setLsLoginDt(Date lsLoginDt) {
        this.lsLoginDt = lsLoginDt;
    }

    /**
     * 获取前回登出时间
     *
     * @return LS_LOGOUT_DT - 前回登出时间
     */
    public Date getLsLogoutDt() {
        return lsLogoutDt;
    }
     ...
     * 设置前回登出时间
     *
     * @param lsLogoutDt 前回登出时间
     */
    public void setLsLogoutDt(Date lsLogoutDt) {
        this.lsLogoutDt = lsLogoutDt;
    }

    /**
     * 获取前前回密码
     *
     * @return LS_LS_PSWD - 前前回密码
     */
     ...
     * 设置前前回密码
     *
     * @param lsLsPswd 前前回密码
     */
    public void setLsLsPswd(String lsLsPswd) {
        this.lsLsPswd = lsLsPswd == null ? null : lsLsPswd.trim();
    }
    ...
    public void setLsPswd(String lsPswd) {
        this.lsPswd = lsPswd == null ? null : lsPswd.trim();
    }
     ...
     * 获取前回密码修改时间
     *
     * @return LS_PSWD_DT - 前回密码修改时间
     */
    public Date getLsPswdDt() {
        return lsPswdDt;
    }
     ...
     * 设置前回密码修改时间
     *
     * @param lsPswdDt 前回密码修改时间
     */
    public void setLsPswdDt(Date lsPswdDt) {
        this.lsPswdDt = lsPswdDt;
    }

    /**
     * 获取是否初期登录
     *
     * @return INIT_FLG - 是否初期登录
     */
     ...
     * 设置是否初期登录
     *
     * @param initFlg 是否初期登录
     */
    public void setInitFlg(String initFlg) {
        this.initFlg = initFlg == null ? null : initFlg.trim();
    }

    /**
     * 获取密码输入错误次数
     *
     * @return PSWD_ERR_NUM - 密码输入错误次数
     */
    public Integer getPswdErrNum() {
        return pswdErrNum;
    }
     ...
     * 设置密码输入错误次数
     *
     * @param pswdErrNum 密码输入错误次数
     */
    public void setPswdErrNum(Integer pswdErrNum) {
    ...
    public boolean equals(Object that) {
        ...
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getLogoutDt() == null ? other.getLogoutDt() == null : this.getLogoutDt().equals(other.getLogoutDt()))
            && (this.getLsLoginDt() == null ? other.getLsLoginDt() == null : this.getLsLoginDt().equals(other.getLsLoginDt()))
            && (this.getLsLogoutDt() == null ? other.getLsLogoutDt() == null : this.getLsLogoutDt().equals(other.getLsLogoutDt()))
            && (this.getLsLsPswd() == null ? other.getLsLsPswd() == null : this.getLsLsPswd().equals(other.getLsLsPswd()))
            && (this.getLsPswd() == null ? other.getLsPswd() == null : this.getLsPswd().equals(other.getLsPswd()))
            && (this.getPswd() == null ? other.getPswd() == null : this.getPswd().equals(other.getPswd()))
            && (this.getLsPswdDt() == null ? other.getLsPswdDt() == null : this.getLsPswdDt().equals(other.getLsPswdDt()))
            && (this.getInitFlg() == null ? other.getInitFlg() == null : this.getInitFlg().equals(other.getInitFlg()))
            && (this.getPswdErrNum() == null ? other.getPswdErrNum() == null : this.getPswdErrNum().equals(other.getPswdErrNum()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getLogoutDt() == null) ? 0 : getLogoutDt().hashCode());
        result = prime * result + ((getLsLoginDt() == null) ? 0 : getLsLoginDt().hashCode());
        result = prime * result + ((getLsLogoutDt() == null) ? 0 : getLsLogoutDt().hashCode());
        result = prime * result + ((getLsLsPswd() == null) ? 0 : getLsLsPswd().hashCode());
        result = prime * result + ((getLsPswd() == null) ? 0 : getLsPswd().hashCode());
        result = prime * result + ((getPswd() == null) ? 0 : getPswd().hashCode());
        result = prime * result + ((getLsPswdDt() == null) ? 0 : getLsPswdDt().hashCode());
        result = prime * result + ((getInitFlg() == null) ? 0 : getInitFlg().hashCode());
        result = prime * result + ((getPswdErrNum() == null) ? 0 : getPswdErrNum().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", logoutDt=").append(logoutDt);
        sb.append(", lsLoginDt=").append(lsLoginDt);
        sb.append(", lsLogoutDt=").append(lsLogoutDt);
        sb.append(", lsLsPswd=").append(lsLsPswd);
        sb.append(", lsPswd=").append(lsPswd);
        sb.append(", pswd=").append(pswd);
        sb.append(", lsPswdDt=").append(lsPswdDt);
        sb.append(", initFlg=").append(initFlg);
        sb.append(", pswdErrNum=").append(pswdErrNum);
