...
@Table(name = "`t_supplier_appraise`")
public class TSupplierAppraise implements Serializable {
    /**
     * 主键
     */
    @Id
    ...
    public boolean equals(Object that) {
        ...
        TSupplierAppraise other = (TSupplierAppraise) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            && (this.getCntrCd() == null ? other.getCntrCd() == null : this.getCntrCd().equals(other.getCntrCd()))
            && (this.getOrgId() == null ? other.getOrgId() == null : this.getOrgId().equals(other.getOrgId()))
            && (this.getSupplierCd() == null ? other.getSupplierCd() == null : this.getSupplierCd().equals(other.getSupplierCd()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getSupplierCd() == null) ? 0 : getSupplierCd().hashCode());
