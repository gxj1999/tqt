...
public class TReceiptLine implements Serializable {
     ...
     * 入库明细号
     */
    @Column(name = "`RCV_LIN_NUM`")
    private String rcvLinNum;
     ...
     * 整箱毛重
     */
    @Column(name = "`GWEIGHT_BOX`")
    private BigDecimal gweightBox;

    /**
     * 整箱净重
     */
    @Column(name = "`NWEIGHT_BOX`")
    private BigDecimal nweightBox;
     ...
     * 获取入库明细号
     *
     * @return RCV_LIN_NUM - 入库明细号
     */
    public String getRcvLinNum() {
        return rcvLinNum;
    }
     ...
     * 设置入库明细号
     *
     * @param rcvLinNum 入库明细号
     */
    public void setRcvLinNum(String rcvLinNum) {
        this.rcvLinNum = rcvLinNum == null ? null : rcvLinNum.trim();
    }
     ...
     * 获取整箱毛重
     *
     * @return GWEIGHT_BOX - 整箱毛重
     */
    public BigDecimal getGweightBox() {
        return gweightBox;
    }
     ...
     * 设置整箱毛重
     *
     * @param gweightBox 整箱毛重
     */
    public void setGweightBox(BigDecimal gweightBox) {
        this.gweightBox = gweightBox;
    }

    /**
     * 获取整箱净重
     *
     * @return NWEIGHT_BOX - 整箱净重
     */
    public BigDecimal getNweightBox() {
        return nweightBox;
    }
     ...
     * 设置整箱净重
     *
     * @param nweightBox 整箱净重
     */
    public void setNweightBox(BigDecimal nweightBox) {
        this.nweightBox = nweightBox;
    }

    /**
     * 获取箱内商品数量
     *
     * @return QTY_BOX - 箱内商品数量
     */
    ...
    public boolean equals(Object that) {
        ...
        TReceiptLine other = (TReceiptLine) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            && (this.getRcvId() == null ? other.getRcvId() == null : this.getRcvId().equals(other.getRcvId()))
            && (this.getRcvLinNum() == null ? other.getRcvLinNum() == null : this.getRcvLinNum().equals(other.getRcvLinNum()))
            ...
            && (this.getGweightBox() == null ? other.getGweightBox() == null : this.getGweightBox().equals(other.getGweightBox()))
            && (this.getNweightBox() == null ? other.getNweightBox() == null : this.getNweightBox().equals(other.getNweightBox()))
            && (this.getQtyBox() == null ? other.getQtyBox() == null : this.getQtyBox().equals(other.getQtyBox()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getRcvId() == null) ? 0 : getRcvId().hashCode());
        result = prime * result + ((getRcvLinNum() == null) ? 0 : getRcvLinNum().hashCode());
        ...
        result = prime * result + ((getGweightBox() == null) ? 0 : getGweightBox().hashCode());
        result = prime * result + ((getNweightBox() == null) ? 0 : getNweightBox().hashCode());
        result = prime * result + ((getQtyBox() == null) ? 0 : getQtyBox().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", rcvId=").append(rcvId);
        sb.append(", rcvLinNum=").append(rcvLinNum);
        ...
        sb.append(", gweightBox=").append(gweightBox);
        sb.append(", nweightBox=").append(nweightBox);
