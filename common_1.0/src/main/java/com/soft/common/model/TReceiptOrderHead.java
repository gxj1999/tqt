...
@Table(name = "`t_receipt_order_head`")
public class TReceiptOrderHead implements Serializable {
    /**
     * 主键
     */
    @Id
     ...
     * 预定入库单号
     */
    @Column(name = "`RCV_ORD_NUM`")
    private String rcvOrdNum;

    /**
     * 预定到货日期
     */
    @Column(name = "`ONS_ORD_DT`")
    private String onsOrdDt;

    /**
     * 预定入库日期
     */
    @Column(name = "`RCV_ORD_DT`")
    private String rcvOrdDt;
     ...
     * 预定入库总毛重
     */
    @Column(name = "`TOTAL_GWEIGHT_ORD`")
    private BigDecimal totalGweightOrd;

    /**
     * 预定入库总净重
     */
    @Column(name = "`TOTAL_NWEIGHT_ORD`")
    private BigDecimal totalNweightOrd;

    /**
     * 预定入库总数量
     */
    @Column(name = "`TOTAL_QTY_ORD`")
    private BigDecimal totalQtyOrd;
     ...
     * 预定入库单打印标识
     */
    @Column(name = "`ORD_PRT_FLG`")
    private String ordPrtFlg;

    /**
     * 预定入库单打印人
     */
    @Column(name = "`ORD_PRT_USER_ID`")
    private String ordPrtUserId;

    /**
     * 预定入库单打印时间
     */
    @Column(name = "`ORD_PRT_DT`")
    private Date ordPrtDt;
     ...
     * 获取预定到货日期
     *
     * @return ONS_ORD_DT - 预定到货日期
     */
    public String getOnsOrdDt() {
        return onsOrdDt;
    }
     ...
     * 设置预定到货日期
     *
     * @param onsOrdDt 预定到货日期
     */
    public void setOnsOrdDt(String onsOrdDt) {
        this.onsOrdDt = onsOrdDt == null ? null : onsOrdDt.trim();
    }

    /**
     * 获取预定入库日期
     *
     * @return RCV_ORD_DT - 预定入库日期
     */
    public String getRcvOrdDt() {
        return rcvOrdDt;
    }
     ...
     * 设置预定入库日期
     *
     * @param rcvOrdDt 预定入库日期
     */
    public void setRcvOrdDt(String rcvOrdDt) {
        this.rcvOrdDt = rcvOrdDt == null ? null : rcvOrdDt.trim();
    }
     ...
     * 设置关联单据号
     *
     * @param foreignNum 关联单据号
     */
    public void setForeignNum(String foreignNum) {
        this.foreignNum = foreignNum == null ? null : foreignNum.trim();
    }
     ...
     * 获取预定入库总毛重
     *
     * @return TOTAL_GWEIGHT_ORD - 预定入库总毛重
     */
    public BigDecimal getTotalGweightOrd() {
        return totalGweightOrd;
    }

    /**
     * 设置预定入库总毛重
     *
     * @param totalGweightOrd 预定入库总毛重
     */
    public void setTotalGweightOrd(BigDecimal totalGweightOrd) {
        this.totalGweightOrd = totalGweightOrd;
    }

    /**
     * 获取预定入库总净重
     *
     * @return TOTAL_NWEIGHT_ORD - 预定入库总净重
     */
    public BigDecimal getTotalNweightOrd() {
        return totalNweightOrd;
    }

    /**
     * 设置预定入库总净重
     *
     * @param totalNweightOrd 预定入库总净重
     */
    public void setTotalNweightOrd(BigDecimal totalNweightOrd) {
        this.totalNweightOrd = totalNweightOrd;
    }

    /**
     * 获取预定入库总数量
     *
     * @return TOTAL_QTY_ORD - 预定入库总数量
     */
    public BigDecimal getTotalQtyOrd() {
        return totalQtyOrd;
    }
     ...
     * 设置预定入库总数量
     *
     * @param totalQtyOrd 预定入库总数量
     */
    public void setTotalQtyOrd(BigDecimal totalQtyOrd) {
        this.totalQtyOrd = totalQtyOrd;
    }

    /**
     * 获取记录人编号
     *
     * @return INPUT_USER_CD - 记录人编号
     */
     ...
     * 设置记录人编号
     *
     * @param inputUserCd 记录人编号
     */
    public void setInputUserCd(String inputUserCd) {
        this.inputUserCd = inputUserCd == null ? null : inputUserCd.trim();
    }
     ...
     * 获取预定入库单打印标识
     *
     * @return ORD_PRT_FLG - 预定入库单打印标识
     */
    public String getOrdPrtFlg() {
        return ordPrtFlg;
    }
     ...
     * 设置预定入库单打印标识
     *
     * @param ordPrtFlg 预定入库单打印标识
     */
    public void setOrdPrtFlg(String ordPrtFlg) {
        this.ordPrtFlg = ordPrtFlg == null ? null : ordPrtFlg.trim();
    }

    /**
     * 获取预定入库单打印人
     *
     * @return ORD_PRT_USER_ID - 预定入库单打印人
     */
    public String getOrdPrtUserId() {
        return ordPrtUserId;
    }
     ...
     * 设置预定入库单打印人
     *
     * @param ordPrtUserId 预定入库单打印人
     */
    public void setOrdPrtUserId(String ordPrtUserId) {
        this.ordPrtUserId = ordPrtUserId == null ? null : ordPrtUserId.trim();
    }

    /**
     * 获取预定入库单打印时间
     *
     * @return ORD_PRT_DT - 预定入库单打印时间
     */
    public Date getOrdPrtDt() {
        return ordPrtDt;
    }
     ...
     * 设置预定入库单打印时间
     *
     * @param ordPrtDt 预定入库单打印时间
     */
    public void setOrdPrtDt(Date ordPrtDt) {
        this.ordPrtDt = ordPrtDt;
    }
    ...
    public boolean equals(Object that) {
        ...
        TReceiptOrderHead other = (TReceiptOrderHead) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            && (this.getRcvOrdNum() == null ? other.getRcvOrdNum() == null : this.getRcvOrdNum().equals(other.getRcvOrdNum()))
            && (this.getOnsOrdDt() == null ? other.getOnsOrdDt() == null : this.getOnsOrdDt().equals(other.getOnsOrdDt()))
            && (this.getRcvOrdDt() == null ? other.getRcvOrdDt() == null : this.getRcvOrdDt().equals(other.getRcvOrdDt()))
            ...
            && (this.getForeignType() == null ? other.getForeignType() == null : this.getForeignType().equals(other.getForeignType()))
            && (this.getForeignNum() == null ? other.getForeignNum() == null : this.getForeignNum().equals(other.getForeignNum()))
            ...
            && (this.getTotalGweightOrd() == null ? other.getTotalGweightOrd() == null : this.getTotalGweightOrd().equals(other.getTotalGweightOrd()))
            && (this.getTotalNweightOrd() == null ? other.getTotalNweightOrd() == null : this.getTotalNweightOrd().equals(other.getTotalNweightOrd()))
            && (this.getTotalQtyOrd() == null ? other.getTotalQtyOrd() == null : this.getTotalQtyOrd().equals(other.getTotalQtyOrd()))
            && (this.getInputUserCd() == null ? other.getInputUserCd() == null : this.getInputUserCd().equals(other.getInputUserCd()))
            && (this.getInputDt() == null ? other.getInputDt() == null : this.getInputDt().equals(other.getInputDt()))
            && (this.getOrdPrtFlg() == null ? other.getOrdPrtFlg() == null : this.getOrdPrtFlg().equals(other.getOrdPrtFlg()))
            && (this.getOrdPrtUserId() == null ? other.getOrdPrtUserId() == null : this.getOrdPrtUserId().equals(other.getOrdPrtUserId()))
            && (this.getOrdPrtDt() == null ? other.getOrdPrtDt() == null : this.getOrdPrtDt().equals(other.getOrdPrtDt()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getOnsOrdDt() == null) ? 0 : getOnsOrdDt().hashCode());
        result = prime * result + ((getRcvOrdDt() == null) ? 0 : getRcvOrdDt().hashCode());
        ...
        result = prime * result + ((getForeignType() == null) ? 0 : getForeignType().hashCode());
        result = prime * result + ((getForeignNum() == null) ? 0 : getForeignNum().hashCode());
        result = prime * result + ((getCustomerId() == null) ? 0 : getCustomerId().hashCode());
        result = prime * result + ((getSupplierId() == null) ? 0 : getSupplierId().hashCode());
        result = prime * result + ((getOutFactoryId() == null) ? 0 : getOutFactoryId().hashCode());
        result = prime * result + ((getTotalGweightOrd() == null) ? 0 : getTotalGweightOrd().hashCode());
        result = prime * result + ((getTotalNweightOrd() == null) ? 0 : getTotalNweightOrd().hashCode());
        result = prime * result + ((getTotalQtyOrd() == null) ? 0 : getTotalQtyOrd().hashCode());
        result = prime * result + ((getInputUserCd() == null) ? 0 : getInputUserCd().hashCode());
        result = prime * result + ((getInputDt() == null) ? 0 : getInputDt().hashCode());
        result = prime * result + ((getOrdPrtFlg() == null) ? 0 : getOrdPrtFlg().hashCode());
        result = prime * result + ((getOrdPrtUserId() == null) ? 0 : getOrdPrtUserId().hashCode());
        result = prime * result + ((getOrdPrtDt() == null) ? 0 : getOrdPrtDt().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", onsOrdDt=").append(onsOrdDt);
        sb.append(", rcvOrdDt=").append(rcvOrdDt);
        ...
        sb.append(", foreignType=").append(foreignType);
        sb.append(", foreignNum=").append(foreignNum);
        sb.append(", customerId=").append(customerId);
        sb.append(", supplierId=").append(supplierId);
        sb.append(", outFactoryId=").append(outFactoryId);
        sb.append(", totalGweightOrd=").append(totalGweightOrd);
        sb.append(", totalNweightOrd=").append(totalNweightOrd);
        sb.append(", totalQtyOrd=").append(totalQtyOrd);
        sb.append(", inputUserCd=").append(inputUserCd);
        sb.append(", inputDt=").append(inputDt);
        sb.append(", ordPrtFlg=").append(ordPrtFlg);
        sb.append(", ordPrtUserId=").append(ordPrtUserId);
        sb.append(", ordPrtDt=").append(ordPrtDt);
