...
public class MRole implements Serializable {
     ...
     * 系统保留
     */
    @Column(name = "`SYS_RETAIN_FLG`")
    private String sysRetainFlg;
     ...
     * 获取系统保留
     *
     * @return SYS_RETAIN_FLG - 系统保留
     */
    public String getSysRetainFlg() {
        return sysRetainFlg;
    }
     ...
     * 设置系统保留
     *
     * @param sysRetainFlg 系统保留
     */
    public void setSysRetainFlg(String sysRetainFlg) {
        this.sysRetainFlg = sysRetainFlg == null ? null : sysRetainFlg.trim();
    }
    ...
    public boolean equals(Object that) {
        ...
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getRoleDis() == null ? other.getRoleDis() == null : this.getRoleDis().equals(other.getRoleDis()))
            && (this.getOrgId() == null ? other.getOrgId() == null : this.getOrgId().equals(other.getOrgId()))
            && (this.getSysRetainFlg() == null ? other.getSysRetainFlg() == null : this.getSysRetainFlg().equals(other.getSysRetainFlg()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getRoleDis() == null) ? 0 : getRoleDis().hashCode());
        result = prime * result + ((getOrgId() == null) ? 0 : getOrgId().hashCode());
        result = prime * result + ((getSysRetainFlg() == null) ? 0 : getSysRetainFlg().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", roleDis=").append(roleDis);
        sb.append(", orgId=").append(orgId);
        sb.append(", sysRetainFlg=").append(sysRetainFlg);
