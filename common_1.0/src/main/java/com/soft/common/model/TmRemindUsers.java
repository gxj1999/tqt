...
@Table(name = "`tm_remind_users`")
public class TmRemindUsers implements Serializable {
    /**
     * 主键
     */
    @Id
     ...
     * 任务提醒ID
     */
    @Column(name = "`TASK_REMIND_ID`")
    private String taskRemindId;

    /**
     * 提醒连番
     */
    @Column(name = "`REMIND_SEQ`")
    private String remindSeq;

    /**
     * 审批者连番
     */
    @Column(name = "`REMIND_USER_SEQ`")
    private String remindUserSeq;

    /**
     * 候选组织部门
     */
    @Column(name = "`ORG_DEPT_CD`")
     ...
     * 设置任务提醒ID
     *
     * @param taskRemindId 任务提醒ID
     */
    public void setTaskRemindId(String taskRemindId) {
        this.taskRemindId = taskRemindId == null ? null : taskRemindId.trim();
    }

    /**
     * 获取提醒连番
     *
     * @return REMIND_SEQ - 提醒连番
     */
    public String getRemindSeq() {
        return remindSeq;
    }
     ...
     * 设置提醒连番
     *
     * @param remindSeq 提醒连番
     */
    public void setRemindSeq(String remindSeq) {
        this.remindSeq = remindSeq == null ? null : remindSeq.trim();
    }

    /**
     * 获取审批者连番
     *
     * @return REMIND_USER_SEQ - 审批者连番
     */
    public String getRemindUserSeq() {
        return remindUserSeq;
    }

    /**
     * 设置审批者连番
     *
     * @param remindUserSeq 审批者连番
     */
    public void setRemindUserSeq(String remindUserSeq) {
        this.remindUserSeq = remindUserSeq == null ? null : remindUserSeq.trim();
    }

    /**
     * 获取候选组织部门
     *
     * @return ORG_DEPT_CD - 候选组织部门
     */
    public String getOrgDeptCd() {
        return orgDeptCd;
    }
     ...
     * 设置候选组织部门
     *
     * @param orgDeptCd 候选组织部门
     */
    public void setOrgDeptCd(String orgDeptCd) {
        this.orgDeptCd = orgDeptCd == null ? null : orgDeptCd.trim();
    }
    ...
    public boolean equals(Object that) {
        ...
        TmRemindUsers other = (TmRemindUsers) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            && (this.getCntrCd() == null ? other.getCntrCd() == null : this.getCntrCd().equals(other.getCntrCd()))
            && (this.getTaskRemindId() == null ? other.getTaskRemindId() == null : this.getTaskRemindId().equals(other.getTaskRemindId()))
            && (this.getRemindSeq() == null ? other.getRemindSeq() == null : this.getRemindSeq().equals(other.getRemindSeq()))
            && (this.getRemindUserSeq() == null ? other.getRemindUserSeq() == null : this.getRemindUserSeq().equals(other.getRemindUserSeq()))
            && (this.getOrgDeptCd() == null ? other.getOrgDeptCd() == null : this.getOrgDeptCd().equals(other.getOrgDeptCd()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getTaskRemindId() == null) ? 0 : getTaskRemindId().hashCode());
        result = prime * result + ((getRemindSeq() == null) ? 0 : getRemindSeq().hashCode());
        result = prime * result + ((getRemindUserSeq() == null) ? 0 : getRemindUserSeq().hashCode());
        result = prime * result + ((getOrgDeptCd() == null) ? 0 : getOrgDeptCd().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", taskRemindId=").append(taskRemindId);
        sb.append(", remindSeq=").append(remindSeq);
        sb.append(", remindUserSeq=").append(remindUserSeq);
        sb.append(", orgDeptCd=").append(orgDeptCd);
