...
public class MUserRole implements Serializable {
     ...
     * 是否公司组织
     */
    @Column(name = "`DEF_ORG_TYPE`")
    private String defOrgType;

    /**
     * 默认角色
     */
    @Column(name = "`DEF_CPY_FLG`")
     ...
     * 获取是否公司组织
     *
     * @return DEF_ORG_TYPE - 是否公司组织
     */
    public String getDefOrgType() {
        return defOrgType;
    }
     ...
     * 设置是否公司组织
     *
     * @param defOrgType 是否公司组织
     */
    public void setDefOrgType(String defOrgType) {
        this.defOrgType = defOrgType == null ? null : defOrgType.trim();
    }

    /**
     * 获取默认角色
     *
     * @return DEF_CPY_FLG - 默认角色
     */
     ...
     * 设置默认角色
     *
     * @param defCpyFlg 默认角色
     */
    public void setDefCpyFlg(String defCpyFlg) {
        this.defCpyFlg = defCpyFlg == null ? null : defCpyFlg.trim();
    }

    /**
     * 获取新建FLG
     *
     * @return NEW_FLG - 新建FLG
     */
    ...
    public void setNewFlg(String newFlg) {
        this.newFlg = newFlg == null ? null : newFlg.trim();
    }

    /**
     * 获取停用FLG
     *
     * @return DISABLE_FLG - 停用FLG
     */
    ...
    public boolean equals(Object that) {
        ...
        MUserRole other = (MUserRole) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getDefOrgType() == null ? other.getDefOrgType() == null : this.getDefOrgType().equals(other.getDefOrgType()))
            && (this.getDefCpyFlg() == null ? other.getDefCpyFlg() == null : this.getDefCpyFlg().equals(other.getDefCpyFlg()))
            && (this.getNewFlg() == null ? other.getNewFlg() == null : this.getNewFlg().equals(other.getNewFlg()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getDefOrgType() == null) ? 0 : getDefOrgType().hashCode());
        result = prime * result + ((getDefCpyFlg() == null) ? 0 : getDefCpyFlg().hashCode());
        result = prime * result + ((getNewFlg() == null) ? 0 : getNewFlg().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", defOrgType=").append(defOrgType);
        sb.append(", defCpyFlg=").append(defCpyFlg);
        sb.append(", newFlg=").append(newFlg);
