...
public class TDevice implements Serializable {
     ...
     * 设备表示用编号
     */
    @Column(name = "`DEVICE_DIS_CD`")
    private String deviceDisCd;
     ...
     * 获取设备表示用编号
     *
     * @return DEVICE_DIS_CD - 设备表示用编号
     */
    public String getDeviceDisCd() {
        return deviceDisCd;
    }
     ...
     * 设置设备表示用编号
     *
     * @param deviceDisCd 设备表示用编号
     */
    public void setDeviceDisCd(String deviceDisCd) {
        this.deviceDisCd = deviceDisCd == null ? null : deviceDisCd.trim();
    }

    /**
     * 获取设备名称
     *
     * @return DEVICE_NM - 设备名称
     */
    ...
    public boolean equals(Object that) {
        ...
        TDevice other = (TDevice) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            && (this.getCntrCd() == null ? other.getCntrCd() == null : this.getCntrCd().equals(other.getCntrCd()))
            && (this.getDeviceDisCd() == null ? other.getDeviceDisCd() == null : this.getDeviceDisCd().equals(other.getDeviceDisCd()))
            && (this.getDeviceNm() == null ? other.getDeviceNm() == null : this.getDeviceNm().equals(other.getDeviceNm()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getDeviceDisCd() == null) ? 0 : getDeviceDisCd().hashCode());
        result = prime * result + ((getDeviceNm() == null) ? 0 : getDeviceNm().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", deviceDisCd=").append(deviceDisCd);
        sb.append(", deviceNm=").append(deviceNm);
