...
@Table(name = "`t_traffic_plan`")
public class TTrafficPlan implements Serializable {
    /**
     * 主键
     */
    @Id
    ...
    public boolean equals(Object that) {
        ...
        TTrafficPlan other = (TTrafficPlan) that;
