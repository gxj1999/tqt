...
@Table(name = "`tm_task_approve_rule`")
public class TmTaskApproveRule implements Serializable {
    /**
     * 主键
     */
    @Id
     ...
     * 审批步骤名
     */
    @Column(name = "`APPROVE_STEP_NM`")
    private String approveStepNm;

    /**
     * 步骤表述
     */
    @Column(name = "`STEP_DESCRIBE`")
    private String stepDescribe;

    /**
     * 下一步审批步骤
     */
    @Column(name = "`NEXT_APPROVE_STEP`")
    private String nextApproveStep;

    /**
     * 退至审批步骤
     */
    @Column(name = "`BACK_APPROVE_STEP`")
    private String backApproveStep;
     ...
     * 获取审批步骤名
     *
     * @return APPROVE_STEP_NM - 审批步骤名
     */
    public String getApproveStepNm() {
        return approveStepNm;
    }

    /**
     * 设置审批步骤名
     *
     * @param approveStepNm 审批步骤名
     */
    public void setApproveStepNm(String approveStepNm) {
        this.approveStepNm = approveStepNm == null ? null : approveStepNm.trim();
    }

    /**
     * 获取步骤表述
     *
     * @return STEP_DESCRIBE - 步骤表述
     */
     ...
     * 设置步骤表述
     *
     * @param stepDescribe 步骤表述
     */
    public void setStepDescribe(String stepDescribe) {
        this.stepDescribe = stepDescribe == null ? null : stepDescribe.trim();
    }

    /**
     * 获取下一步审批步骤
     *
     * @return NEXT_APPROVE_STEP - 下一步审批步骤
     */
    public String getNextApproveStep() {
        return nextApproveStep;
    }

    /**
     * 设置下一步审批步骤
     *
     * @param nextApproveStep 下一步审批步骤
     */
    public void setNextApproveStep(String nextApproveStep) {
        this.nextApproveStep = nextApproveStep == null ? null : nextApproveStep.trim();
    }

    /**
     * 获取退至审批步骤
     *
     * @return BACK_APPROVE_STEP - 退至审批步骤
     */
    public String getBackApproveStep() {
        return backApproveStep;
    }

    /**
     * 设置退至审批步骤
     *
     * @param backApproveStep 退至审批步骤
     */
    public void setBackApproveStep(String backApproveStep) {
        this.backApproveStep = backApproveStep == null ? null : backApproveStep.trim();
    }

    /**
     * 获取完成标志
     *
     * @return COMPLETE_FLG - 完成标志
     */
    ...
    public boolean equals(Object that) {
        ...
        TmTaskApproveRule other = (TmTaskApproveRule) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getApproveStepNm() == null ? other.getApproveStepNm() == null : this.getApproveStepNm().equals(other.getApproveStepNm()))
            && (this.getStepDescribe() == null ? other.getStepDescribe() == null : this.getStepDescribe().equals(other.getStepDescribe()))
            && (this.getNextApproveStep() == null ? other.getNextApproveStep() == null : this.getNextApproveStep().equals(other.getNextApproveStep()))
            && (this.getBackApproveStep() == null ? other.getBackApproveStep() == null : this.getBackApproveStep().equals(other.getBackApproveStep()))
            && (this.getCompleteFlg() == null ? other.getCompleteFlg() == null : this.getCompleteFlg().equals(other.getCompleteFlg()))
            && (this.getConfirmUrl() == null ? other.getConfirmUrl() == null : this.getConfirmUrl().equals(other.getConfirmUrl()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getApproveStepNm() == null) ? 0 : getApproveStepNm().hashCode());
        result = prime * result + ((getStepDescribe() == null) ? 0 : getStepDescribe().hashCode());
        result = prime * result + ((getNextApproveStep() == null) ? 0 : getNextApproveStep().hashCode());
        result = prime * result + ((getBackApproveStep() == null) ? 0 : getBackApproveStep().hashCode());
        result = prime * result + ((getCompleteFlg() == null) ? 0 : getCompleteFlg().hashCode());
        result = prime * result + ((getConfirmUrl() == null) ? 0 : getConfirmUrl().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", approveStepNm=").append(approveStepNm);
        sb.append(", stepDescribe=").append(stepDescribe);
        sb.append(", nextApproveStep=").append(nextApproveStep);
        sb.append(", backApproveStep=").append(backApproveStep);
        sb.append(", completeFlg=").append(completeFlg);
        sb.append(", confirmUrl=").append(confirmUrl);
