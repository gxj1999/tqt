...
@Table(name = "`t_customer_visit_register`")
public class TCustomerVisitRegister implements Serializable {
    /**
     * 主键
     */
    @Id
     ...
     * 设置销售员编号
     *
     * @param salespersonCd 销售员编号
     */
    public void setSalespersonCd(String salespersonCd) {
        this.salespersonCd = salespersonCd == null ? null : salespersonCd.trim();
    }
    ...
    public boolean equals(Object that) {
        ...
        TCustomerVisitRegister other = (TCustomerVisitRegister) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            && (this.getCntrCd() == null ? other.getCntrCd() == null : this.getCntrCd().equals(other.getCntrCd()))
            && (this.getSalespersonCd() == null ? other.getSalespersonCd() == null : this.getSalespersonCd().equals(other.getSalespersonCd()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getSalespersonCd() == null) ? 0 : getSalespersonCd().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", salespersonCd=").append(salespersonCd);
