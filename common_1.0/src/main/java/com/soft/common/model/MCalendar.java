...
public class MCalendar implements Serializable {
     ...
     * 标准休息日
     */
    @Column(name = "`HOLIDAY_CL`")
    private String holidayCl;
    ...
    public void setYoubi(String youbi) {
        this.youbi = youbi == null ? null : youbi.trim();
    }

    /**
     * 获取标准休息日
     *
     * @return HOLIDAY_CL - 标准休息日
     */
    public String getHolidayCl() {
        return holidayCl;
    }
     ...
     * 设置标准休息日
     *
     * @param holidayCl 标准休息日
     */
    public void setHolidayCl(String holidayCl) {
        this.holidayCl = holidayCl == null ? null : holidayCl.trim();
    }

    /**
     * 获取休日
     *
     * @return HOLIDAY_DT - 休日
     */
    ...
    public void setHolidayDt(String holidayDt) {
        this.holidayDt = holidayDt == null ? null : holidayDt.trim();
    }

    /**
     * 获取休日状态
     *
     * @return HOLIDAY_STATUS - 休日状态
     */
     ...
     * 设置休日状态
     *
     * @param holidayStatus 休日状态
     */
    public void setHolidayStatus(String holidayStatus) {
        this.holidayStatus = holidayStatus == null ? null : holidayStatus.trim();
    }
    ...
    public boolean equals(Object that) {
        ...
        MCalendar other = (MCalendar) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getYoubi() == null ? other.getYoubi() == null : this.getYoubi().equals(other.getYoubi()))
            && (this.getHolidayCl() == null ? other.getHolidayCl() == null : this.getHolidayCl().equals(other.getHolidayCl()))
            && (this.getHolidayDt() == null ? other.getHolidayDt() == null : this.getHolidayDt().equals(other.getHolidayDt()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getYoubi() == null) ? 0 : getYoubi().hashCode());
        result = prime * result + ((getHolidayCl() == null) ? 0 : getHolidayCl().hashCode());
        result = prime * result + ((getHolidayDt() == null) ? 0 : getHolidayDt().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", youbi=").append(youbi);
        sb.append(", holidayCl=").append(holidayCl);
        sb.append(", holidayDt=").append(holidayDt);
