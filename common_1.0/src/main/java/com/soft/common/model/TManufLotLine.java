...
@Table(name = "`t_manuf_lot_line`")
public class TManufLotLine implements Serializable {
    /**
     * 主键
     */
    @Id
     ...
     * 生产批次明细号
     */
    @Column(name = "`LOT_LINE_NUM`")
    private String lotLineNum;
     ...
     * 获取生产批次明细号
     *
     * @return LOT_LINE_NUM - 生产批次明细号
     */
    public String getLotLineNum() {
        return lotLineNum;
    }
     ...
     * 设置生产批次明细号
     *
     * @param lotLineNum 生产批次明细号
     */
    public void setLotLineNum(String lotLineNum) {
        this.lotLineNum = lotLineNum == null ? null : lotLineNum.trim();
    }
    ...
    public boolean equals(Object that) {
        ...
        TManufLotLine other = (TManufLotLine) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            && (this.getLot() == null ? other.getLot() == null : this.getLot().equals(other.getLot()))
            && (this.getLotLineNum() == null ? other.getLotLineNum() == null : this.getLotLineNum().equals(other.getLotLineNum()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getLotLineNum() == null) ? 0 : getLotLineNum().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", lotLineNum=").append(lotLineNum);
