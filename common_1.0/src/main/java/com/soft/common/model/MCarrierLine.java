...
@Table(name = "`m_carrier_line`")
public class MCarrierLine implements Serializable {
    /**
     * 主键
     */
    @Id
     ...
     * 物流公司明细行号
     */
    @Column(name = "`CARRIER_LINE_NUM`")
    private String carrierLineNum;
     ...
     * 最大载重
     */
    @Column(name = "`WGT_LIMIT`")
    private BigDecimal wgtLimit;

    /**
     * 车重
     */
    @Column(name = "`WGT_CAR`")
    private BigDecimal wgtCar;

    /**
     * 最大总重
     */
    @Column(name = "`WGT_TOTAL`")
    private BigDecimal wgtTotal;
     ...
     * 车长
     */
    @Column(name = "`CAR_DEPTH`")
    private BigDecimal carDepth;
     ...
     * 装货区长
     */
    @Column(name = "`LOAD_DEPTH`")
    private BigDecimal loadDepth;
     ...
     * 获取物流公司明细行号
     *
     * @return CARRIER_LINE_NUM - 物流公司明细行号
     */
    public String getCarrierLineNum() {
        return carrierLineNum;
    }

    /**
     * 设置物流公司明细行号
     *
     * @param carrierLineNum 物流公司明细行号
     */
    public void setCarrierLineNum(String carrierLineNum) {
        this.carrierLineNum = carrierLineNum == null ? null : carrierLineNum.trim();
    }
    ...
    public void setCarNm(String carNm) {
        this.carNm = carNm == null ? null : carNm.trim();
    }
     ...
     * 获取最大载重
     *
     * @return WGT_LIMIT - 最大载重
     */
    public BigDecimal getWgtLimit() {
        return wgtLimit;
    }
     ...
     * @param wgtLimit 最大载重
     */
    public void setWgtLimit(BigDecimal wgtLimit) {
     ...
     * @param wgtCar 车重
     */
    public void setWgtCar(BigDecimal wgtCar) {
        this.wgtCar = wgtCar;
    }
     ...
     * 获取最大总重
     *
     * @return WGT_TOTAL - 最大总重
     */
    public BigDecimal getWgtTotal() {
        return wgtTotal;
    }
     ...
     * @param wgtTotal 最大总重
     */
    public void setWgtTotal(BigDecimal wgtTotal) {
        this.wgtTotal = wgtTotal;
    }

    /**
     * 获取车高
     *
     * @return CAR_HEIGHT - 车高
     */
     ...
     * @param carDepth 车长
     */
    public void setCarDepth(BigDecimal carDepth) {
     ...
     * 获取装货区高
     *
     * @return LOAD_HEIGHT - 装货区高
     */
    public BigDecimal getLoadHeight() {
        return loadHeight;
    }
     ...
     * 设置装货区高
     *
     * @param loadHeight 装货区高
     */
    public void setLoadHeight(BigDecimal loadHeight) {
     ...
     * 获取装货区宽
     *
     * @return LOAD_WIDTH - 装货区宽
     */
    public BigDecimal getLoadWidth() {
        return loadWidth;
    }
     ...
     * 设置装货区宽
     *
     * @param loadWidth 装货区宽
     */
    public void setLoadWidth(BigDecimal loadWidth) {
     ...
     * 获取装货区长
     *
     * @return LOAD_DEPTH - 装货区长
     */
    public BigDecimal getLoadDepth() {
        return loadDepth;
    }
     ...
     * 设置装货区长
     *
     * @param loadDepth 装货区长
     */
    public void setLoadDepth(BigDecimal loadDepth) {
    ...
    public boolean equals(Object that) {
        ...
        MCarrierLine other = (MCarrierLine) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getCarrierLineNum() == null ? other.getCarrierLineNum() == null : this.getCarrierLineNum().equals(other.getCarrierLineNum()))
            && (this.getCarNm() == null ? other.getCarNm() == null : this.getCarNm().equals(other.getCarNm()))
            && (this.getCarType() == null ? other.getCarType() == null : this.getCarType().equals(other.getCarType()))
            && (this.getWgtLimit() == null ? other.getWgtLimit() == null : this.getWgtLimit().equals(other.getWgtLimit()))
            && (this.getWgtCar() == null ? other.getWgtCar() == null : this.getWgtCar().equals(other.getWgtCar()))
            && (this.getWgtTotal() == null ? other.getWgtTotal() == null : this.getWgtTotal().equals(other.getWgtTotal()))
            && (this.getCarHeight() == null ? other.getCarHeight() == null : this.getCarHeight().equals(other.getCarHeight()))
            && (this.getCarWidth() == null ? other.getCarWidth() == null : this.getCarWidth().equals(other.getCarWidth()))
            && (this.getCarDepth() == null ? other.getCarDepth() == null : this.getCarDepth().equals(other.getCarDepth()))
            && (this.getLoadHeight() == null ? other.getLoadHeight() == null : this.getLoadHeight().equals(other.getLoadHeight()))
            && (this.getLoadWidth() == null ? other.getLoadWidth() == null : this.getLoadWidth().equals(other.getLoadWidth()))
            && (this.getLoadDepth() == null ? other.getLoadDepth() == null : this.getLoadDepth().equals(other.getLoadDepth()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getCarrierLineNum() == null) ? 0 : getCarrierLineNum().hashCode());
        result = prime * result + ((getCarNm() == null) ? 0 : getCarNm().hashCode());
        result = prime * result + ((getCarType() == null) ? 0 : getCarType().hashCode());
        result = prime * result + ((getWgtLimit() == null) ? 0 : getWgtLimit().hashCode());
        result = prime * result + ((getWgtCar() == null) ? 0 : getWgtCar().hashCode());
        result = prime * result + ((getWgtTotal() == null) ? 0 : getWgtTotal().hashCode());
        result = prime * result + ((getCarHeight() == null) ? 0 : getCarHeight().hashCode());
        result = prime * result + ((getCarWidth() == null) ? 0 : getCarWidth().hashCode());
        result = prime * result + ((getCarDepth() == null) ? 0 : getCarDepth().hashCode());
        result = prime * result + ((getLoadHeight() == null) ? 0 : getLoadHeight().hashCode());
        result = prime * result + ((getLoadWidth() == null) ? 0 : getLoadWidth().hashCode());
        result = prime * result + ((getLoadDepth() == null) ? 0 : getLoadDepth().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", carrierLineNum=").append(carrierLineNum);
        sb.append(", carNm=").append(carNm);
        sb.append(", carType=").append(carType);
        sb.append(", wgtLimit=").append(wgtLimit);
        sb.append(", wgtCar=").append(wgtCar);
        sb.append(", wgtTotal=").append(wgtTotal);
        sb.append(", carHeight=").append(carHeight);
        sb.append(", carWidth=").append(carWidth);
        sb.append(", carDepth=").append(carDepth);
        sb.append(", loadHeight=").append(loadHeight);
        sb.append(", loadWidth=").append(loadWidth);
        sb.append(", loadDepth=").append(loadDepth);
