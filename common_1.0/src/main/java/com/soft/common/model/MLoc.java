...
@Table(name = "`m_loc`")
public class MLoc implements Serializable {
    /**
     * 主键
     */
    @Id
     ...
     * 库位表示用编号
     */
    @Column(name = "`LOC_CD_DIS`")
    private String locCdDis;
    ...
    private BigDecimal depthLimit;

    /**
     * 入库顺序
     */
    @Column(name = "`RANK_FOR_ONS`")
    private BigDecimal rankForOns;

    /**
     * 出库顺序
     */
    @Column(name = "`RANK_FOR_ISS`")
    private BigDecimal rankForIss;

    /**
     * 禁止操作区分
     */
    @Column(name = "`ALLC_NG_CLS`")
    private String allcNgCls;
     ...
     * 获取库位表示用编号
     *
     * @return LOC_CD_DIS - 库位表示用编号
     */
    public String getLocCdDis() {
        return locCdDis;
    }
     ...
     */
    public void setLocCdDis(String locCdDis) {
        this.locCdDis = locCdDis == null ? null : locCdDis.trim();
    }
    ...
    public void setLocNm(String locNm) {
        this.locNm = locNm == null ? null : locNm.trim();
    }

    /**
     * 获取库位类型
     *
     * @return LOC_TYPE - 库位类型
     */
     ...
     * 获取长度上限
     *
     * @return DEPTH_LIMIT - 长度上限
     */
    public BigDecimal getDepthLimit() {
        return depthLimit;
    }
     ...
     * 设置长度上限
     *
     * @param depthLimit 长度上限
     */
    public void setDepthLimit(BigDecimal depthLimit) {
     ...
     * 获取入库顺序
     *
     * @return RANK_FOR_ONS - 入库顺序
     */
    public BigDecimal getRankForOns() {
        return rankForOns;
    }
     ...
     * 设置入库顺序
     *
     * @param rankForOns 入库顺序
     */
    public void setRankForOns(BigDecimal rankForOns) {
        this.rankForOns = rankForOns;
    }

    /**
     * 获取出库顺序
     *
     * @return RANK_FOR_ISS - 出库顺序
     */
    public BigDecimal getRankForIss() {
        return rankForIss;
    }
     ...
     * 设置出库顺序
     *
     * @param rankForIss 出库顺序
     */
    public void setRankForIss(BigDecimal rankForIss) {
        this.rankForIss = rankForIss;
    }

    /**
     * 获取禁止操作区分
     *
     * @return ALLC_NG_CLS - 禁止操作区分
     */
    public String getAllcNgCls() {
        return allcNgCls;
    }
     ...
     * 设置禁止操作区分
     *
     * @param allcNgCls 禁止操作区分
     */
    public void setAllcNgCls(String allcNgCls) {
        this.allcNgCls = allcNgCls == null ? null : allcNgCls.trim();
    }
    ...
    public boolean equals(Object that) {
        ...
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getLocCdDis() == null ? other.getLocCdDis() == null : this.getLocCdDis().equals(other.getLocCdDis()))
            && (this.getLocNm() == null ? other.getLocNm() == null : this.getLocNm().equals(other.getLocNm()))
            && (this.getLocType() == null ? other.getLocType() == null : this.getLocType().equals(other.getLocType()))
            && (this.getWgtLimit() == null ? other.getWgtLimit() == null : this.getWgtLimit().equals(other.getWgtLimit()))
            && (this.getHeightLimit() == null ? other.getHeightLimit() == null : this.getHeightLimit().equals(other.getHeightLimit()))
            && (this.getWidthLimit() == null ? other.getWidthLimit() == null : this.getWidthLimit().equals(other.getWidthLimit()))
            && (this.getDepthLimit() == null ? other.getDepthLimit() == null : this.getDepthLimit().equals(other.getDepthLimit()))
            && (this.getRankForOns() == null ? other.getRankForOns() == null : this.getRankForOns().equals(other.getRankForOns()))
            && (this.getRankForIss() == null ? other.getRankForIss() == null : this.getRankForIss().equals(other.getRankForIss()))
            && (this.getAllcNgCls() == null ? other.getAllcNgCls() == null : this.getAllcNgCls().equals(other.getAllcNgCls()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getLocCdDis() == null) ? 0 : getLocCdDis().hashCode());
        result = prime * result + ((getLocNm() == null) ? 0 : getLocNm().hashCode());
        result = prime * result + ((getLocType() == null) ? 0 : getLocType().hashCode());
        result = prime * result + ((getWgtLimit() == null) ? 0 : getWgtLimit().hashCode());
        result = prime * result + ((getHeightLimit() == null) ? 0 : getHeightLimit().hashCode());
        result = prime * result + ((getWidthLimit() == null) ? 0 : getWidthLimit().hashCode());
        result = prime * result + ((getDepthLimit() == null) ? 0 : getDepthLimit().hashCode());
        result = prime * result + ((getRankForOns() == null) ? 0 : getRankForOns().hashCode());
        result = prime * result + ((getRankForIss() == null) ? 0 : getRankForIss().hashCode());
        result = prime * result + ((getAllcNgCls() == null) ? 0 : getAllcNgCls().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", locCdDis=").append(locCdDis);
        sb.append(", locNm=").append(locNm);
        ...
        sb.append(", depthLimit=").append(depthLimit);
        sb.append(", rankForOns=").append(rankForOns);
        sb.append(", rankForIss=").append(rankForIss);
        sb.append(", allcNgCls=").append(allcNgCls);
