...
@Table(name = "`m_wh`")
public class MWh implements Serializable {
    /**
     * 主键
     */
    @Id
     ...
     * 仓库表示用编号
     */
    @Column(name = "`WH_CD_DIS`")
    private String whCdDis;
     ...
     * 仓库简称
     */
    @Column(name = "`WH_NM_JC`")
    private String whNmJc;
     ...
     * 获取仓库表示用编号
     *
     * @return WH_CD_DIS - 仓库表示用编号
     */
    public String getWhCdDis() {
        return whCdDis;
    }
     ...
     * 设置仓库表示用编号
     *
     * @param whCdDis 仓库表示用编号
     */
    public void setWhCdDis(String whCdDis) {
        this.whCdDis = whCdDis == null ? null : whCdDis.trim();
    }
    ...
    public void setWhNm(String whNm) {
        this.whNm = whNm == null ? null : whNm.trim();
    }

    /**
     * 获取仓库简称
     *
     * @return WH_NM_JC - 仓库简称
     */
    public String getWhNmJc() {
        return whNmJc;
    }
     ...
     * @param whNmJc 仓库简称
     */
    public void setWhNmJc(String whNmJc) {
        this.whNmJc = whNmJc == null ? null : whNmJc.trim();
    }
    ...
    public boolean equals(Object that) {
        ...
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getWhCdDis() == null ? other.getWhCdDis() == null : this.getWhCdDis().equals(other.getWhCdDis()))
            && (this.getWhNm() == null ? other.getWhNm() == null : this.getWhNm().equals(other.getWhNm()))
            && (this.getWhNmJc() == null ? other.getWhNmJc() == null : this.getWhNmJc().equals(other.getWhNmJc()))
            && (this.getWhType() == null ? other.getWhType() == null : this.getWhType().equals(other.getWhType()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getWhCdDis() == null) ? 0 : getWhCdDis().hashCode());
        result = prime * result + ((getWhNm() == null) ? 0 : getWhNm().hashCode());
        result = prime * result + ((getWhNmJc() == null) ? 0 : getWhNmJc().hashCode());
        result = prime * result + ((getWhType() == null) ? 0 : getWhType().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", whCdDis=").append(whCdDis);
        sb.append(", whNm=").append(whNm);
        sb.append(", whNmJc=").append(whNmJc);
