...
public class MZone implements Serializable {
     ...
     * 区域表示用编号
     */
    @Column(name = "`ZONE_CD_DIS`")
    private String zoneCdDis;
     ...
     * 获取区域表示用编号
     *
     * @return ZONE_CD_DIS - 区域表示用编号
     */
    public String getZoneCdDis() {
        return zoneCdDis;
    }
     ...
     * 设置区域表示用编号
     *
     * @param zoneCdDis 区域表示用编号
     */
    public void setZoneCdDis(String zoneCdDis) {
        this.zoneCdDis = zoneCdDis == null ? null : zoneCdDis.trim();
    }
    ...
    public void setZoneNm(String zoneNm) {
        this.zoneNm = zoneNm == null ? null : zoneNm.trim();
    }
    ...
    public boolean equals(Object that) {
        ...
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getZoneCdDis() == null ? other.getZoneCdDis() == null : this.getZoneCdDis().equals(other.getZoneCdDis()))
            && (this.getZoneNm() == null ? other.getZoneNm() == null : this.getZoneNm().equals(other.getZoneNm()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getZoneCdDis() == null) ? 0 : getZoneCdDis().hashCode());
        result = prime * result + ((getZoneNm() == null) ? 0 : getZoneNm().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", zoneCdDis=").append(zoneCdDis);
        sb.append(", zoneNm=").append(zoneNm);
