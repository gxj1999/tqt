...
public class MGeneral implements Serializable {
     ...
     * 共通区分
     */
    @Column(name = "`GENERAL_MASTER_TYPE`")
    private String generalMasterType;

    /**
     * 共通Code
     */
    @Column(name = "`GENERAL_CD`")
    private String generalCd;

    /**
     * 共通区分名称
     */
    @Column(name = "`GENERAL_MASTER_TYPE_NM`")
    private String generalMasterTypeNm;

    /**
     * 共通名称
     */
    @Column(name = "`GENERAL_NM`")
    private String generalNm;

    /**
     * 共通略称
     */
    @Column(name = "`GENERAL_ABBR`")
    private String generalAbbr;
     ...
     * 获取共通区分
     *
     * @return GENERAL_MASTER_TYPE - 共通区分
     */
    public String getGeneralMasterType() {
        return generalMasterType;
    }
    ...
    public void setGeneralMasterType(String generalMasterType) {
        this.generalMasterType = generalMasterType == null ? null : generalMasterType.trim();
    }

    /**
     * 获取共通Code
     *
     * @return GENERAL_CD - 共通Code
     */
     ...
     * 设置共通Code
     *
     * @param generalCd 共通Code
     */
    public void setGeneralCd(String generalCd) {
        this.generalCd = generalCd == null ? null : generalCd.trim();
    }

    /**
     * 获取共通区分名称
     *
     * @return GENERAL_MASTER_TYPE_NM - 共通区分名称
     */
    public String getGeneralMasterTypeNm() {
        return generalMasterTypeNm;
    }
    ...
    public void setGeneralMasterTypeNm(String generalMasterTypeNm) {
        this.generalMasterTypeNm = generalMasterTypeNm == null ? null : generalMasterTypeNm.trim();
    }

    /**
     * 获取共通名称
     *
     * @return GENERAL_NM - 共通名称
     */
     ...
     * 设置共通名称
     *
     * @param generalNm 共通名称
     */
    public void setGeneralNm(String generalNm) {
        this.generalNm = generalNm == null ? null : generalNm.trim();
    }

    /**
     * 获取共通略称
     *
     * @return GENERAL_ABBR - 共通略称
     */
     ...
     * 设置共通略称
     *
     * @param generalAbbr 共通略称
     */
    public void setGeneralAbbr(String generalAbbr) {
        this.generalAbbr = generalAbbr == null ? null : generalAbbr.trim();
    }
    ...
    public boolean equals(Object that) {
        ...
        MGeneral other = (MGeneral) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            && (this.getCntrCd() == null ? other.getCntrCd() == null : this.getCntrCd().equals(other.getCntrCd()))
            && (this.getGeneralMasterType() == null ? other.getGeneralMasterType() == null : this.getGeneralMasterType().equals(other.getGeneralMasterType()))
            && (this.getGeneralCd() == null ? other.getGeneralCd() == null : this.getGeneralCd().equals(other.getGeneralCd()))
            && (this.getGeneralMasterTypeNm() == null ? other.getGeneralMasterTypeNm() == null : this.getGeneralMasterTypeNm().equals(other.getGeneralMasterTypeNm()))
            && (this.getGeneralNm() == null ? other.getGeneralNm() == null : this.getGeneralNm().equals(other.getGeneralNm()))
            && (this.getGeneralAbbr() == null ? other.getGeneralAbbr() == null : this.getGeneralAbbr().equals(other.getGeneralAbbr()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getGeneralMasterType() == null) ? 0 : getGeneralMasterType().hashCode());
        result = prime * result + ((getGeneralCd() == null) ? 0 : getGeneralCd().hashCode());
        result = prime * result + ((getGeneralMasterTypeNm() == null) ? 0 : getGeneralMasterTypeNm().hashCode());
        result = prime * result + ((getGeneralNm() == null) ? 0 : getGeneralNm().hashCode());
        result = prime * result + ((getGeneralAbbr() == null) ? 0 : getGeneralAbbr().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", generalMasterType=").append(generalMasterType);
        sb.append(", generalCd=").append(generalCd);
        sb.append(", generalMasterTypeNm=").append(generalMasterTypeNm);
        sb.append(", generalNm=").append(generalNm);
        sb.append(", generalAbbr=").append(generalAbbr);
