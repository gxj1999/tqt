...
@Table(name = "`m_numericing`")
public class MNumericing implements Serializable {
    /**
     * 主键
     */
    @Id
     ...
     * 位数
     */
    @Column(name = "`NUM_OF_DIGIT`")
    private Integer numOfDigit;

    /**
     * 採番区分
     */
    @Column(name = "`NUMING_CLS`")
    private String numingCls;
     ...
     * 固定日期格式
     */
    @Column(name = "`FIXED_DT_FORMAT`")
    private String fixedDtFormat;

    /**
     * 日期类型
     */
    @Column(name = "`FIXED_DT_TYPE`")
    private String fixedDtType;
     ...
     * 初期化区分
     */
    @Column(name = "`INIT_CLS`")
    private String initCls;
    ...
    public void setBizCd(String bizCd) {
        this.bizCd = bizCd == null ? null : bizCd.trim();
    }
     ...
     * 获取位数
     *
     * @return NUM_OF_DIGIT - 位数
     */
    public Integer getNumOfDigit() {
        return numOfDigit;
    }
     ...
     * @param numOfDigit 位数
     */
    public void setNumOfDigit(Integer numOfDigit) {
     ...
     * 获取採番区分
     *
     * @return NUMING_CLS - 採番区分
     */
    public String getNumingCls() {
        return numingCls;
    }
     ...
     * 设置採番区分
     *
     * @param numingCls 採番区分
     */
    public void setNumingCls(String numingCls) {
        this.numingCls = numingCls == null ? null : numingCls.trim();
    }

    /**
     * 获取固定文字
     *
     * @return FIXED_VALUE - 固定文字
     */
     ...
     * 获取固定日期格式
     *
     * @return FIXED_DT_FORMAT - 固定日期格式
     */
    public String getFixedDtFormat() {
        return fixedDtFormat;
    }

    /**
     * 设置固定日期格式
     *
     * @param fixedDtFormat 固定日期格式
     */
    public void setFixedDtFormat(String fixedDtFormat) {
        this.fixedDtFormat = fixedDtFormat == null ? null : fixedDtFormat.trim();
    }

    /**
     * 获取日期类型
     *
     * @return FIXED_DT_TYPE - 日期类型
     */
    public String getFixedDtType() {
        return fixedDtType;
    }
     ...
     * 设置日期类型
     *
     * @param fixedDtType 日期类型
     */
    public void setFixedDtType(String fixedDtType) {
        this.fixedDtType = fixedDtType == null ? null : fixedDtType.trim();
    }

    /**
     * 获取当前值
     *
     * @return PRESENT_VALUE - 当前值
     */
     ...
     * 获取增加值
     *
     * @return INC_VALUE - 增加值
     */
    public BigDecimal getIncValue() {
        return incValue;
    }
     ...
     * @param incValue 增加值
     */
    public void setIncValue(BigDecimal incValue) {
    ...
    public void setInitCls(String initCls) {
        this.initCls = initCls == null ? null : initCls.trim();
    }
    ...
    public boolean equals(Object that) {
        ...
        MNumericing other = (MNumericing) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            && (this.getCntrCd() == null ? other.getCntrCd() == null : this.getCntrCd().equals(other.getCntrCd()))
            && (this.getBizCd() == null ? other.getBizCd() == null : this.getBizCd().equals(other.getBizCd()))
            && (this.getBizNm() == null ? other.getBizNm() == null : this.getBizNm().equals(other.getBizNm()))
            && (this.getNumOfDigit() == null ? other.getNumOfDigit() == null : this.getNumOfDigit().equals(other.getNumOfDigit()))
            && (this.getNumingCls() == null ? other.getNumingCls() == null : this.getNumingCls().equals(other.getNumingCls()))
            && (this.getFixedValue() == null ? other.getFixedValue() == null : this.getFixedValue().equals(other.getFixedValue()))
            && (this.getFixedDtFormat() == null ? other.getFixedDtFormat() == null : this.getFixedDtFormat().equals(other.getFixedDtFormat()))
            && (this.getFixedDtType() == null ? other.getFixedDtType() == null : this.getFixedDtType().equals(other.getFixedDtType()))
            && (this.getPresentValue() == null ? other.getPresentValue() == null : this.getPresentValue().equals(other.getPresentValue()))
            && (this.getIncValue() == null ? other.getIncValue() == null : this.getIncValue().equals(other.getIncValue()))
            ...
            && (this.getInitCls() == null ? other.getInitCls() == null : this.getInitCls().equals(other.getInitCls()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getBizCd() == null) ? 0 : getBizCd().hashCode());
        result = prime * result + ((getBizNm() == null) ? 0 : getBizNm().hashCode());
        result = prime * result + ((getNumOfDigit() == null) ? 0 : getNumOfDigit().hashCode());
        result = prime * result + ((getNumingCls() == null) ? 0 : getNumingCls().hashCode());
        result = prime * result + ((getFixedValue() == null) ? 0 : getFixedValue().hashCode());
        result = prime * result + ((getFixedDtFormat() == null) ? 0 : getFixedDtFormat().hashCode());
        result = prime * result + ((getFixedDtType() == null) ? 0 : getFixedDtType().hashCode());
        result = prime * result + ((getPresentValue() == null) ? 0 : getPresentValue().hashCode());
        result = prime * result + ((getIncValue() == null) ? 0 : getIncValue().hashCode());
        ...
        result = prime * result + ((getInitCls() == null) ? 0 : getInitCls().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", bizCd=").append(bizCd);
        sb.append(", bizNm=").append(bizNm);
        sb.append(", numOfDigit=").append(numOfDigit);
        sb.append(", numingCls=").append(numingCls);
        sb.append(", fixedValue=").append(fixedValue);
        sb.append(", fixedDtFormat=").append(fixedDtFormat);
        sb.append(", fixedDtType=").append(fixedDtType);
        sb.append(", presentValue=").append(presentValue);
        sb.append(", incValue=").append(incValue);
        sb.append(", minValue=").append(minValue);
        sb.append(", maxValue=").append(maxValue);
        sb.append(", checkDigit=").append(checkDigit);
        sb.append(", initCls=").append(initCls);
