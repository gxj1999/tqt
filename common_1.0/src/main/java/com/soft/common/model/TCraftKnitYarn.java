...
@Table(name = "`t_craft_knit_yarn`")
public class TCraftKnitYarn implements Serializable {
    /**
     * 主键
     */
    @Id
     ...
     * 纱线明细号
     */
    @Column(name = "`CRAFT_YARN_LINE_NUM`")
    private String craftYarnLineNum;
     ...
     * 成分比例
     */
    @Column(name = "`COMPONENT_RATIO`")
    private String componentRatio;

    /**
     * 条数
     */
    @Column(name = "`BARS_NUMBER`")
    private BigDecimal barsNumber;

    /**
     * 纱强力
     */
    @Column(name = "`YARN_STRENGTH`")
    private String yarnStrength;

    /**
     * 要求纱支
     */
    @Column(name = "`NEED_YARN_CNT`")
    private String needYarnCnt;
     ...
     * 算纱比例
     */
    @Column(name = "`YARN_RATIO`")
    private BigDecimal yarnRatio;

    /**
     * 纱质量
     */
    @Column(name = "`YARN_QUALITY`")
    private String yarnQuality;

    /**
     * 千米克重
     */
    @Column(name = "`KM_WEIGHT`")
    private BigDecimal kmWeight;
     ...
     * 获取纱线明细号
     *
     * @return CRAFT_YARN_LINE_NUM - 纱线明细号
     */
    public String getCraftYarnLineNum() {
        return craftYarnLineNum;
    }

    /**
     * 设置纱线明细号
     *
     * @param craftYarnLineNum 纱线明细号
     */
    public void setCraftYarnLineNum(String craftYarnLineNum) {
        this.craftYarnLineNum = craftYarnLineNum == null ? null : craftYarnLineNum.trim();
    }
     ...
     * 获取成分比例
     *
     * @return COMPONENT_RATIO - 成分比例
     */
    public String getComponentRatio() {
     ...
     * 设置成分比例
     *
     * @param componentRatio 成分比例
     */
    public void setComponentRatio(String componentRatio) {
        this.componentRatio = componentRatio == null ? null : componentRatio.trim();
    }

    /**
     * 获取条数
     *
     * @return BARS_NUMBER - 条数
     */
    public BigDecimal getBarsNumber() {
        return barsNumber;
    }
     ...
     * @param barsNumber 条数
     */
    public void setBarsNumber(BigDecimal barsNumber) {
     ...
     * 获取纱强力
     *
     * @return YARN_STRENGTH - 纱强力
     */
    public String getYarnStrength() {
        return yarnStrength;
    }
     ...
     * 设置纱强力
     *
     * @param yarnStrength 纱强力
     */
    public void setYarnStrength(String yarnStrength) {
        this.yarnStrength = yarnStrength == null ? null : yarnStrength.trim();
    }

    /**
     * 获取要求纱支
     *
     * @return NEED_YARN_CNT - 要求纱支
     */
    public String getNeedYarnCnt() {
        return needYarnCnt;
    }
     ...
     * 设置要求纱支
     *
     * @param needYarnCnt 要求纱支
     */
    public void setNeedYarnCnt(String needYarnCnt) {
        this.needYarnCnt = needYarnCnt == null ? null : needYarnCnt.trim();
    }
     ...
     * 获取算纱比例
     *
     * @return YARN_RATIO - 算纱比例
     */
    public BigDecimal getYarnRatio() {
        return yarnRatio;
    }
     ...
     * 设置算纱比例
     *
     * @param yarnRatio 算纱比例
     */
    public void setYarnRatio(BigDecimal yarnRatio) {
        this.yarnRatio = yarnRatio;
    }

    /**
     * 获取纱质量
     *
     * @return YARN_QUALITY - 纱质量
     */
     ...
     * 设置纱质量
     *
     * @param yarnQuality 纱质量
     */
    public void setYarnQuality(String yarnQuality) {
        this.yarnQuality = yarnQuality == null ? null : yarnQuality.trim();
    }

    /**
     * 获取千米克重
     *
     * @return KM_WEIGHT - 千米克重
     */
    public BigDecimal getKmWeight() {
        return kmWeight;
    }
     ...
     * @param kmWeight 千米克重
     */
    public void setKmWeight(BigDecimal kmWeight) {
        this.kmWeight = kmWeight;
    }
     ...
     * 获取色比
     *
     * @return COLOR_RATIO - 色比
     */
    public BigDecimal getColorRatio() {
        return colorRatio;
    }
     ...
     * @param colorRatio 色比
     */
    public void setColorRatio(BigDecimal colorRatio) {
    ...
    public boolean equals(Object that) {
        ...
        TCraftKnitYarn other = (TCraftKnitYarn) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            && (this.getCraftSn() == null ? other.getCraftSn() == null : this.getCraftSn().equals(other.getCraftSn()))
            && (this.getCraftYarnLineNum() == null ? other.getCraftYarnLineNum() == null : this.getCraftYarnLineNum().equals(other.getCraftYarnLineNum()))
            ...
            && (this.getComponentRatio() == null ? other.getComponentRatio() == null : this.getComponentRatio().equals(other.getComponentRatio()))
            && (this.getBarsNumber() == null ? other.getBarsNumber() == null : this.getBarsNumber().equals(other.getBarsNumber()))
            && (this.getYarnStrength() == null ? other.getYarnStrength() == null : this.getYarnStrength().equals(other.getYarnStrength()))
            && (this.getNeedYarnCnt() == null ? other.getNeedYarnCnt() == null : this.getNeedYarnCnt().equals(other.getNeedYarnCnt()))
            && (this.getTwist() == null ? other.getTwist() == null : this.getTwist().equals(other.getTwist()))
            && (this.getYarnRatio() == null ? other.getYarnRatio() == null : this.getYarnRatio().equals(other.getYarnRatio()))
            && (this.getYarnQuality() == null ? other.getYarnQuality() == null : this.getYarnQuality().equals(other.getYarnQuality()))
            && (this.getKmWeight() == null ? other.getKmWeight() == null : this.getKmWeight().equals(other.getKmWeight()))
            ...
            && (this.getColorRatio() == null ? other.getColorRatio() == null : this.getColorRatio().equals(other.getColorRatio()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getCraftYarnLineNum() == null) ? 0 : getCraftYarnLineNum().hashCode());
        ...
        result = prime * result + ((getComponentRatio() == null) ? 0 : getComponentRatio().hashCode());
        result = prime * result + ((getBarsNumber() == null) ? 0 : getBarsNumber().hashCode());
        result = prime * result + ((getYarnStrength() == null) ? 0 : getYarnStrength().hashCode());
        result = prime * result + ((getNeedYarnCnt() == null) ? 0 : getNeedYarnCnt().hashCode());
        result = prime * result + ((getTwist() == null) ? 0 : getTwist().hashCode());
        result = prime * result + ((getYarnRatio() == null) ? 0 : getYarnRatio().hashCode());
        result = prime * result + ((getYarnQuality() == null) ? 0 : getYarnQuality().hashCode());
        result = prime * result + ((getKmWeight() == null) ? 0 : getKmWeight().hashCode());
        ...
        result = prime * result + ((getColorRatio() == null) ? 0 : getColorRatio().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", craftYarnLineNum=").append(craftYarnLineNum);
        sb.append(", prodId=").append(prodId);
        sb.append(", prodClassId=").append(prodClassId);
        sb.append(", yarnCount=").append(yarnCount);
        sb.append(", componentRatio=").append(componentRatio);
        sb.append(", barsNumber=").append(barsNumber);
        sb.append(", yarnStrength=").append(yarnStrength);
        sb.append(", needYarnCnt=").append(needYarnCnt);
        sb.append(", twist=").append(twist);
        sb.append(", yarnRatio=").append(yarnRatio);
        sb.append(", yarnQuality=").append(yarnQuality);
        sb.append(", kmWeight=").append(kmWeight);
        sb.append(", colorCd=").append(colorCd);
        sb.append(", colorSystem=").append(colorSystem);
        sb.append(", colorNm=").append(colorNm);
        sb.append(", colorRatio=").append(colorRatio);
