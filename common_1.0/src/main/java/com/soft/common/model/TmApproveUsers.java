...
@Table(name = "`tm_approve_users`")
public class TmApproveUsers implements Serializable {
    /**
     * 主键
     */
    @Id
     ...
     * 仅申请者所属
     */
    @Column(name = "`ONLY_APPLY_ORG`")
    private String onlyApplyOrg;
     ...
     * 设置审批者连番
     *
     * @param approveUserSeq 审批者连番
     */
    public void setApproveUserSeq(String approveUserSeq) {
        this.approveUserSeq = approveUserSeq == null ? null : approveUserSeq.trim();
    }
     ...
     * 获取仅申请者所属
     *
     * @return ONLY_APPLY_ORG - 仅申请者所属
     */
    public String getOnlyApplyOrg() {
        return onlyApplyOrg;
    }
     ...
     * 设置仅申请者所属
     *
     * @param onlyApplyOrg 仅申请者所属
     */
    public void setOnlyApplyOrg(String onlyApplyOrg) {
        this.onlyApplyOrg = onlyApplyOrg == null ? null : onlyApplyOrg.trim();
    }
    ...
    public boolean equals(Object that) {
        ...
        TmApproveUsers other = (TmApproveUsers) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getApproveUserSeq() == null ? other.getApproveUserSeq() == null : this.getApproveUserSeq().equals(other.getApproveUserSeq()))
            ...
            && (this.getOnlyApplyOrg() == null ? other.getOnlyApplyOrg() == null : this.getOnlyApplyOrg().equals(other.getOnlyApplyOrg()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getApproveUserSeq() == null) ? 0 : getApproveUserSeq().hashCode());
        ...
        result = prime * result + ((getOnlyApplyOrg() == null) ? 0 : getOnlyApplyOrg().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", approveUserSeq=").append(approveUserSeq);
        sb.append(", orgDeptCd=").append(orgDeptCd);
        sb.append(", roleId=").append(roleId);
        sb.append(", sysUserId=").append(sysUserId);
        sb.append(", onlyApplyOrg=").append(onlyApplyOrg);
