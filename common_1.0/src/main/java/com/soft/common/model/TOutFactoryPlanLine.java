...
@Table(name = "`t_out_factory_plan_line`")
public class TOutFactoryPlanLine implements Serializable {
    /**
     * 主键
     */
    @Id
     ...
     * 外发计划明细号
     */
    @Column(name = "`OF_PLAN_LINE_NUM`")
    private String ofPlanLineNum;
     ...
     * 获取外发计划明细号
     *
     * @return OF_PLAN_LINE_NUM - 外发计划明细号
     */
    public String getOfPlanLineNum() {
        return ofPlanLineNum;
    }

    /**
     * 设置外发计划明细号
     *
     * @param ofPlanLineNum 外发计划明细号
     */
    public void setOfPlanLineNum(String ofPlanLineNum) {
        this.ofPlanLineNum = ofPlanLineNum == null ? null : ofPlanLineNum.trim();
    }
    ...
    public boolean equals(Object that) {
        ...
        TOutFactoryPlanLine other = (TOutFactoryPlanLine) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            && (this.getOfPlanCd() == null ? other.getOfPlanCd() == null : this.getOfPlanCd().equals(other.getOfPlanCd()))
            && (this.getOfPlanLineNum() == null ? other.getOfPlanLineNum() == null : this.getOfPlanLineNum().equals(other.getOfPlanLineNum()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getOfPlanLineNum() == null) ? 0 : getOfPlanLineNum().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", ofPlanLineNum=").append(ofPlanLineNum);
