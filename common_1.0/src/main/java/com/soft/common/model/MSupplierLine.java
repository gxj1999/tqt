...
@Table(name = "`m_supplier_line`")
public class MSupplierLine implements Serializable {
    /**
     * 主键
     */
    @Id
     ...
     * 供应商明细行号
     */
    @Column(name = "`SUPPLIER_LINE_NUM`")
    private String supplierLineNum;
     ...
     * 获取供应商明细行号
     *
     * @return SUPPLIER_LINE_NUM - 供应商明细行号
     */
    public String getSupplierLineNum() {
        return supplierLineNum;
    }

    /**
     * 设置供应商明细行号
     *
     * @param supplierLineNum 供应商明细行号
     */
    public void setSupplierLineNum(String supplierLineNum) {
        this.supplierLineNum = supplierLineNum == null ? null : supplierLineNum.trim();
    }
    ...
    public boolean equals(Object that) {
        ...
        MSupplierLine other = (MSupplierLine) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            && (this.getCntrCd() == null ? other.getCntrCd() == null : this.getCntrCd().equals(other.getCntrCd()))
            && (this.getSupplierId() == null ? other.getSupplierId() == null : this.getSupplierId().equals(other.getSupplierId()))
            && (this.getSupplierLineNum() == null ? other.getSupplierLineNum() == null : this.getSupplierLineNum().equals(other.getSupplierLineNum()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getSupplierLineNum() == null) ? 0 : getSupplierLineNum().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", supplierLineNum=").append(supplierLineNum);
