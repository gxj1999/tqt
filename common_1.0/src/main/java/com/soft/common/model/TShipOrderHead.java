...
@Table(name = "`t_ship_order_head`")
public class TShipOrderHead implements Serializable {
    /**
     * 主键
     */
    @Id
     ...
     * 预定出库单号
     */
    @Column(name = "`SHP_ORD_NUM`")
    private String shpOrdNum;

    /**
     * 预定出库日期
     */
    @Column(name = "`SHP_ORD_DT`")
    private String shpOrdDt;
     ...
     */
    public void setShpOrdNum(String shpOrdNum) {
     ...
     * 获取预定出库日期
     *
     * @return SHP_ORD_DT - 预定出库日期
     */
    public String getShpOrdDt() {
        return shpOrdDt;
    }
     ...
     * 设置预定出库日期
     *
     * @param shpOrdDt 预定出库日期
     */
    public void setShpOrdDt(String shpOrdDt) {
        this.shpOrdDt = shpOrdDt == null ? null : shpOrdDt.trim();
    }
     ...
     * 获取预定出库总毛重
     *
     * @return TOTAL_GWEIGHT_ORD - 预定出库总毛重
     */
     ...
     * 获取预定出库总净重
     *
     * @return TOTAL_NWEIGHT_ORD - 预定出库总净重
     */
     ...
     * 获取预定出库单打印人
     *
     * @return ORD_PRT_USER_ID - 预定出库单打印人
     */
    ...
    public boolean equals(Object that) {
        ...
        TShipOrderHead other = (TShipOrderHead) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            && (this.getShpOrdNum() == null ? other.getShpOrdNum() == null : this.getShpOrdNum().equals(other.getShpOrdNum()))
            && (this.getShpOrdDt() == null ? other.getShpOrdDt() == null : this.getShpOrdDt().equals(other.getShpOrdDt()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getShpOrdDt() == null) ? 0 : getShpOrdDt().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", shpOrdDt=").append(shpOrdDt);
