...
@Table(name = "`t_sell_ord_specs_line`")
public class TSellOrdSpecsLine implements Serializable {
    /**
     * 主键
     */
    @Id
     ...
     * 销售规格明细编号
     */
    @Column(name = "`SELL_ORD_SPECS_CD`")
    private String sellOrdSpecsCd;
     ...
     * 领高度
     */
    @Column(name = "`COLLAR_HEIGHT`")
    private BigDecimal collarHeight;
     ...
     * 袖高度
     */
    @Column(name = "`SLEEVE_HEIGTH`")
    private BigDecimal sleeveHeigth;

    /**
     * 带长度
     */
    @Column(name = "`BAND_LENGTH`")
    private BigDecimal bandLength;
     ...
     * 获取销售规格明细编号
     *
     * @return SELL_ORD_SPECS_CD - 销售规格明细编号
     */
    public String getSellOrdSpecsCd() {
        return sellOrdSpecsCd;
    }

    /**
     * 设置销售规格明细编号
     *
     * @param sellOrdSpecsCd 销售规格明细编号
     */
    public void setSellOrdSpecsCd(String sellOrdSpecsCd) {
        this.sellOrdSpecsCd = sellOrdSpecsCd == null ? null : sellOrdSpecsCd.trim();
    }
     ...
     * 获取领长度
     *
     * @return COLLAR_LENGTH - 领长度
     */
    public BigDecimal getCollarLength() {
        return collarLength;
    }
     ...
     * 设置领长度
     *
     * @param collarLength 领长度
     */
    public void setCollarLength(BigDecimal collarLength) {
     ...
     * 获取领高度
     *
     * @return COLLAR_HEIGHT - 领高度
     */
    public BigDecimal getCollarHeight() {
        return collarHeight;
    }
     ...
     * 设置领高度
     *
     * @param collarHeight 领高度
     */
    public void setCollarHeight(BigDecimal collarHeight) {
        this.collarHeight = collarHeight;
    }

    /**
     * 获取袖长度
     *
     * @return SLEEVE_LENGTH - 袖长度
     */
     ...
     * 获取袖高度
     *
     * @return SLEEVE_HEIGTH - 袖高度
     */
    public BigDecimal getSleeveHeigth() {
        return sleeveHeigth;
    }
     ...
     * 设置袖高度
     *
     * @param sleeveHeigth 袖高度
     */
    public void setSleeveHeigth(BigDecimal sleeveHeigth) {
        this.sleeveHeigth = sleeveHeigth;
    }

    /**
     * 获取带长度
     *
     * @return BAND_LENGTH - 带长度
     */
    public BigDecimal getBandLength() {
        return bandLength;
    }
     ...
     * 设置带长度
     *
     * @param bandLength 带长度
     */
    public void setBandLength(BigDecimal bandLength) {
    ...
    public boolean equals(Object that) {
        ...
        TSellOrdSpecsLine other = (TSellOrdSpecsLine) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getSellOrdSpecsCd() == null ? other.getSellOrdSpecsCd() == null : this.getSellOrdSpecsCd().equals(other.getSellOrdSpecsCd()))
            && (this.getSize() == null ? other.getSize() == null : this.getSize().equals(other.getSize()))
            && (this.getUnit() == null ? other.getUnit() == null : this.getUnit().equals(other.getUnit()))
            && (this.getCollarLength() == null ? other.getCollarLength() == null : this.getCollarLength().equals(other.getCollarLength()))
            && (this.getCollarHeight() == null ? other.getCollarHeight() == null : this.getCollarHeight().equals(other.getCollarHeight()))
            && (this.getSleeveLength() == null ? other.getSleeveLength() == null : this.getSleeveLength().equals(other.getSleeveLength()))
            && (this.getSleeveHeigth() == null ? other.getSleeveHeigth() == null : this.getSleeveHeigth().equals(other.getSleeveHeigth()))
            && (this.getBandLength() == null ? other.getBandLength() == null : this.getBandLength().equals(other.getBandLength()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getSellOrdSpecsCd() == null) ? 0 : getSellOrdSpecsCd().hashCode());
        result = prime * result + ((getSize() == null) ? 0 : getSize().hashCode());
        result = prime * result + ((getUnit() == null) ? 0 : getUnit().hashCode());
        result = prime * result + ((getCollarLength() == null) ? 0 : getCollarLength().hashCode());
        result = prime * result + ((getCollarHeight() == null) ? 0 : getCollarHeight().hashCode());
        result = prime * result + ((getSleeveLength() == null) ? 0 : getSleeveLength().hashCode());
        result = prime * result + ((getSleeveHeigth() == null) ? 0 : getSleeveHeigth().hashCode());
        result = prime * result + ((getBandLength() == null) ? 0 : getBandLength().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", sellOrdSpecsCd=").append(sellOrdSpecsCd);
        sb.append(", size=").append(size);
        sb.append(", unit=").append(unit);
        sb.append(", collarLength=").append(collarLength);
        sb.append(", collarHeight=").append(collarHeight);
        sb.append(", sleeveLength=").append(sleeveLength);
        sb.append(", sleeveHeigth=").append(sleeveHeigth);
        sb.append(", bandLength=").append(bandLength);
