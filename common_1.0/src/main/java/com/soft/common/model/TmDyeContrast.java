...
@Table(name = "`tm_dye_contrast`")
public class TmDyeContrast implements Serializable {
    /**
     * 主键
     */
    @Id
     ...
     * 本系统染料编号
     */
    @Column(name = "`DYE_CD_TQT`")
    private String dyeCdTqt;

    /**
     * 本系统染料名称
     */
    @Column(name = "`DYE_NM_TQT`")
    private String dyeNmTqt;
     ...
     * 获取本系统染料编号
     *
     * @return DYE_CD_TQT - 本系统染料编号
     */
    public String getDyeCdTqt() {
        return dyeCdTqt;
    }
     ...
     * 设置本系统染料编号
     *
     * @param dyeCdTqt 本系统染料编号
     */
    public void setDyeCdTqt(String dyeCdTqt) {
        this.dyeCdTqt = dyeCdTqt == null ? null : dyeCdTqt.trim();
    }

    /**
     * 获取本系统染料名称
     *
     * @return DYE_NM_TQT - 本系统染料名称
     */
    public String getDyeNmTqt() {
        return dyeNmTqt;
    }
     ...
     * 设置本系统染料名称
     *
     * @param dyeNmTqt 本系统染料名称
     */
    public void setDyeNmTqt(String dyeNmTqt) {
        this.dyeNmTqt = dyeNmTqt == null ? null : dyeNmTqt.trim();
    }
    ...
    public boolean equals(Object that) {
        ...
        TmDyeContrast other = (TmDyeContrast) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getDyeCdTqt() == null ? other.getDyeCdTqt() == null : this.getDyeCdTqt().equals(other.getDyeCdTqt()))
            && (this.getDyeNmTqt() == null ? other.getDyeNmTqt() == null : this.getDyeNmTqt().equals(other.getDyeNmTqt()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getDyeCdTqt() == null) ? 0 : getDyeCdTqt().hashCode());
        result = prime * result + ((getDyeNmTqt() == null) ? 0 : getDyeNmTqt().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", dyeCdTqt=").append(dyeCdTqt);
        sb.append(", dyeNmTqt=").append(dyeNmTqt);
