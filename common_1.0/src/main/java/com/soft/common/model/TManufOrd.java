...
public class TManufOrd implements Serializable {
     ...
     * 产出毛重
     */
    @Column(name = "`FINISH_GWEIGHT`")
    private BigDecimal finishGweight;

    /**
     * 产出净重
     */
    @Column(name = "`FINISH_NWEIGHT`")
     ...
     */
    public void setManufOrdDt(String manufOrdDt) {
     ...
     * 获取生产需量
     *
     * @return NEED_WEIGHT - 生产需量
     */
    public BigDecimal getNeedWeight() {
        return needWeight;
    }
     ...
     * 设置生产需量
     *
     * @param needWeight 生产需量
     */
    public void setNeedWeight(BigDecimal needWeight) {
     ...
     */
    public void setFinishGweight(BigDecimal finishGweight) {
     ...
     */
    public void setFinishNweight(BigDecimal finishNweight) {
    ...
    public boolean equals(Object that) {
        ...
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getNeedWeight() == null ? other.getNeedWeight() == null : this.getNeedWeight().equals(other.getNeedWeight()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getNeedWeight() == null) ? 0 : getNeedWeight().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", needWeight=").append(needWeight);
