...
@Table(name = "`t_cost_data`")
public class TCostData implements Serializable {
    /**
     * 主键
     */
    @Id
     ...
     * 设置成本核算对象编号
     *
     * @param costObjId 成本核算对象编号
     */
    public void setCostObjId(String costObjId) {
        this.costObjId = costObjId == null ? null : costObjId.trim();
    }
    ...
    public boolean equals(Object that) {
        ...
        TCostData other = (TCostData) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            && (this.getCntrCd() == null ? other.getCntrCd() == null : this.getCntrCd().equals(other.getCntrCd()))
            && (this.getCostObjId() == null ? other.getCostObjId() == null : this.getCostObjId().equals(other.getCostObjId()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getCostObjId() == null) ? 0 : getCostObjId().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", costObjId=").append(costObjId);
