...
@Table(name = "`t_color_sample_dye`")
public class TColorSampleDye implements Serializable {
    /**
     * 主键
     */
    @Id
     ...
     * 染料参数
     */
    @Column(name = "`DYE_VALUE`")
    private BigDecimal dyeValue;

    /**
     * 染料用量
     */
    @Column(name = "`DYE_USE_VALUE`")
    private BigDecimal dyeUseValue;

    /**
     * 染料用量单位
     */
    @Column(name = "`DYE_USE_UNIT`")
    private String dyeUseUnit;

    /**
     * 染料总量
     */
    @Column(name = "`TOTAL_DYE_WEIGHT`")
    private BigDecimal totalDyeWeight;

    /**
     * 染料总量单位
     */
    @Column(name = "`TOTAL_DYE_UNIT`")
    private String totalDyeUnit;
     ...
     * @param dyeCd 呼叫
     */
    public void setDyeCd(String dyeCd) {
        this.dyeCd = dyeCd == null ? null : dyeCd.trim();
    }
     ...
     * 获取染料参数
     *
     * @return DYE_VALUE - 染料参数
     */
    public BigDecimal getDyeValue() {
        return dyeValue;
    }
     ...
     * @param dyeValue 染料参数
     */
    public void setDyeValue(BigDecimal dyeValue) {
     ...
     * 获取染料用量
     *
     * @return DYE_USE_VALUE - 染料用量
     */
    public BigDecimal getDyeUseValue() {
        return dyeUseValue;
    }
     ...
     * 设置染料用量
     *
     * @param dyeUseValue 染料用量
     */
    public void setDyeUseValue(BigDecimal dyeUseValue) {
        this.dyeUseValue = dyeUseValue;
    }

    /**
     * 获取染料用量单位
     *
     * @return DYE_USE_UNIT - 染料用量单位
     */
    public String getDyeUseUnit() {
        return dyeUseUnit;
    }
     ...
     * 设置染料用量单位
     *
     * @param dyeUseUnit 染料用量单位
     */
    public void setDyeUseUnit(String dyeUseUnit) {
        this.dyeUseUnit = dyeUseUnit == null ? null : dyeUseUnit.trim();
    }

    /**
     * 获取染料总量
     *
     * @return TOTAL_DYE_WEIGHT - 染料总量
     */
    public BigDecimal getTotalDyeWeight() {
        return totalDyeWeight;
    }

    /**
     * 设置染料总量
     *
     * @param totalDyeWeight 染料总量
     */
    public void setTotalDyeWeight(BigDecimal totalDyeWeight) {
        this.totalDyeWeight = totalDyeWeight;
    }

    /**
     * 获取染料总量单位
     *
     * @return TOTAL_DYE_UNIT - 染料总量单位
     */
    public String getTotalDyeUnit() {
        return totalDyeUnit;
    }
     ...
     * 设置染料总量单位
     *
     * @param totalDyeUnit 染料总量单位
     */
    public void setTotalDyeUnit(String totalDyeUnit) {
        this.totalDyeUnit = totalDyeUnit == null ? null : totalDyeUnit.trim();
    }
    ...
    public boolean equals(Object that) {
        ...
        TColorSampleDye other = (TColorSampleDye) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getDyeCd() == null ? other.getDyeCd() == null : this.getDyeCd().equals(other.getDyeCd()))
            && (this.getProdId() == null ? other.getProdId() == null : this.getProdId().equals(other.getProdId()))
            && (this.getDyeValue() == null ? other.getDyeValue() == null : this.getDyeValue().equals(other.getDyeValue()))
            && (this.getDyeUseValue() == null ? other.getDyeUseValue() == null : this.getDyeUseValue().equals(other.getDyeUseValue()))
            && (this.getDyeUseUnit() == null ? other.getDyeUseUnit() == null : this.getDyeUseUnit().equals(other.getDyeUseUnit()))
            && (this.getTotalDyeWeight() == null ? other.getTotalDyeWeight() == null : this.getTotalDyeWeight().equals(other.getTotalDyeWeight()))
            && (this.getTotalDyeUnit() == null ? other.getTotalDyeUnit() == null : this.getTotalDyeUnit().equals(other.getTotalDyeUnit()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getDyeCd() == null) ? 0 : getDyeCd().hashCode());
        result = prime * result + ((getProdId() == null) ? 0 : getProdId().hashCode());
        result = prime * result + ((getDyeValue() == null) ? 0 : getDyeValue().hashCode());
        result = prime * result + ((getDyeUseValue() == null) ? 0 : getDyeUseValue().hashCode());
        result = prime * result + ((getDyeUseUnit() == null) ? 0 : getDyeUseUnit().hashCode());
        result = prime * result + ((getTotalDyeWeight() == null) ? 0 : getTotalDyeWeight().hashCode());
        result = prime * result + ((getTotalDyeUnit() == null) ? 0 : getTotalDyeUnit().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", dyeCd=").append(dyeCd);
        sb.append(", prodId=").append(prodId);
        sb.append(", dyeValue=").append(dyeValue);
        sb.append(", dyeUseValue=").append(dyeUseValue);
        sb.append(", dyeUseUnit=").append(dyeUseUnit);
        sb.append(", totalDyeWeight=").append(totalDyeWeight);
        sb.append(", totalDyeUnit=").append(totalDyeUnit);
