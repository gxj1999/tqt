...
@Table(name = "`m_errorinfo`")
public class MErrorinfo implements Serializable {
    /**
     * 主键
     */
    @Id
    ...
    public void setErrId(String errId) {
        this.errId = errId == null ? null : errId.trim();
    }

    /**
     * 获取言语区分
     *
     * @return LANG_TYPE - 言语区分
     */
     ...
     * 设置提示信息概要
     *
     * @param errSummary 提示信息概要
     */
    public void setErrSummary(String errSummary) {
        this.errSummary = errSummary == null ? null : errSummary.trim();
    }

    /**
     * 获取提示信息内容
     *
     * @return ERR_INFO - 提示信息内容
     */
    ...
    public boolean equals(Object that) {
        ...
        MErrorinfo other = (MErrorinfo) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            && (this.getCntrCd() == null ? other.getCntrCd() == null : this.getCntrCd().equals(other.getCntrCd()))
            && (this.getErrId() == null ? other.getErrId() == null : this.getErrId().equals(other.getErrId()))
            ...
            && (this.getErrSummary() == null ? other.getErrSummary() == null : this.getErrSummary().equals(other.getErrSummary()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getErrId() == null) ? 0 : getErrId().hashCode());
        result = prime * result + ((getLangType() == null) ? 0 : getLangType().hashCode());
        result = prime * result + ((getErrType() == null) ? 0 : getErrType().hashCode());
        result = prime * result + ((getErrSummary() == null) ? 0 : getErrSummary().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", errId=").append(errId);
        sb.append(", langType=").append(langType);
        sb.append(", errType=").append(errType);
        sb.append(", errSummary=").append(errSummary);
